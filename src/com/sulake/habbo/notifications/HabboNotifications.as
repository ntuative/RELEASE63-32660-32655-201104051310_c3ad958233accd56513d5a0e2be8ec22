package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1294:String = "pixelbalance";
      
      private static const const_1297:String = "badges";
      
      private static const const_1298:String = "selectbadge";
      
      private static const const_1295:String = "inventory";
      
      private static const const_1293:String = "selectfurni";
      
      private static const const_1292:String = "credits";
      
      private static const const_1291:String = "friendlist";
      
      private static const const_1296:String = "pet_inventory";
      ...
      private var var_504:HabboNotificationViewManager;
      
      private var var_226:HabboAlertDialogManager;
      
      private var var_757:ParkBusDialogManager;
      
      private var var_2408:Boolean;
      
      private var var_926:ClubGiftNotification;
      
      private var var_927:ClubEndingNotification;
      
      private var var_928:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_929);
         }
         var _loc6_:Map = this.var_929["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_929["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1150.push(_loc8_);
         return this.var_1150.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1150.splice(0,1);
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_756.events.addEventListener(HabboToolbarEvent.const_70,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_70)
         {
            ...
            this.var_504 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_929["styles"],this.var_929["view"],this.var_756);
            ...
            registerUpdateReceiver(this.var_504,1);
            registerUpdateReceiver(this,2);
            this._sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_142,this.onBadgeImage);
            this.var_756.events.addEventListener(HabboToolbarEvent.const_554,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1418[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this._sessionDataManager);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1418[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1418[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1670,null);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this._sessionDataManager.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1144,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1144,null);
            }
         }
      }
      ...
      private function onBadgeReceived(param1:BadgeReceivedMessageEvent) : void
      {
         ...
         if(this._sessionDataManager.userId == _loc3_)
         {
            ...
            _loc9_ = this._sessionDataManager.getBadgeImage(_loc4_);
            this.addItem(!!_loc6_ ? _loc6_.value : "notifications.text.received.badge",NotificationType.const_643,_loc9_,_loc4_);
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1561,null);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_536.createAvatarImage(param2,AvatarScaleType.const_54);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this._sessionDataManager.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_72)
               {
                  _loc7_ = this._sessionDataManager.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this._sessionDataManager.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1673,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1202)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1529,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_927 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_928 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_504.isSpaceAvailable() && this.var_1150.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_504.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1296:
               if(this._inventory != null && this._inventory.hasRoomSession)
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_141);
               }
               break;
            case const_1293:
               break;
      ...
      {
         if(param1 != null && this.var_504 != null)
         {
            this.var_504.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_757 == null)
         {
            this.var_757 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_757 != null)
         {
            this.var_757.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1214,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1214,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_536.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_54);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2408)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_643,null);
            this.var_2408 = true;
      ...
      {
         if(param2.type == WindowEvent.const_189 || param2.type == WindowEvent.const_884)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_926 && this.var_926.visible)
         {
            return;
         }
         this.var_926 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_643,_loc6_);
      }
   }
}
