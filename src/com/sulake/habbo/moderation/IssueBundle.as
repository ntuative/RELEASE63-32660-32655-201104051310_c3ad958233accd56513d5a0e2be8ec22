package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_754:IssueMessageData = null;
      
      private var var_753:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2402 = param2.pickerUserId;
         this.var_2403 = param2.pickerUserName;
         this.var_1511 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1146 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1147;
         }
         if(this.var_754 == null || param1.timeStamp < this.var_754.timeStamp)
         {
            this.var_754 = param1;
         }
         if(this.var_753 == null || param1.priority > this.var_753.timeStamp)
         {
            this.var_753 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1146 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1147;
            }
            if(this.var_754 == _loc2_)
            {
               this.var_754 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_753;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_754;
         if(_loc2_ == null)
         {
