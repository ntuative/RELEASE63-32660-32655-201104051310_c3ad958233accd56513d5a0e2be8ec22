package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1225:int = 5;
      ...
      public static const const_1711:int = 9;
       
      
      private var var_1965:Dictionary;
      
      public function WindowTracker()
      {
         this.var_1965 = new Dictionary();
         super();
      }
      ...
      {
         var _loc2_:Dictionary = this.var_1965[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1965[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
