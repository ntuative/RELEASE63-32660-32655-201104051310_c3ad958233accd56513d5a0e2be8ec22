package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1118:IDropMenuWindow;
      
      private var var_487:ITextFieldWindow;
      
      private var var_580:Boolean = true;
      
      private var var_948:ICheckBoxWindow;
      
      private var var_1439:ICheckBoxWindow;
      
      private var var_1440:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_33.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_391));
         Logger.log("BEGINNING TO SHOW: " + this.var_391);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1711;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_1118 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1118);
         this.var_1118.procedure = this.onSelectTemplate;
         this.var_948 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1439 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1440 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_33,WindowTracker.const_871,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_948.isSelected);
         this.var_33.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1584,_loc2_,this.var_487.text,"",""));
         if(this.var_1439.isSelected || this.var_1440.isSelected || this.var_948.isSelected)
         {
            this.var_33.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1439.isSelected,this.var_1440.isSelected,this.var_948.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1495);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1648);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_33.initMsg.roomMessageTemplates[this.var_1118.selection];
         if(_loc3_ != null)
         {
            this.var_580 = false;
            this.var_487.text = _loc3_;
         }
      }
   }
}
