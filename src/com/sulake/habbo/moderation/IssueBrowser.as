package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2011:String = "my_issues";
      
      private const const_2012:String = "open_issues";
      
      private const const_2013:String = "picked_issues";
      
      private const const_2049:String = "closed_issues";
      ...
      private var var_1622:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_244 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_244.numTabItems)
            {
               _loc5_ = this.var_244.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_59,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_244 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_244 == null || this.var_244.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_244.selector.getSelectableByName("open_issues");
         this.var_244.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_341.view.width = this.var_244.container.width;
         this.var_341.view.height = this.var_244.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2011:
               ...
               {
                  this.var_1623 = new MyIssuesView(this.issueManager,this,this.var_244.container);
               }
               return this.var_1623;
            case this.const_2012:
               if(this.var_1622 == null)
               {
                  this.var_1622 = new OpenIssuesView(this.issueManager,this,this.var_244.container);
               }
               return this.var_1622;
            case this.const_2013:
               if(this.var_1624 == null)
               {
                  this.var_1624 = new PickedIssuesView(this.issueManager,this,this.var_244.container);
               }
