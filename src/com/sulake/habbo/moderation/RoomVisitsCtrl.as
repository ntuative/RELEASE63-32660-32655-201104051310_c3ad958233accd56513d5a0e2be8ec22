package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_907:Array = [];
      
      private static var var_1701:int = 200;
      ...
      {
         this.var_735 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_907.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_735.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_907.length < var_1701)
         {
            ...
            param1.width = this.var_735.width;
            param1.height = this.var_735.height;
            var_907.push(param1);
         }
         else
         {
