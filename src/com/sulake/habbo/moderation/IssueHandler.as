package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1287:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.addEventListener(WindowEvent.const_38,this.onResized);
         }
         ...
         this.var_556 = new UserInfoCtrl(this._window,this.var_68,_loc3_.message);
         this.var_1287 = new UserInfoCtrl(this._window,this.var_68,_loc3_.message);
         ...
         {
            this.var_1287.load(_loc4_,this.var_173.reportedUserId);
         }
         else
         {
      ...
      private function updateIssueList() : void
      {
         ...
         for each(_loc7_ in _loc2_)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               _loc12_.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.method_5);
               _loc12_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.method_5);
            }
      ...
      {
         if(this.var_68 != null && this.var_68.issueManager != null && this.var_173 != null)
         {
            this.var_68.issueManager.removeHandler(this.var_173.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_68.issueManager.closeBundle(this.var_173.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_68.issueManager.closeBundle(this.var_173.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_68.issueManager.closeBundle(this.var_173.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_68.issueManager.releaseBundle(this.var_173.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_68.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_68,WindowTracker.const_1107,_loc2_),this._window,false,false,true);
      }
      
      private function method_5(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
