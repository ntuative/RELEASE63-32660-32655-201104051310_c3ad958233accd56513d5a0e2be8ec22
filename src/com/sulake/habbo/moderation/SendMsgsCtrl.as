package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Msg To: " + this.var_1644;
      ...
      {
         return WindowTracker.const_1490;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_33.initMsg.messageTemplates[this.var_1118.selection];
         if(_loc3_ != null)
         {
            this.var_580 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModMessageMessageComposer(this.var_1349,this.var_487.text,this.var_1350));
         this.dispose();
      }
