package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1849:int = 1000;
      
      private static var var_959:Array = [];
      
      private static var var_1848:int = 200;
      ...
      private var var_1847:IMessageComposer;
      ...
      {
         this.var_790 = IWindowContainer(this.var_33.getXmlWindow("chatlog_roomheader"));
         this.var_789 = IWindowContainer(this.var_33.getXmlWindow("chatlog_chatline"));
         ...
         this.var_33.connection.send(this.var_1847);
      ...
      private function populate() : void
      {
         ...
         for each(_loc1_ in this.var_122)
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1846[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1467.getValue(param2.chatterName))
            {
               this.var_1467.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1467.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1466)
         {
