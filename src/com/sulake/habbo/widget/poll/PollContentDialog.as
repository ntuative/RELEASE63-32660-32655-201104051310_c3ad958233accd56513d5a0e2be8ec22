package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1183;
         if(this.var_1183 < this.var_965.length)
         {
            _loc1_ = this.var_965[this.var_1183] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(this._window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",this.var_965.length);
                  _loc2_.text = _loc6_;
               }
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_437)
         {
            ...
            this.var_437 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_437.center();
            this.var_437.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_965[this.var_1183] as Dictionary;
