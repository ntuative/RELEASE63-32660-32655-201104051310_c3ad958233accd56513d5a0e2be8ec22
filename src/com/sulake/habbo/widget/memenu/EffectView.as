package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_194:IWidgetAvatarEffect;
      
      private var var_1036:IWindow;
      ...
      private var var_1035:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_202 = new Timer(this.const_2044);
         this.var_202.addEventListener(TimerEvent.TIMER,this.onUpdate);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_202.stop();
            this.var_202.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_202 = null;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_194.isActive)
         {
            _loc2_ = this.var_194.secondsLeft / Number(this.var_194.duration);
            this.var_1036.width = _loc2_ * this.var_294;
         }
         else
         {
            this.var_1036.width = 0;
            this.var_202.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_845 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_845 == null)
            {
               return;
            }
         ...
         if(!this.var_194.isActive)
         {
            this.var_845.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_845.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_845.text;
         var _loc2_:int = this.var_194.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         if(this.var_194.isInUse)
         {
            _loc3_ = "memenu_effect_selected";
         }
         else if(this.var_194.isActive)
         {
         ...
         else
         {
            ...
            this.var_1035 = this._window.findChildByName("effect_hilite");
            this.var_1035.visible = false;
         }
         this.setTimeLeft();
         this.var_1036 = this._window.findChildByName("loader_bar");
         if(this.var_1036 != null)
         {
            this.var_294 = this.var_1036.width;
            this.var_202.start();
            this.onUpdate();
         }
         if(this.var_194.icon)
         {
            this.setElementBitmap("effect_icon",this.var_194.icon);
         }
      }
