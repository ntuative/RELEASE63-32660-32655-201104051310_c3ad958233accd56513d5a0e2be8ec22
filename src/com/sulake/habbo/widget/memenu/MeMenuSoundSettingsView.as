package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_877:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_525 = param1.volume;
         if(this.var_877 != null)
         {
            this.var_877.setValue(this.var_525);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1611 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1610 = (_loc5_.content as BitmapData).clone();
         }
         ...
         this.var_877 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_754));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_525 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1611);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1610);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_525 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1613);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1612);
         }
      }
