package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private static const const_1284:Number = 100;
      ...
      private var var_1399:XML;
      
      private var _widget:DimmerFurniWidget;
      
      private var var_611:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_74,HabboWindowStyle.const_29,0 | 0,new Rectangle(const_1284,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_611 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         ...
         this.var_244 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_244.numTabItems)
         {
            _loc6_ = this.var_244.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1398 = _loc2_.light;
         if(this.var_419 != null)
         {
            this.var_419.setValue(this.var_1398);
         }
         this.var_492 = this.colors.indexOf(_loc2_.color);
         if(this.var_611 != null)
         {
            this.var_611.setSelectedColorIndex(this.var_492);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_244.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_244.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_244.selector.getSelected();
         return this.var_244.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1399 = XML(_loc1_.content);
         return this.var_1399;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_611 != null)
         {
            this.var_611.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
