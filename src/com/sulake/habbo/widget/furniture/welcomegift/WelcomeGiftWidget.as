package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_632:String = "welcome_gift_email_unverified";
      
      private const const_1004:String = "welcome_gift_email_verified";
      
      private const const_1397:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1252)
         {
            this.setViewState(this.const_1004);
         }
         else
         {
            this.setViewState(this.const_632);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_632:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1981;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_1981);
               break;
            case this.const_1004:
      ...
      {
         this.setViewState(this.const_1397);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_706,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1252 ? this.const_1004 : this.const_632);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1531 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1531));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_593,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_806,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_593,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_806,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_593:
               this.var_1530 = param1.email;
               this.var_1252 = param1.isVerified;
               this.var_1981 = param1.allowEmailChange;
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1531);
