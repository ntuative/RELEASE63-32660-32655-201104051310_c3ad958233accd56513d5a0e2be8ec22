package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class ImageDownloader implements IDisposable
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_42)
         {
            this.var_42.removeEventListener(AssetLoaderEvent.const_30,this.onImageReady);
         }
         this.var_42 = null;
         this._disposed = true;
      }
      ...
      public function downloadImage(param1:String, param2:String) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_42.addEventListener(AssetLoaderEvent.const_30,this.onImageReady);
         }
      }
