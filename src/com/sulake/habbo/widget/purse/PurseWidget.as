   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      public function PurseWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager)
      {
         ...
         if(_loc4_)
         {
            ...
            this._view.x = _loc5_.width - this._view.width - this.const_1765;
            this._view.y = this.const_1765;
      ...
      {
         this.var_1900 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_1900.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_1900.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_1901 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_1901.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_1901.toString();
         }
      }
      
      private function onCreditsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1028));
      }
      
      private function onPixelsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1153));
      }
   }
}
