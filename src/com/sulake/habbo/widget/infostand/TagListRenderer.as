package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2020:int = 5;
      
      private const const_2021:int = 5;
      ...
      private var var_1141:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1142 = 0;
         this.var_1141 = param2.rectangle.clone();
         this.var_1141.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1141.width)
         {
            return false;
         }
         if(this.var_1142 + param1.height > this.var_1141.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1141.width)
         {
            this._offsetX = 0;
            this.var_1142 += param1.height + this.const_2021;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1142);
         this._offsetX += param1.width + this.const_2020;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1542 != null && this.var_1542.indexOf(param1) != -1)
         {
