package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1754:String = "infostand_user_view";
      
      private const const_1756:String = "infostand_furni_view";
      
      private const const_1752:String = "infostand_pet_view";
      
      private const const_1753:String = "infostand_bot_view";
      
      private const const_1755:String = "infostand_jukebox_view";
      
      private const const_1757:String = "infostand_songdisk_view";
      
      private var var_1195:InfoStandFurniView;
      
      private var var_138:InfoStandUserView;
      
      private var var_374:InfoStandPetView;
      ...
      private var var_1479:InfostandUserData;
      
      private var var_610:InfostandFurniData;
      ...
      private const const_2025:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog, param6:IHabboSoundManager)
      {
         ...
         this.var_376 = param6;
         this.var_1195 = new InfoStandFurniView(this,this.const_1756,this._catalog);
         this.var_138 = new InfoStandUserView(this,this.const_1754);
         this.var_374 = new InfoStandPetView(this,this.const_1752,this._catalog);
         this.var_438 = new InfoStandBotView(this,this.const_1753);
         this.var_974 = new InfoStandJukeboxView(this,this.const_1755,this._catalog);
         this.var_973 = new InfoStandSongDiskView(this,this.const_1757,this._catalog);
         this.var_1479 = new InfostandUserData();
         this.var_610 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_163 = new Timer(this.const_2025);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_74,HabboWindowStyle.const_44,HabboWindowParam.const_44,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_287,this.onFurniInfo);
         param1.addEventListener(RoomWidgetUserTagsUpdateEvent.const_166,this.onUserTags);
         param1.addEventListener(RoomWidgetUserFigureUpdateEvent.const_163,this.onUserFigureUpdate);
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_73,this.onUserBadges);
         param1.addEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_885,this.onUserGivableBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_761,this.onBadgeImage);
         param1.addEventListener(RoomWidgetPetInfoUpdateEvent.PET_INFO,this.onPetInfo);
         param1.addEventListener(RoomWidgetPetCommandsUpdateEvent.PET_COMMANDS,this.onPetCommands);
         param1.addEventListener(RoomWidgetSongUpdateEvent.const_320,this.onSongUpdate);
         param1.addEventListener(RoomWidgetSongUpdateEvent.const_570,this.onSongUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_287,this.onFurniInfo);
         param1.removeEventListener(RoomWidgetUserTagsUpdateEvent.const_166,this.onUserTags);
         param1.removeEventListener(RoomWidgetUserFigureUpdateEvent.const_163,this.onUserFigureUpdate);
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_73,this.onUserBadges);
         param1.removeEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_885,this.onUserGivableBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_761,this.onBadgeImage);
         param1.removeEventListener(RoomWidgetPetInfoUpdateEvent.PET_INFO,this.onPetInfo);
         param1.removeEventListener(RoomWidgetPetCommandsUpdateEvent.PET_COMMANDS,this.onPetCommands);
         param1.removeEventListener(RoomWidgetSongUpdateEvent.const_320,this.onSongUpdate);
         param1.removeEventListener(RoomWidgetSongUpdateEvent.const_570,this.onSongUpdate);
      }
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_411,this.var_374.getCurrentPetId()));
      }
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1754);
         if(this.var_163)
         {
            this.var_163.stop();
         }
      ...
      private function onBotInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1753);
         if(this.var_163)
         {
            this.var_163.stop();
         }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_691)
         {
            this.var_974.update(param1);
            this.selectView(this.const_1755);
         }
         ...
         else
         {
            ...
            this.selectView(this.const_1756);
         }
         if(this.var_163)
         {
            this.var_163.stop();
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_374.update(this.petData);
      ...
      {
         this.var_374.updateEnabledTrainingCommands(param1.id,new CommandConfiguration(param1.allCommands,param1.enabledCommands));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_138.setTags(param1.tags,this.var_2532);
         }
      }
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_143:
               _loc2_ = param1.id == this.var_610.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_169:
               if(this.var_138 != null && this.var_138.window != null && this.var_138.window.visible)
               {
                  _loc2_ = param1.id == this.var_1479.userRoomId;
                  break;
               }
               if(this.var_374 != null && this.var_374.window != null && this.var_374.window.visible)
               {
