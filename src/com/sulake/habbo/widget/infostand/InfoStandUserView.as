package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_166:IFrameWindow;
      
      private var var_659:IWindow;
      
      private var var_53:IBorderWindow;
      
      private var var_1210:TagListRenderer;
      
      private var var_140:IBorderWindow;
      
      private var var_2746:int;
      
      private const const_1002:int = 5;
      
      private const const_1769:int = 39;
      
      private const const_1771:int = 7829367;
      
      private const const_1770:int = 16777215;
      
      private const const_2042:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1210 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_52 == null || this.var_53 == null || this._buttons == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_53.width,this._buttons.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_53.width < this._buttons.width)
         {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:* = [];
         this._buttons.groupListItemsWithTag("CMD_BUTTON",_loc3_,true);
         for each(_loc4_ in _loc3_)
         {
            ...
            _loc4_.addEventListener(WindowEvent.const_38,this.onButtonResized);
         }
         if(this.var_53 != null)
         {
         ...
         {
            _loc7_ = 0;
            while(_loc7_ < this._buttons.numListItems)
            {
               _loc12_ = this._buttons.getListItemAt(_loc7_) as IRegionWindow;
               if(_loc12_ != null)
               {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_53.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
         ...
         _loc9_ = this.var_53.findChildByName("badge_group");
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1002;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1771;
            }
            else
            {
               _loc3_.textColor = this.const_1770;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_1002;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_406,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_406,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1210.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_124);
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this._buttons.getListItemByName(param1) as IRegionWindow;
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = this._buttons.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_1227:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1033:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2746 > this.const_2042 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2746 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1771;
            if(_loc3_.length >= this.const_1769)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1769 - 1);
            }
         }
      }
      ...
      {
         this.var_166 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_166.center();
         this.var_166.procedure = this.badgesEventProc;
         this.var_166.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_166 && this.var_166.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_659 = null;
         var _loc2_:IItemGridWindow = this.var_166.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_166.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_166.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_659);
               }
               if(_loc3_ <= -1)
               {
                  return;
