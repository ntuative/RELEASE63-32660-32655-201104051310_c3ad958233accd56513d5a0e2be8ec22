package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var_53 = _window.getListItemByName("info_border") as IBorderWindow;
         _buttons = _window.getListItemByName("button_list") as IItemListWindow;
         if(var_53 != null)
         {
            var_52 = var_53.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_53.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var_241 = var_53.findChildByTag("catalog");
         if(var_241 != null)
         {
            var_241.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onCatalogButtonClicked);
         }
         var _loc7_:IBitmapWrapperWindow = var_53.findChildByName("icon_disc") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = var_53.findChildByName("icon_composer") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_320)
         {
            this.var_1961 = param1.songId;
         }
         if(param1.songId == this.var_1961)
         {
            this._songName = param1.songName;
            this.var_2708 = param1.songAuthor;
            this.updateNowPlaying(this.var_1961 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2708;
         }
         else
         {
