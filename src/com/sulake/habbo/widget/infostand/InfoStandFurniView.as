package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected var var_53:IBorderWindow;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_241 = this.var_53.findChildByTag("catalog");
      ...
      {
         if(this._widget == null || this.var_53 == null)
         {
            return;
         }
         var _loc2_:IWindow = this.var_53.findChildByName("furni_details_spacer");
         if(_loc2_ != null)
         {
            _loc2_.visible = param1;
         }
         var _loc3_:IWindow = this.var_53.findChildByName("furni_details_text") as ITextWindow;
         if(_loc3_ != null)
         {
