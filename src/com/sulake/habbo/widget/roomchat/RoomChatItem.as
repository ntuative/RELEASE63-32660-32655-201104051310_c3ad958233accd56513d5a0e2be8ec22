package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_950:Number = 18;
      
      private static const const_614:int = 6;
      
      private static const const_1276:int = 6;
      
      private static const const_949:int = 35;
      
      private static const const_442:String = "name";
      
      private static const const_948:String = "message";
      
      private static const const_1277:String = "pointer";
      ...
      private static var var_417:IRegionWindow;
      ...
      public function RoomChatItem(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:String, param5:IHabboLocalizationManager, param6:String)
      {
         ...
         if(!var_416)
         {
            var_416 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_shout").content as XML,1) as IRegionWindow;
         ...
         if(!var_417)
         {
            var_417 = this._windowManager.buildFromXML(this._assetLibrary.getAssetByName("bubble_whisper").content as XML,1) as IRegionWindow;
            var_417.tags.push("roomchat_bubble");
            var_417.x = 0;
            var_417.y = 0;
            var_417.width = 0;
            var_417.background = true;
            var_417.mouseThreshold = 0;
            var_223.setParamFlag(WindowParam.WINDOW_PARAM_FORCE_CLIPPING,true);
         }
         if(!var_357)
         {
      ...
      {
         this.var_1378 = param1.chatType;
         this.var_1124 = param1.userId;
         this.var_911 = param1.userName;
         this.var_1125 = param1.userCategory;
         this._message = param1.text;
         this.var_356 = param1.links;
         this.var_1717 = param1.userX;
         this.var_248 = param1.userImage;
         this.var_2336 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(this._x,this.var_172,this.width,const_950);
      ...
      public function renderView() : void
      {
         ...
         switch(this.var_1378)
         {
            case RoomWidgetChatUpdateEvent.const_158:
               this._window = var_223.clone() as IRegionWindow;
               break;
            case RoomWidgetChatUpdateEvent.const_156:
               this._window = var_417.clone() as IRegionWindow;
               break;
         ...
         var nameWindow:ILabelWindow = this._window.findChildByName(const_442) as ILabelWindow;
         var textWindow:ITextWindow = this._window.findChildByName(const_948) as ITextWindow;
         var pointerWindow:IBitmapWrapperWindow = this._window.findChildByName(const_1277) as IBitmapWrapperWindow;
         ...
         if(this.var_248 && !isRespect)
         {
            ...
            if(userIconWindow)
            {
               ...
               userIconWindow.x = x1;
               userIconWindow.y = y1;
               this.var_742 = Math.max(0,(this.var_248.height - background.height) / 2);
               this.var_249 += userIconWindow.x + this.var_248.width;
            }
         }
         if(nameWindow != null)
         {
            ...
            this.var_249 += nameWindow.width;
         }
         if(this.var_1378 == RoomWidgetChatUpdateEvent.const_341)
         {
            textWindow.text = this.var_66.registerParameter("widgets.chatbubble.respect","username",this.var_911);
            this.var_249 = const_949;
         }
         else if(this.var_1378 == RoomWidgetChatUpdateEvent.const_330)
         {
            textWindow.text = this.var_66.registerParameter("widget.chatbubble.petrespect","petname",this.var_911);
            this.var_249 = const_949;
         }
         ...
         if(textWindow.visible)
         {
            ...
            textWindow.width = messageWidth + const_1276;
            this.var_249 += textWindow.width;
         }
         if(pointerWindow != null && pointerWindow.visible)
         {
            pointerWindow.bitmap = pointerBitmapData;
            pointerWindow.disposesBitmap = false;
            pointerWindow.x = this.var_249 / 2;
            pointerWindow.y += this.var_742;
         }
         var bitmap:BitmapData = this.buildBubbleImage(nameWindow.width + textWindow.width,background.height,this.var_2336,isRespect);
         this._window.width = bitmap.width;
         this._window.y -= this.var_742;
         this.var_249 = this._window.width;
      ...
      {
         var _loc5_:int = 0;
         var _loc3_:ITextWindow = this._window.getChildByName(const_948) as ITextWindow;
         var _loc4_:int = _loc3_.getCharIndexAtPoint(param1 - _loc3_.x,param2 - _loc3_.y);
         if(_loc4_ > -1)
         {
            _loc5_ = 0;
            while(_loc5_ < this.var_741.length)
            {
               if(_loc4_ >= this.var_741[_loc5_][0] && _loc4_ <= this.var_741[_loc5_][1])
               {
                  ...
                  {
                     HabboWebTools.openWebPage(this.var_1716 + this.var_356[_loc5_][0],"habboMain");
                  }
                  else
                  {
                     HabboWebTools.openWebPage(this.var_1716 + this.var_356[_loc5_][0]);
                  }
                  return true;
               }
               _loc5_++;
      ...
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         ...
         this._widget.onItemMouseClick(this.var_1124,this.var_911,this.var_1125,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseDown(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseDown(this.var_1124,this.var_1125,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOver(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOver(this.var_1124,this.var_1125,this._roomId,this._roomCategory,param1);
      }
      
      private function onBubbleMouseOut(param1:WindowMouseEvent) : void
      {
         this._widget.onItemMouseOut(this.var_1124,this.var_1125,this._roomId,this._roomCategory,param1);
      }
