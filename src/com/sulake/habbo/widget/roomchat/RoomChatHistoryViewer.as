package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1256:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_179.state = RoomChatHistoryPulldown.const_225;
         ...
         this.var_49 = param2.createWindow("chatscroller","",HabboWindowType.const_1118,HabboWindowStyle.const_44,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_179.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_225);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_179.state == RoomChatHistoryPulldown.const_399 || this.var_179.state == RoomChatHistoryPulldown.const_452;
      }
      ...
      {
         if(!this.var_406 && !this.var_1774)
         {
            this.var_406 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_179.state = RoomChatHistoryPulldown.const_399;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_49 != null)
         {
            ...
            if(param2)
            {
               this.var_49.scrollV = this.var_578;
            }
         }
         if(this.var_179 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_407 > 0 && param2)
         {
            if(this.var_1603)
            {
               if(Math.abs(param1 - this.var_407) <= const_1025)
               {
                  return;
               }
               this.var_1603 = false;
            ...
            if(this.var_406)
            {
               ...
               _loc5_ = (param1 - this.var_407) / this.var_49.height;
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_49.scrollV < 1 - const_1256 / this.var_49.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1604)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_49 != null)
         {
            this.var_578 = this.var_49.scrollV;
         }
         if(this.var_49 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_578 - this.var_49.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
