package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_945:int = 150;
      
      private static const const_946:int = 250;
      ...
      private var var_1658:BitmapData;
      ...
      private var var_2270:BitmapData;
      
      private var var_2267:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_1658 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2272 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1660 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1659 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2271 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2270 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_76 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_334,HabboWindowStyle.const_29,HabboWindowParam.const_62,new Rectangle(0,0,param3.width,param3.height - const_85),null,0,0) as IBitmapWrapperWindow;
         this.var_41.addChild(this.var_76);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_74,HabboWindowStyle.const_29,0 | 0,new Rectangle(0,this.var_41.height - const_85,param3.width,const_85),null,0) as IWindowContainer;
         this.var_41.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_558,HabboWindowStyle.const_44,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_85),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_452:
               this.var_76.blend += param1 / const_946;
               this._window.blend += param1 / const_946;
               ...
               break;
            case const_1010:
               this.var_76.blend -= param1 / const_945;
               this._window.blend -= param1 / const_945;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_41.height - const_85;
            this._window.width = this.var_41.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_41.height - const_85;
            this._region.width = this.var_41.width - this.var_2267;
         }
         if(this.var_76 != null)
         {
            this.var_76.rectangle = this.var_41.rectangle;
            this.var_76.height -= const_85;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2268 == this._window.width)
         {
            return;
         }
         this.var_2268 = this._window.width;
         ...
         if(_loc2_ != null && _loc5_ != null)
         {
            ...
            _loc2_.bitmap = this.var_1660;
            _loc2_.disposesBitmap = false;
            this.var_2267 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1658,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1658,_loc9_);
         ...
         this.var_76.bitmap = this.var_2270;
