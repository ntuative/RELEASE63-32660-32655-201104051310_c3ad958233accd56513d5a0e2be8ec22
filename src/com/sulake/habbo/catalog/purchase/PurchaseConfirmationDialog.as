package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_614:IWindowContainer;
      
      private var var_360:int = -1;
      
      private const const_2019:int = 10;
      ...
      private const const_1740:uint = 4.293848814E9;
      
      private const const_1739:uint = 4.294967295E9;
      
      private const const_2018:uint = 4.291613146E9;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_186:
                  _loc6_ = this._catalog.method_11(_loc7_);
                  break;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_751 = _loc1_.boxTypes;
            this.var_750 = _loc1_.ribbonTypes;
            this.var_1137 = this.var_1758[0];
            this.var_359 = this.var_751[0];
            this.var_361 = this.var_750[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_361 < 0)
         {
            this.var_361 = this.var_750.length - 1;
         }
         if(this.var_361 > this.var_750.length - 1)
         {
            this.var_361 = 0;
         }
         if(this.var_359 < 0)
         {
            this.var_359 = this.var_751.length - 1;
         }
         if(this.var_359 > this.var_751.length - 1)
         {
            this.var_359 = 0;
         }
         var _loc1_:int = this.var_751[this.var_359] * 1000 + this.var_750[this.var_361];
         if(this._window == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_751[this.var_359]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_750[this.var_361]);
         this._catalog.purchaseProductAsGift(this.var_1407,this.var_93,this.var_1408,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1407,this.var_93.offerId,this.var_1408);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_107:
               ...
               for each(_loc7_ in this.var_234)
               {
                  ...
                  if(_loc5_.length >= this.const_2019)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2380 = _loc3_.text;
               break;
            case WindowMouseEvent.const_43:
               ...
               break;
            case WindowKeyboardEvent.const_406:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_360 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_360 + 1);
                     break;
      ...
      {
         if(this.var_251 == null || !this.var_251.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_251.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_360) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_251 == null)
         {
            this.var_251 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_614 == null)
         {
            this.var_614 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_614.procedure = this.suggestionsEventHandler;
         }
         if(this.var_251 == null || this.var_614 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_251.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_614.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_360) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_360);
         }
         this.var_360 = param1;
         if(this.var_360 < 0)
         {
            this.var_360 = _loc2_.numListItems - 1;
         }
         if(this.var_360 >= _loc2_.numListItems)
         {
            this.var_360 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_360) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_2018;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1740) : uint(this.const_1739);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_251.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
