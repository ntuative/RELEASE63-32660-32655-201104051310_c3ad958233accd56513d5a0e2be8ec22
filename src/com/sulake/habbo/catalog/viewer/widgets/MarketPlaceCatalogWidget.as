package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1737:int = 1;
      
      private const const_1738:int = 2;
      
      private const const_2048:int = 40;
      
      private const const_2047:int = 10;
      
      private var var_849:Array;
      
      private var var_1573:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_559)
         {
            this.var_559.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_559 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_849 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_849 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_849));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_688)
         {
            ...
            this.var_688 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_688)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1738,_loc2_.length);
         if(!this.var_559)
         {
            this.var_559 = new Timer(25);
            this.var_559.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1293 = 0;
         this.populateList();
         this.var_559.start();
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_688 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_688.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1737);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_849.length)
         {
            _loc4_ = this.var_849[_loc6_.selection];
         }
         ...
         else if(param1.type == WindowEvent.const_107)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2047;
                  break;
               case "search_input":
                  _loc8_ = this.const_2048;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1573.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_59)
