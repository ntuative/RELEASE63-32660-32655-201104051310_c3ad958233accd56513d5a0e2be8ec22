package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1914:Point;
      
      private var var_533:IItemGridWindow;
      
      private var var_1502:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_989 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1224 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_87 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1914 = new Point(this.var_87.x,this.var_87.y);
         this.var_533 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1502 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1915 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_989.text = _loc4_;
         this.var_1224.text = _loc5_;
         this.var_989.height = this.var_989.textHeight + 5;
         this.var_1224.y = this.var_989.y + this.var_989.height;
         this.var_1224.height = Math.max(130,this.var_1224.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_551:
                  _loc6_ = this.var_1915.clone();
                  if(this.var_533 != null)
                  {
                     this.var_533.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_533,this.var_1502,this.var_1585);
                     this.var_533.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_186:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_316,AvatarAction.const_532);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2621)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_87 != null && true)
         {
            ...
            this.var_87.x = this.var_1914.x;
            this.var_87.y = this.var_1914.y;
            if(param3 != null)
            {
