package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_2928:IButtonWindow;
      ...
      private var var_2887:ITextWindow;
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.const_678,this.onSetParameter);
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            this.var_2295 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            this.var_2293 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            this.var_2294 = _loc3_.content as XML;
         }
         var _loc4_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsOrCreditsAndPixelsStub") as XmlAsset;
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.onSelectProduct);
         events.addEventListener(WidgetEvent.const_678,this.onSetParameter);
      ...
      private function attachStub(param1:String) : void
      {
         ...
         this.var_1665 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         this.var_1663 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         this.var_1664 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         this.var_2887 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
         this.var_588 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         if(this.var_588 != null)
         {
            if(this.var_1363 != null)
            {
               this.var_588.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1363);
            }
            else
            {
               this.var_588.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1363);
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_1665 != null)
         {
            ...
            this.var_1665.caption = "${catalog.purchase.price.credits}";
         }
         var _loc3_:String = this.var_93.activityPointType == Purse.const_185 ? "pixels" : "activitypoints";
         if(this.var_1663 != null)
         {
            ...
            this.var_1663.caption = _loc2_.getKey(_loc4_);
         }
         if(this.var_1664 != null)
         {
            ...
            this.var_1664.caption = _loc2_.getKey(_loc4_);
         }
      ...
      {
         this.var_1666 = param1.parameter;
      }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         if(this.var_93 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_93,page.pageId,this.var_1666);
         }
      }
      ...
      private function initPurchase(param1:CatalogWidgetInitPurchaseEvent) : void
      {
         if(this.var_93 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_93,page.pageId,this.var_1666,param1.enableBuyAsGift);
         }
      }
   }
}
