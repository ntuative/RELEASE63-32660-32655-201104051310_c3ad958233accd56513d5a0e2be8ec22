package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1250:int = 16763904;
      
      private static const const_1251:int = 13421772;
      
      private static const const_1249:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(this.var_243.getValue(_loc5_) == null)
            {
               this.var_243.add(_loc5_,new Map());
            }
            _loc7_ = this.var_243.getValue(_loc5_) as Map;
            _loc7_.add(_loc6_,_loc3_);
         }
         _loc4_ = this.var_243.getWithIndex(this.var_296);
         if(_loc4_ != null)
         {
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent) : void
      {
         ...
         _loc2_.push(const_1250);
         _loc2_.push(const_1251);
         _loc2_.push(const_1249);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_243.getWithIndex(this.var_296);
         if(_loc2_ != null)
         {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_296;
         if(this.var_296 >= this.var_243.length)
         {
            this.var_296 = 0;
         }
         var _loc2_:Map = this.var_243.getWithIndex(this.var_296);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_296 < 0)
         {
            this.var_296 = this.var_243.length - 1;
         }
         var _loc2_:Map = this.var_243.getWithIndex(this.var_296);
         if(_loc2_ != null)
         {
