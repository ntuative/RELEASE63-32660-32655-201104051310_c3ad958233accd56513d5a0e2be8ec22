package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_217[this.var_581][this.var_719];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_581 = var_473.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_581];
         var _loc3_:Array = this.var_217[this.var_581] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_719 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_719] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_393 || _loc1_.pricingModel == Offer.const_405)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_72 || _loc3_.productType == ProductTypeEnum.const_77)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        (this.var_217[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
