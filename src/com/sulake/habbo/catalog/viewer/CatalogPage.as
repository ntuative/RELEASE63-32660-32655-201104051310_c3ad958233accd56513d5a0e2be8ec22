package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1718:String = "ctlg_";
       
      
      protected var var_2096:XML;
      ...
      private var var_1140:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1139);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1139);
      }
      ...
      {
         var _loc2_:String = const_1718 + param1;
         ...
         this.var_2096 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2096) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1652:
               if(this.var_1140 == null)
               {
                  this.var_1140 = new ItemGridCatalogWidget(param1);
                  this.var_37.push(this.var_1140);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1475:
               ...
               break;
            case CatalogWidgetEnum.const_1665:
            ...
            case CatalogWidgetEnum.const_1692:
               ...
               break;
            case CatalogWidgetEnum.const_1443:
            ...
            case CatalogWidgetEnum.const_1602:
               ...
               break;
            case CatalogWidgetEnum.const_1698:
            ...
            case CatalogWidgetEnum.const_1598:
               ...
               break;
            case CatalogWidgetEnum.const_1438:
            ...
            case CatalogWidgetEnum.const_1565:
               ...
               break;
            case CatalogWidgetEnum.const_1483:
            ...
            case CatalogWidgetEnum.const_1662:
               ...
               break;
            case CatalogWidgetEnum.const_1519:
