package com.sulake.habbo.catalog.club
{
   ...
   public class ClubBuyItem
   {
      ...
      public function ClubBuyItem(param1:ClubBuyOfferData, param2:ICatalogPage)
      {
         ...
         this._window = this.var_336.viewer.catalog.windowManager.buildFromXML(_loc3_) as IWindowContainer;
      ...
      {
         var _loc2_:ClubBuyController = (this.var_336.viewer.catalog as HabboCatalog).getClubBuyController();
         (this.var_336.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_93,this.var_336.pageId);
      }
      
      private function getAssetXML(param1:String) : XML
      {
         if(!this.var_336 || !this.var_336.viewer || !this.var_336.viewer.catalog || !this.var_336.viewer.catalog.assets)
         {
            return null;
         }
         var _loc2_:XmlAsset = this.var_336.viewer.catalog.assets.getAssetByName(param1) as XmlAsset;
         if(_loc2_ == null)
         {
            return null;
         }
