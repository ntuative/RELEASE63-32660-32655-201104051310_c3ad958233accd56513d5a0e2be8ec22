package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1269:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1371:XML;
      
      private static var var_1370:XML;
       
      
      private var var_1690:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2890:IWindowContainer;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1690 == 4294967295)
            {
               this.var_1690 = _loc1_.color;
            }
            _loc1_.color = const_1269;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1549;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1553;
            }
         }
      }
      ...
      {
         this.var_62 = navigator.catalog.windowManager.buildFromXML(var_1370) as IItemListWindow;
         if(this.var_62 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1371) as IWindowContainer;
         }
         else
         {
