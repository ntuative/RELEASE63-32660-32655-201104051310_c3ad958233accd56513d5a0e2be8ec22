package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_992:int = 0;
      ...
      {
         return this.var_651 != const_992;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1928 != RecyclerStatusMessageEvent.const_1228;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_651 == const_438;
      }
      ...
      {
         this.var_651 = const_991;
         this.var_119 = new Array(const_194);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_194)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_651 = const_992;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1928)
         {
            case RecyclerStatusMessageEvent.const_1579:
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1228:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1525:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1202:
               if(this._view != null)
               {
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_119.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_194)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_119.length < const_194)
         {
            return false;
         }
         var _loc1_:int = 0;
