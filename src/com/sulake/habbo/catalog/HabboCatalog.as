package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_621:uint = 1;
      ...
      private var var_188:CatalogViewer;
      ...
      private var var_233:PurchaseConfirmationDialog;
      
      private var var_318:ChargeConfirmationDialog;
      ...
      private var var_2521:Boolean = true;
      
      private var var_2520:Boolean = true;
      
      private var var_1861:Boolean = false;
      
      private var var_2522:GiftWrappingConfiguration;
      
      private var var_1187:ClubGiftController;
      
      private var var_523:ClubBuyController;
      
      private var var_793:Map;
      
      private var var_1188:Boolean = false;
      
      private var var_970:IPurchasableOffer;
      
      private var var_1476:IDragAndDropDoneReceiver;
      
      private var var_86:PlacedObjectPurchaseData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionEvent.const_91,this.onRoomSessionEvent);
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_233 == null)
            {
               this.var_233 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_233.showOffer(this,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_523.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function method_11(param1:int) : BitmapData
      {
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_107.getActivityPointsForType(Purse.const_185)));
         var _loc1_:int = 0;
      ...
      {
         this.var_169.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(this.var_169 != null && _loc2_)
         {
            this.var_169.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_60,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this.mainWindowVisible())
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_188.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_188 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_188.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:XmlAsset = assets.getAssetByName("catalog") as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_621) as IWindowContainer;
         ...
         _loc3_.setParamFlag(WindowParam.const_244,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               this.var_1861 = param1.session.isPrivateRoom;
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1187 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_523 == null)
         {
            this.var_523 = new ClubBuyController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_188 != null)
         {
            this.var_188.catalogWindowClosed();
         }
         if(this.var_94 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_94.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_794 && this.var_794 != "")
         {
            this.var_372.openPage(this.var_794);
            this.var_794 = "";
            this.var_971 = -1;
         }
         else if(this.var_971 > -1)
         {
            this.var_372.openPageById(this.var_971,this.var_1860);
            this.var_971 = -1;
            this.var_1860 = -1;
            this.var_794 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_188.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_188.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2521 && this.var_376 != null)
         {
            this.var_376.playSound(HabboSoundTypesEnum.const_1135);
         }
         this.var_2521 = false;
         if(this.var_318 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_67,this.var_107.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2520 && this.var_376 != null)
         {
            this.var_376.playSound(HabboSoundTypesEnum.const_1029);
         }
         this.var_2520 = false;
         if(this.var_318 != null)
         {
         ...
         if(_loc2_.type == Purse.const_185)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1187.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_188.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2522 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_233 != null)
         {
            this.var_233.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_318 == null)
         {
            this.var_318 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_318.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_188.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      public function requestSelectedItemToMover(param1:IDragAndDropDoneReceiver, param2:Offer) : void
      {
         ...
         if(!this.var_1089 || !this.var_1089.isRoomOwner)
         {
            return;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         if(this.var_1188 && param1.type == RoomEngineObjectEvent.const_167)
         {
            this.resetPlacedOfferData();
            if(this.var_970 == null || !param1.placedInRoom)
            {
               this.resetObjectMover();
               return;
            }
            this.var_86 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_970);
            _loc2_ = this.var_1476;
            this.resetObjectMover();
            if(_loc2_ != null)
            {
            ...
            _loc4_ = this.var_970.productContainer.firstProduct;
            ...
            if(_loc5_)
            {
               _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_290,0.5);
            }
         }
      }
      ...
      public function resetPlacedOfferData() : void
      {
         if(this.var_86 != null)
         {
            if(this.var_86.category == RoomObjectCategoryEnum.const_27)
            {
               this._roomEngine.disposeObjectFurniture(this.var_86.roomId,this.var_86.roomCategory,this.var_86.objectId);
            }
            else if(this.var_86.category == RoomObjectCategoryEnum.const_26)
            {
               this._roomEngine.disposeObjectWallItem(this.var_86.roomId,this.var_86.roomCategory,this.var_86.objectId);
            }
            else
            {
               this._roomEngine.deleteRoomObject(this.var_86.objectId,this.var_86.category);
            }
            this.var_86.dispose();
            this.var_86 = null;
         }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         if(this.var_86 && this.var_86.productClassId == param1.classId)
         {
            if(this.var_86.roomCategory == this._roomEngine.activeRoomCategory && this.var_86.roomId == this._roomEngine.activeRoomId)
            {
               _loc2_ = param1.stripId;
               _loc3_ = this.var_86.category;
               _loc4_ = this.var_86.wallLocation;
               _loc5_ = this.var_86.x;
               _loc6_ = this.var_86.y;
               _loc7_ = this.var_86.direction;
               ...
               if(param1.category == FurniCategory.const_328 || param1.category == FurniCategory.const_344 || param1.category == FurniCategory.const_299)
               {
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_621);
            if(_loc1_ != null)
            {
