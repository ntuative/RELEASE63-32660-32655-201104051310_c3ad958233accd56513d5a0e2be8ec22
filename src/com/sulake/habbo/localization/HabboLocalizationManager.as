package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2365 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1745 = (param2 & 0) > 0;
         if(!this.var_1745)
         {
            lock();
         }
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1745)
            {
               if("false" == this.var_184.getKey("use.default.localizations","false"))
               {
                  ...
                  events.addEventListener(LocalizationEvent.const_161,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_161,this.onLocalizationLoaded);
         if(this.var_184.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_184.getKey("external.override.texts.txt");
            events.addEventListener(LocalizationEvent.const_161,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_161,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         return this.var_2365[Math.max(0,param1 - 1)];
      }
   }
}
