package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1894:GroupDetailsView;
      ...
      private var var_645:ProductDataParser;
      ...
      private var var_1893:UserTagManager;
      
      private var var_1490:BadgeImageManager;
      
      private var var_1213:HabboGroupInfoManager;
      
      private var var_982:IgnoredUsersManager;
      ...
      private var var_1211:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_2905 = [];
         this.var_1893 = new UserTagManager(events);
         this.var_1213 = new HabboGroupInfoManager(this,events);
         this.var_982 = new IgnoredUsersManager(this);
         this.var_1211 = new FaceBookSession();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_320)
         {
            this.var_320.removeEventListener(FurnitureDataParser.const_118,this.onFurnitureReady);
            this.var_320.dispose();
            this.var_320 = null;
         }
         if(this.var_645)
         {
            this.var_645.removeEventListener(ProductDataParser.const_118,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1490 = new BadgeImageManager(context.root.assets,events,this.var_184,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1893.communication = this._communication;
         this.var_1213.communication = this._communication;
         this.var_1211.communication = this._communication;
         this.var_982.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_320)
         {
            ...
            this.var_320 = new FurnitureDataParser(this.var_529,this._wallItems,this.var_528,this._localization);
            this.var_320.addEventListener(FurnitureDataParser.const_118,this.onFurnitureReady);
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2136 = _loc2_.clubLevel;
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2417 = _loc3_.respectTotal;
         this._respectLeft = _loc3_.respectLeft;
         this.var_804 = _loc3_.petRespectLeft;
         this.var_657 = _loc3_.figure;
         this.var_1003 = _loc3_.sex;
         this.var_1688 = _loc3_.realName;
         this.var_2548 = _loc3_.identityId;
         this.var_982.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            this.var_657 = _loc2_.figure;
            this.var_1003 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_657,this.var_1003));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2589 = _loc2_.isOpen;
         this.var_2590 = _loc2_.onShutDown;
      }
      ...
      {
         return this._securityLevel >= SecurityLevelEnum.const_1125;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1893.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1490.getBadgeImage(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1894 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1213.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1894.showGroupDetails(param1);
         }
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         return this.var_1213.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1213.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1490.getBadgeImage(param1,BadgeImageManager.const_1110);
      }
      ...
      {
         return this.var_982.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_982.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_982.unignoreUser(param1);
      }
      ...
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_804 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_804 = this.var_804 - 1;
      }
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(this.var_1212.indexOf(param1) == -1)
         {
         ...
         if(this.var_645 == null)
         {
            ...
            this.var_645 = new ProductDataParser(_loc2_,this.var_1185);
            this.var_645.addEventListener(ProductDataParser.const_118,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         {
            if(this.var_983.indexOf(param1) == -1)
            {
