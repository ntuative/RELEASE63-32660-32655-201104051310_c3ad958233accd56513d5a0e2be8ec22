package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1014:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1416:String = "sendAccessTokenToServer";
      
      private static const const_1415:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1416,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1415,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1014);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1014);
         }
      }
