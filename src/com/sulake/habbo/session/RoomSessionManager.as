   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_77)
         {
            ...
            {
               _loc4_ = this.var_77[_loc3_] as IDisposable;
               if(_loc4_)
               {
                  _loc4_.dispose();
               }
      ...
      private function createHandlers() : void
      {
         ...
         this.var_77.push(new RoomSessionHandler(this._connection,this));
         this.var_77.push(new RoomChatHandler(this._connection,this));
         this.var_77.push(new RoomUsersHandler(this._connection,this));
         this.var_77.push(new RoomPermissionsHandler(this._connection,this));
         this.var_77.push(new AvatarEffectsHandler(this._connection,this));
         this.var_77.push(new RoomDataHandler(this._connection,this));
         this.var_77.push(new PresentHandler(this._connection,this));
         this.var_77.push(new PlaceObjectErrorHandler(this._connection,this));
         this.var_77.push(new TeleportErrorHandler(this._connection,this));
         this.var_77.push(new GenericErrorHandler(this._connection,this));
         this.var_77.push(new PollHandler(this._connection,this));
         this.var_77.push(new VoteHandler(this._connection,this));
         this.var_77.push(new LidoHandler(this._connection,this));
         this.var_77.push(new RoomDimmerPresetsHandler(this._connection,this));
         this.var_77.push(new ViralFurniHandler(this._connection,this));
         this.var_77.push(new UserNotificationHandler(this._connection,this));
         this.var_77.push(new PetPackageHandler(this._connection,this));
      }
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1710)
         {
            this.gotoRoom(this.var_2331,this.var_2332,this.var_1709);
            this.var_1710 = false;
            this.var_1709 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_268,_loc7_));
         return true;
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1193:
                  break;
               case RoomSessionHandler.const_1066:
                  break;
               case RoomSessionHandler.const_880:
      ...
      private function updateHandlers(param1:IRoomSession) : void
      {
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_77.length)
            {
               _loc3_ = this.var_77[_loc2_] as BaseHandler;
               if(_loc3_ != null)
               {
