package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         this.var_839 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_840 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_841 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_839.hasItem(param1))
         {
