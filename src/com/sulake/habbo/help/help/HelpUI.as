package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_387 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201104051304));
         this.var_169 = param5;
         this.var_121 = new Map();
         this.var_121.add(HabboHelpViewEnum.const_1622,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_199,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_505,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_305,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         ...
         this.var_121.add(HabboHelpViewEnum.const_366,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_714,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_255,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_121.add(HabboHelpViewEnum.const_1119,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_121.add(HabboHelpViewEnum.const_1082,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_121.add(HabboHelpViewEnum.const_690,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_542.length == 0 || param1 != this.var_387)
            {
               this.var_542.push(this.var_387);
            }
         }
         this.var_387 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_387);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_255:
               this.showUI(HabboHelpViewEnum.const_255);
               break;
            case CallForHelpResultEnum.const_1080:
               this.showUI(HabboHelpViewEnum.const_1082);
               break;
            case CallForHelpResultEnum.const_1042:
               this.showUI(HabboHelpViewEnum.const_1119);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_121.getValue(HabboHelpViewEnum.const_199) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_448));
      }
      ...
      {
         return this.var_121.getValue(this.var_387);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2665 = this._window.width - _loc3_.width;
         this.var_2664 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2664;
         this._window.width = _loc1_.width + this.var_2665;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_387 == HabboHelpViewEnum.const_199)
         {
            return;
         }
         if(this.var_660.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_660.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_660[1],this.var_660[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_660[0],this.var_660[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_387 == HabboHelpViewEnum.const_199 || this.var_542.length == 0)
         {
            return;
         }
         if(this.var_388 == null)
