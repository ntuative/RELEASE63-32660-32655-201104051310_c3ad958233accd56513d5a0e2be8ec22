package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_494:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_448,this.onTaskDoneEvent);
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_590,this.onTaskDoneEvent);
         ...
         {
            this.var_33.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_322,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1237 && this.var_1236 && this.var_1514;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_33)
         {
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_448,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_590,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_485,this.onTaskDoneEvent);
            if(this.var_33.sessionDataManager != null)
            {
               this.var_33.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_322,this.onFigureUpdate);
            }
            this.var_33 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_43 == null || this.var_43.id == const_89)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_448:
               this.var_1514 = true;
               if(this.var_43 != null && this.var_43.id == const_494)
               {
                  this.showView(const_89);
               }
               break;
            case HabboHelpTutorialEvent.const_590:
               if(this.var_43 != null && this.var_43.id == const_394)
               {
                  this.var_1944 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2665 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2664;
         this._window.width = _loc2_.width + this.var_2665;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_33.hideUI();
         this.var_33.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_120));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_43 != null && (this.var_43.id == const_302 || this.var_43.id == const_89))
         {
            this.showView(const_89);
         }
      }
      ...
      {
         this.var_1237 = true;
         if(this.var_43 != null && (this.var_43.id == const_394 || this.var_43.id == const_89))
         {
            this.showView(const_89);
         }
      }
