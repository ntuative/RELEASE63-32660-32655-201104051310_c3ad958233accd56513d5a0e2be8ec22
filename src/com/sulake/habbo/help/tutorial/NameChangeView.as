package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1496:uint = 13232628;
      
      private static var var_1907:uint = 11129827;
      ...
      private var var_1905:IWindowContainer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1905 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_806)
         {
            this.var_806 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_806)
            {
               return;
            }
            this._window.content.addChild(this.var_806);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_806.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_531;
         }
         this.showView(this.var_806);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_531);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_850:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_853:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1052 || param1 == ChangeUserNameResultMessageEvent.var_1051)
         {
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_531 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_531);
               break;
