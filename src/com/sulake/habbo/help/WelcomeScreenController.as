package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      {
         return this._notifications[this.var_1393];
      }
      ...
      public function dispose() : void
      {
         if(this.var_131)
         {
            ...
            this.var_131.toolbar.events.removeEventListener(HabboToolbarEvent.const_829,this.onToolbarResized);
            this.var_131 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_131.toolbar.events.addEventListener(HabboToolbarEvent.const_829,this.onToolbarResized);
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_375.y = this.var_131.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
         this._window.y = this.var_375.y;
      ...
      private function initializeWindow() : void
      {
         ...
         _loc4_.content.setParamFlag(WindowParam.const_319,false);
         _loc4_.height -= 20;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_95,this.current.targetIconId);
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1393 < this._notifications.length - 1)
         {
            ++this.var_1393;
         }
         else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_375);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_375,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_375.x;
            this._window.y = this.var_375.y;
            this.var_131.removeUpdateReceiver(this);
         }
      }
