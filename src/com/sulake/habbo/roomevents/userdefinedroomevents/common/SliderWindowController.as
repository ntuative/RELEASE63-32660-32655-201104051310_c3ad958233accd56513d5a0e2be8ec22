package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1280:Number = 1.0;
      
      private var var_681:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1280,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1038);
         }
      ...
      {
         return int(this.var_1629 * (Number(param1 - this._minValue) / (this.var_1280 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1629 * (this.var_1280 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1037)
         {
            if(param1.type == WindowMouseEvent.const_58 || param1.type == WindowMouseEvent.const_178)
            {
               this.var_1037 = false;
            }
         }
         if(!this.var_1037 || param1.type != WindowEvent.const_270)
         {
            return;
         }
         if(this.var_681 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_681) * this.var_681;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_681 != 0)
            {
               _loc3_ = this.var_1038 + this.var_681;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_712 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_712.width,this.var_712.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_712,this.var_712.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_711 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_711.width,this.var_711.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_711,this.var_711.rect,new Point(0,0),null,null,true);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_712 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_711 = BitmapData(_loc2_.content);
      }
   }
}
