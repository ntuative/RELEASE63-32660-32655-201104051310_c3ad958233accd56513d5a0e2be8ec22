package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1430:int = 2;
      ...
      private var var_1791:TriggerConfs;
      
      private var var_1789:ActionTypes;
      
      private var var_1790:ConditionTypes;
      
      private var var_257:Dictionary;
      
      private var var_35:Triggerable;
      
      private var var_764:RoomObjectHightLighter;
      ...
      {
         this.var_1791 = new TriggerConfs();
         this.var_1789 = new ActionTypes();
         this.var_1790 = new ConditionTypes();
         this.var_257 = new Dictionary();
         super();
         this.var_82 = param1;
         this.var_764 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_257[param1])
         {
            delete this.var_257[param1];
            this.var_764.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_35.furniLimit)
         {
            this.var_257[param1] = param2;
            this.var_764.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1156 = new SliderWindowController(this.var_82,IWindowContainer(this.find(this.var_51,"delay_slider_container")),this.var_82.assets,0,20,1);
         this.var_1156.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1156.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_764.hideAll(this.var_257);
         }
      }
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_82.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_35.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_35 as TriggerDefinition != null)
         {
            this.var_82.send(new UpdateTriggerMessageComposer(this.var_35.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_35 as ActionDefinition != null)
         {
            this.var_82.send(new UpdateActionMessageComposer(this.var_35.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_35 as ConditionDefinition != null)
         {
            this.var_82.send(new UpdateConditionMessageComposer(this.var_35.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1156.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = this.var_35.stuffTypeSelectionCode < 1 ? int(var_1430) : int(this.var_35.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = (this.var_35.stuffTypeSelectionCode + 1) % (var_1430 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_82.send(new ApplySnapshotMessageComposer(this.var_35.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1791);
         this.refreshConfigureElement(this.var_1789);
         this.refreshConfigureElement(this.var_1790);
