package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      private var var_1159:SliderWindowController;
      ...
      {
         return ConditionCodes.var_2060;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1159.getValue());
      ...
      {
         this.var_82 = param2;
         this.var_1159 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1159.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1159.setValue(1);
         this.var_1160 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1160.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1160.setValue(50);
      }
