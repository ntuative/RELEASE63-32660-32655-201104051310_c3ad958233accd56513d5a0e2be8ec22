package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class SetType implements ISetType
   {
      ...
      public function SetType(param1:XML)
      {
         ...
         this.var_2807 = parseInt(param1.@paletteid);
         this.var_678 = new Dictionary();
         this.var_678["F"] = new Dictionary();
         this.var_678["M"] = new Dictionary();
         this.var_678["F"][0] = Boolean(parseInt(param1.@mand_f_0));
         this.var_678["F"][1] = Boolean(parseInt(param1.@mand_f_1));
         this.var_678["M"][0] = Boolean(parseInt(param1.@mand_m_0));
         this.var_678["M"][1] = Boolean(parseInt(param1.@mand_m_1));
      ...
      public function cleanUp(param1:XML) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         for each(_loc2_ in param1["IDropMenuItemWindow"])
         {
      ...
      {
         return this.var_678[param1.toUpperCase()][Math.min(param2,1)];
      }
