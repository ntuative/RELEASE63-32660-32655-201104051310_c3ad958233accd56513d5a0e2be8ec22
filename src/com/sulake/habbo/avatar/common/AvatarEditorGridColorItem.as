package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_1001:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_640.width,this.var_640.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_640,this.var_640.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_967.width,this.var_967.height,true,0);
            _loc5_ = this.var_967.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_1001.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_968.width,this.var_968.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_968,this.var_968.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_1001)
            {
               switch(this.var_1001.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_47:
                     _loc4_.style = HabboIconType.const_810;
                     _loc4_.visible = true;
               }
            }
            else
