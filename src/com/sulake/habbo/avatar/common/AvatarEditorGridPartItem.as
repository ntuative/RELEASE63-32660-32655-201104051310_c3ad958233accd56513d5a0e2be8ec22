package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_755:IFigurePartSet;
      ...
      private const const_2008:int = 13421772;
      
      private const const_2009:int = 16777215;
      
      private const const_353:Array = [2,6,0,4,3,1];
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         this.var_425 = this.var_69.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_689 != null && !this.var_1771)
            {
               _loc3_ = this.var_689;
            }
            else
            ...
            if(this.var_755)
            {
               switch(this.var_755.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_47:
                     _loc2_.style = HabboIconType.const_810;
               }
            }
            else
            {
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_353[_loc6_] + "_" + FigureData.const_129;
               _loc4_ = this.var_425.getAssetByName(_loc3_) as BitmapDataAsset;
            }
            else
            {
               _loc6_ = 0;
               while(!_loc7_ && _loc6_ < this.const_353.length)
               {
                  _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_353[_loc6_] + "_" + FigureData.const_129;
                  _loc4_ = this.var_425.getAssetByName(_loc3_) as BitmapDataAsset;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(this.var_618.width,this.var_618.height,true,16777215);
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc10_ = -1 * _loc4_.offset.x - this.var_618.x;
               _loc11_ = -1 * _loc4_.offset.y - this.var_618.y;
