   ...
   public class AvatarEditorGridView
   {
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(this._view != null)
         {
            ...
            this.var_553.push(this._view.findChildByName("palette0") as IItemGridWindow);
            this.var_553.push(this._view.findChildByName("palette1") as IItemGridWindow);
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = this.var_69.getCategoryData(this.var_1564);
         if(!_loc1_)
         {
            return;
         }
         ...
         _loc3_ = 0;
         while(_loc3_ < this.const_1387)
         {
            _loc4_ = _loc1_.getPalette(_loc3_);
            _loc5_ = this.var_553[_loc3_] as IItemGridWindow;
            if(!(!_loc4_ || !_loc5_))
            {
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43)
         {
            ...
            this.var_69.selectPart(this.var_1564,_loc3_);
         }
      }
      ...
      private function paletteEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43)
         {
            ...
            _loc7_ = 0;
            while(_loc7_ < this.const_1387)
            {
               if(this.var_553.length > _loc7_)
               {
                  _loc4_ = this.var_553[_loc7_] as IItemGridWindow;
                  _loc5_ = _loc4_.getGridItemIndex(_loc6_);
                  if(_loc5_ > -1)
                  {
                     this.var_69.selectColor(this.var_1564,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
