package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1575:IWindowContainer;
      
      public static var var_2082:int = 6710886;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1155 = [];
         this.var_1429 = [AvatarEditorFigureCategory.const_796,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_233,AvatarEditorFigureCategory.const_725,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_105];
         super();
         ...
         if(var_1575 == null)
         {
            ...
            var_1575 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2428 = this.canChangeOutfit();
            this.var_428.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_505 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_505.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_505.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1155.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_505.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_505.numSelectables)
               {
                  this.var_505.getSelectableAt(_loc6_).x = this.var_505.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_505.setSelected(this.var_505.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_45) && (this.var_1788 == AvatarEditorSideCategory.const_105 || this.var_2429))
         {
         ...
         this.setViewToCategory(this.var_387);
      }
      ...
      {
         if(this.var_1788 == AvatarEditorSideCategory.const_105)
         {
            this.var_2429 = false;
            this.setSideContent(AvatarEditorSideCategory.const_841);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_841:
               break;
            case AvatarEditorSideCategory.const_493:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_493);
               break;
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2229 = new Date().valueOf();
                  this.var_2428 = false;
                  this.var_428.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_506)
         {
            ...
            this.var_506 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_506.procedure = this.stripClubDialogEventProc;
            this.var_506.center();
         }
         else
         {
            this.var_506.visible = true;
            this.var_506.center();
         }
      }
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2229 > 5000;
      }
   }
}
