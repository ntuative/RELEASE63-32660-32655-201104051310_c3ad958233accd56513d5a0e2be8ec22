package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_870:AvatarActionManager;
      ...
      private var var_1043:ActionDefinition;
      
      private var var_477:String;
      
      private var var_1328:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         ...
         this.var_702 = new AnimationManager();
         this.var_477 = param2;
      ...
      {
         this.var_1328.loadOffsets(param1);
      }
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_477);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_477);
            return;
         }
         this.var_870 = new AvatarActionManager(param1,this.var_477,param2);
         this.var_1043 = this.var_870.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_477);
            return false;
         }
         if(this.var_405.parse(param1))
         {
            if(this.var_477 == AvatarType.const_125)
            {
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_477);
            return false;
         }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_477);
            return false;
         }
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_702.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      {
         return this.var_702.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_702.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return this.var_870.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_870.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_870.sortActions(param1);
      }
      
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         if(!this.var_575[param1])
         {
            this.var_575[param1] = new Dictionary();
         }
         if(this.var_575[param1][param2])
         {
            return this.var_575[param1][param2];
         }
         this.var_575[param1][param2] = this.var_338.getMandatorySetTypeIds(param1,param2);
         return this.var_575[param1][param2];
      }
      ...
      {
         return this.var_870.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_702.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1482[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc9_ = this.var_702.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
      ...
      {
         return this.var_1328.getOffset(param1,param2,param3,param4,param5,param6);
      }
