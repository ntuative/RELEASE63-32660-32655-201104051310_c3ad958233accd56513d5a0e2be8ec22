package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1945 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2668 = parseInt(_loc2_,16);
         this.var_2666 = parseInt(_loc3_,16);
         ...
         this.var_1015 = new ColorTransform(this.var_1595,this.var_1594,this.var_1592,this._alphaMultiplier);
         this.var_1238 = this.generatePaletteMapForGrayscale(this.var_2666,this.var_2668);
      }
      ...
      {
         return this.var_1238.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1238.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1238.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1238.getValue("alphas") as Array;
      }
