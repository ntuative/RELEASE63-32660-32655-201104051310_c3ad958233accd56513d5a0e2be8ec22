package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1842:AvatarDataContainer;
      
      private var var_1461:Array;
      
      private var var_1840:DirectionDataContainer;
      
      private var var_1841:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1588 = String(param2.@desc);
         }
         else
         {
            this.var_1588 = this._id;
         }
         if(param2.hasOwnProperty("sprite"))
         {
            for each(_loc3_ in param2.sprite)
            {
               this.var_1462.push(new SpriteDataContainer(this as IAnimation,_loc3_));
            }
         }
         if(param2.hasOwnProperty("avatar"))
         {
            this.var_1842 = new AvatarDataContainer(param2.avatar[0]);
         }
         ...
         {
            this.var_1840 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            this.var_1841 = new ShadowDataContainer(param2.shadow[0]);
         }
         if(param2.hasOwnProperty("remove"))
         {
            for each(_loc5_ in param2.remove)
            {
               this.var_1463.push(String(_loc5_.@id));
            }
         }
         ...
         if(param2.hasOwnProperty("override"))
         {
            ...
            for each(_loc7_ in param2.var_2044)
            {
               _loc8_ = _loc7_.@name;
               _loc9_ = _loc7_.@var_2044;
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc8_ in _loc7_.bodypart)
            {
               ...
               _loc10_ = new AnimationLayerData(param3,_loc8_,AnimationLayerData.const_866,_loc6_,_loc5_);
               _loc4_.push(_loc10_);
            }
            for each(_loc9_ in _loc7_.fx)
            {
               _loc5_ = param3.getActionDefinition(String(_loc9_.@action));
               _loc11_ = new AnimationLayerData(param3,_loc9_,AnimationLayerData.const_598,_loc6_,_loc5_);
               _loc4_.push(_loc11_);
               if(_loc5_ != null)
               {
               }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         {
            if(_loc4_.type == AnimationLayerData.const_866)
            {
               _loc3_.push(_loc4_.id);
            }
            else if(_loc4_.type == AnimationLayerData.const_598)
            {
      ...
      public function getLayerData(param1:int, param2:String, param3:String = null) : AnimationLayerData
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param3))
         {
            ...
            if(_loc4_.type == AnimationLayerData.const_598)
            {
               for each(_loc5_ in this.var_786)
               {
      ...
      {
         return this.var_1462 != null;
      }
      
      public function hasAvatarData() : Boolean
      {
         return this.var_1842 != null;
      }
      ...
      {
         return this.var_1840 != null;
      }
      
      public function hasShadowData() : Boolean
      {
         return this.var_1841 != null;
      }
      
      public function hasRemoveData() : Boolean
      {
         return this.var_1463 != null;
      }
