package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      private var var_2189:IAnimation;
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_1945 = parseInt(param2.@ink);
         this.var_2187 = String(param2.@member);
         this.var_2188 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1336 = [];
         this.var_1335 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1336[_loc4_] = parseInt(_loc3_.@dy);
            this.var_1335[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1335.length)
         {
