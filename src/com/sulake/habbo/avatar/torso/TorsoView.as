   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_231,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_188,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_273,_windowManager,_assetLibrary);
         }
         else
         {
