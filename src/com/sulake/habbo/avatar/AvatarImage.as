package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1399:String = "Default";
      
      private static const const_1398:int = 2;
      
      private static const const_1400:String = AvatarSetType.const_37;
      ...
      private var var_1043:IActiveActionData;
      ...
      private var var_2778:String = null;
      
      private var var_2779:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1400,const_1398);
         this.var_332 = new Array();
         this.var_1043 = new ActiveActionData(AvatarAction.const_400);
         this.var_1043.definition = this._structure.getActionDefinition(const_1399);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_724)
         {
            ...
            if(this.var_827)
            {
               for each(_loc2_ in this.var_827)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return this._structure.getPartColor(this.var_657,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1989;
         if(param2 < AvatarDirectionAngle.const_1057)
         {
            param2 = AvatarDirectionAngle.const_314 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_314)
         {
            param2 -= NaN;
         }
         ...
         if(param1 == AvatarSetType.const_52 || param1 == AvatarSetType.const_37)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_665,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_275.length == 1 && this.var_90 == this.var_1801)
         {
            return this.var_90 + this.var_546 + this.var_665 % 4;
         }
         if(this.var_275.length == 2)
         {
            for each(_loc1_ in this.var_275)
            {
               ...
               {
                  return this.var_90 + this.var_546 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_665 % 11;
                  return this.var_90 + "_" + this.var_1801 + this.var_546 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2780 || param2 != this.var_2778 || param1 != this.var_2779)
         {
            this.var_2780 = param3;
            this.var_2778 = param2;
            this.var_2779 = param1;
            this.var_1990 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1317 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1317)
            {
               this.var_46.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_665);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_665);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_332.push(new ActiveActionData(param1,param2,this.var_665));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_287 = this.var_1043;
         this.var_287.definition = this.var_1043.definition;
         this.resetBodyPartCache(this.var_1043);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_546 = "";
         this.var_275 = this._structure.sortActions(this.var_332);
         if(this.var_275 == null)
         {
            this.var_805 = new Array(0,0,0);
            if(this.var_1537 != "")
            {
               _loc1_ = true;
               this.var_1537 = "";
         ...
         {
            this.var_805 = this._structure.getCanvasOffsets(this.var_275,this._scale,this.var_90);
            for each(_loc4_ in this.var_275)
            {
               this.var_546 += _loc4_.actionType + _loc4_.actionParameter;
            ...
            if(this.var_1537 != this.var_546)
            {
               _loc1_ = true;
               this.var_1537 = this.var_546;
            }
         }
         this.var_1536 = true;
         return _loc1_;
            ...
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1989 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_296 || _loc1_.actionType == AvatarAction.const_276 || _loc1_.actionType == AvatarAction.const_359)
               {
                  this.var_996 = true;
               }
            }
