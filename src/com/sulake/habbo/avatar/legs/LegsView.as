   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_237,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.const_239,_windowManager,_assetLibrary);
         }
         else
         {
