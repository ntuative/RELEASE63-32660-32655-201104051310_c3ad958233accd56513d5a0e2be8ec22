package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2023:String = "hd-99999-99999";
      ...
      private var var_231:AvatarAssetDownloadManager;
      
      private var var_1843:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_658 = RenderMode.const_1472;
         ...
         this.var_106.add(AvatarType.const_125,_loc4_);
         _loc4_ = new AvatarStructure(this,AvatarType.const_75,PartOffsetData.getInstance(param1.assets));
         ...
         this.var_106.add(AvatarType.const_75,_loc4_);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_231)
         {
            this.var_231.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_315.init();
         this.var_787.init();
         _loc2_ = this.var_106.getValue(AvatarType.const_125) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_106.getValue(AvatarType.const_75) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_106.getValue(AvatarType.const_125) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_231 == null)
               {
                  ...
                  this.var_231 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_231.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1009)
         {
            if(this.var_2509 && this.var_2508 && this.var_2510)
            {
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_231.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_231.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_106.getValue(AvatarType.const_125) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_231.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1843)
         {
            this.var_1843 = new AvatarFigureContainer(this.const_2023);
         }
         this.var_231.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1843,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         for each(_loc3_ in this.var_316.getKeys())
         {
            _loc4_ = this.var_316.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1696)
         {
            _loc6_ = !this.var_315.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_315.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_106.getValue(AvatarType.const_75) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_106.getValue(AvatarType.const_75);
      ...
      {
         var _loc3_:AvatarStructure = this.var_106.getValue(AvatarType.const_125) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_75:
               _loc3_ = this.var_106.getValue(AvatarType.const_75) as AvatarStructure;
               break;
            default:
