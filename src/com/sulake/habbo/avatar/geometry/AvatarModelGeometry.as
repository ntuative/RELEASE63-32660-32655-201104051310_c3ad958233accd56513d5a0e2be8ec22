package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_2023:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         this.var_2022 = new Dictionary();
         this.var_2023 = new AvatarSet(param1.avatarset[0]);
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_846[String(_loc6_.@id)] = _loc7_;
            this.var_2022[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      public function removeDynamicItems() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_846)
         {
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_2023.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:AvatarSet = this.var_2023.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = this.var_165[param1];
         if(_loc3_ != null)
         {
      ...
      {
         return this.var_846[param1] != null;
      }
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = this.var_846[param1] as Dictionary;
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(this.typeExists(param1))
         {
            return this.var_846[param1] as Dictionary;
         }
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_2022[param1];
         if(_loc3_ != null)
         {
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            return _loc5_.getParts(this.var_1284,this.var_1039,param4);
         }
         return [];
      }
