package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_623:String = "tab_boy";
      
      private const const_622:String = "tab_girl";
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_69,FigureData.FACE,_windowManager,_assetLibrary);
         }
         else
         {
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_69.controller.gender)
         {
            case FigureData.const_82:
               activateTab(this.const_623);
               inactivateTab(this.const_622);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_622);
               inactivateTab(this.const_623);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_623:
                  var_69.controller.gender = FigureData.const_82;
