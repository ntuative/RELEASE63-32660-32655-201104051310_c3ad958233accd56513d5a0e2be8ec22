package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_412 = new Timer(500,1);
         this.var_348 = new Timer(100,1);
         super();
         this._navigator = param1;
         this.var_1059 = param4;
         this.var_2200 = param2;
         this._popupIndentLeft = param3;
         this.var_412.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_412)
         {
            this.var_412.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_412.reset();
            this.var_412 = null;
         }
         if(this.var_348)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_54 == null)
         {
            this.var_54 = IWindowContainer(this._navigator.getXmlWindow(this.var_1059));
         ...
         this.var_54.x = _loc2_.x + this.var_2200 + param1.width;
