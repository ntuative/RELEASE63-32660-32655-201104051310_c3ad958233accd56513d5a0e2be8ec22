package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1352:CutToWidth = new CutToWidth();
      
      private static var var_1351:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1352.beforeSearch(param2,param1,param3);
         binarySearch(var_1352,param2.length - 1);
      }
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1351.beforeSearch(param2,param1,param3);
         binarySearch(var_1351,param2.length - 1);
      }
