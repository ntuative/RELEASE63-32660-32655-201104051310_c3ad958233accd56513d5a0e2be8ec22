package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_404:RoomInfoViewCtrl;
      
      private var var_1067:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_444:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2924:Dictionary;
      ...
      private var var_2107:RoomThumbnailRenderer;
      
      private var var_1018:GuestRoomPasswordInput;
      
      private var var_289:GuestRoomDoorbell;
      
      private var var_1068:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2108 = new Array();
         ...
         this.var_404 = new RoomInfoViewCtrl(this);
         this.var_1067 = new RoomCreateViewCtrl(this);
         this.var_2107 = new RoomThumbnailRenderer(this);
         this.var_1018 = new GuestRoomPasswordInput(this);
         this.var_289 = new GuestRoomDoorbell(this);
         this.var_444 = new Tabs(this);
         this.var_1068 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_334,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_404.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_169.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_169.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_36)
         {
            ...
            {
               this.var_404.handleToolbarEvent(param1);
            }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_169.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_60,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_290.startSearch(Tabs.const_258,Tabs.const_396,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_290.startSearch(Tabs.const_306,Tabs.const_257);
         this.var_444.getTab(Tabs.const_306).tabPageDecorator.tabSelected();
      }
