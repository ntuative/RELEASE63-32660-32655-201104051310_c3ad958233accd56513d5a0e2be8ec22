package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1100:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_587 = new Timer(100);
         this.var_587.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_587)
         {
            this.var_587.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_587.reset();
            this.var_587 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1100.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1657 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1657 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_62 = IItemListWindow(this.var_180.findChildByName("item_list"));
         ...
         this.var_1101 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_180.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1101.goBackToInitialState();
         this.var_1101.input.textBackgroundColor = 4294967295;
         this.var_1100 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_74,HabboWindowStyle.const_29,HabboWindowParam.const_62,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1101.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1101.getText();
         var _loc3_:String = "model_" + this.var_1100.name;
