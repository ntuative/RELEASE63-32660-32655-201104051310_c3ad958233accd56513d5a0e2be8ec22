package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_2788:ITextWindow;
      
      private var var_2787:ITextWindow;
      ...
      {
         if(param1 != this.var_391 || this.var_1263 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1596)
         {
            this.var_833.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1536)
         {
            this.var_1264.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1676)
         {
            this.setTagError(this.var_879,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_880,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1615)
         {
            this.setTagError(this.var_879,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_880,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1637)
         {
      ...
      private function clearErrors() : void
      {
         ...
         this.var_879.clearErrors();
         this.var_880.clearErrors();
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_317,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_574,this.onDoorModePasswordUnselect);
         ...
         this.var_833 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1264 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_879 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_880 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1018 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1266 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1260 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1265 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1267 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_676 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1997 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1544 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1259 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1262 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this._switchViewContainer = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1543 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_278 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1261 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2788 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2787 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1545 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1545.mouseThreshold = 0;
         this.var_1545.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1261.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1997.visible = this._inRoom;
         this._switchViewContainer.visible = this._inRoom;
         this.var_2787.visible = this.var_549;
         this.var_2788.visible = !this.var_549;
         if(this.var_549)
         {
            this.var_1262.visible = true;
            this.var_1543.visible = false;
            this.refreshFlatControllers();
            this.var_1262.height = Util.getLowestPoint(this.var_1262) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1259.visible = true;
            this.var_1543.visible = true;
            this.var_1544.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1544.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1259.height = Util.getLowestPoint(this.var_1259) + 4;
         }
         this.var_1545.text = !!this.var_549 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1997.name,this.var_1544.name,this.var_1259.name,this.var_1262.name,this.var_1543.name,this._switchViewContainer.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_833.setText(_loc1_.name);
         this.var_1264.setText(_loc1_.description);
         ...
         {
            case RoomSettingsData.const_208:
         ...
         this.setTag(this.var_879,_loc1_.tags[0]);
         this.setTag(this.var_880,_loc1_.tags[1]);
         if(this.var_1260)
         {
            if(_loc1_.allowPets)
            {
               this.var_1260.select();
            }
            else
            {
               this.var_1260.unselect();
            }
         }
         if(this.var_1265)
         {
         ...
         if(this.var_676)
         {
            ...
            {
               this.var_676.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_676.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.allowPets = this.var_1260.isSelected;
         _loc2_.allowFoodConsume = this.var_1265.isSelected;
         _loc2_.allowWalkThrough = this.var_1267.isSelected;
         _loc2_.hideWalls = this.var_676.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_879,_loc2_.tags);
         this.addTag(this.var_880,_loc2_.tags);
         this.clearErrors();
         this.var_1263 = _loc2_.roomId;
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_278.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_278.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_278.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_278.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_278.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_278.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_278.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_278);
         this.var_278.findChildByName("ruler").visible = true;
         ...
         if(this.var_78.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_278,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_74,HabboWindowStyle.const_29,HabboWindowParam.const_62,new Rectangle(0,0,100,20)));
      }
