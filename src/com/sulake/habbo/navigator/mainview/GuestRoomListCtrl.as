package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_564 = IScrollbarWindow(this.var_180.findChildByName("scroller"));
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1423,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_208,null,0);
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_210)
         {
            this.checkFastHorizontalMove(param1);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(this.var_530.visible && this.var_2603)
            {
               return;
            }
            ...
            if(_loc7_.ownerName != this._navigator.sessionData.userName)
            {
               ...
               switch(_loc7_.doorMode)
               {
                  case RoomSettingsFlatInfo.const_123:
                     ...
                     return;
                  case RoomSettingsFlatInfo.const_208:
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1492.tags[0];
            this.var_1492.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2604 - _loc2_.stageX);
         this.var_2604 = _loc2_.stageX;
         this.var_2603 = _loc3_ > 2;
      }
   }
}
