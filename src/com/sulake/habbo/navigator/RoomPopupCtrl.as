package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2107 = new RoomThumbnailRenderer(param1);
         this.var_1210 = new TagRenderer(param1,hideInstantly);
      }
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1210.refreshTags(_loc1_,this.var_118.tags);
         ...
         this.var_2107.refreshThumbnail(_loc1_,this.var_118.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_258,Tabs.const_240,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
