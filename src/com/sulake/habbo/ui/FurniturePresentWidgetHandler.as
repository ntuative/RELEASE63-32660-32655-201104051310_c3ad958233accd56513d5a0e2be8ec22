package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1331:String = "poster";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_778,RoomWidgetPresentOpenMessage.const_171];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_778:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = _loc5_.getNumber(RoomObjectVariableEnum.const_286);
                     _loc8_ = _loc5_.getString(RoomObjectVariableEnum.const_309);
            ...
            case RoomWidgetPresentOpenMessage.const_171:
               ...
               if(_loc4_.objectId != this.var_382)
               {
                  return null;
               }
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_292:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     else if(_loc2_.itemType == ProductTypeEnum.const_72)
                     {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_72:
                           if(_loc3_ != null && _loc3_.name == const_220)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_517,0,this._container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == TYPE_LANDSCAPE)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_582,0,this._container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == const_221)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_540,0,this._container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                              if(_loc3_ != null && _loc3_.name == const_1331)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_342:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_453,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
