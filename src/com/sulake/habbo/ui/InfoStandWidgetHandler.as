package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_229.events.addEventListener(NowPlayingEvent.const_856,this.onNowPlayingChanged);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_163,this.onFigureUpdate);
         ...
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_163,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_625.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_625.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_229 != null)
         {
            this.var_229.events.removeEventListener(NowPlayingEvent.const_856,this.onNowPlayingChanged);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_407);
         _loc1_.push(RoomWidgetUserActionMessage.const_883);
         _loc1_.push(RoomWidgetUserActionMessage.const_757);
         _loc1_.push(RoomWidgetUserActionMessage.const_808);
         _loc1_.push(RoomWidgetUserActionMessage.const_900);
         _loc1_.push(RoomWidgetUserActionMessage.const_845);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_264);
         _loc1_.push(RoomWidgetFurniActionMessage.const_704);
         _loc1_.push(RoomWidgetFurniActionMessage.const_820);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_658);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_737);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1702);
         _loc1_.push(RoomWidgetPetCommandMessage.const_454);
         _loc1_.push(RoomWidgetPetCommandMessage.const_832);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_557)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_411 || param1.type == RoomWidgetUserActionMessage.const_537 || param1.type == RoomWidgetUserActionMessage.const_502)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_407:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetUserActionMessage.const_883:
            ...
            case RoomWidgetUserActionMessage.const_808:
               ...
               break;
            case RoomWidgetUserActionMessage.const_900:
               this._container.sessionDataManager.ignoreUser(_loc3_.name);
               break;
            case RoomWidgetUserActionMessage.const_845:
            ...
            case RoomWidgetUserActionMessage.const_411:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_658:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_737:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_287);
               _loc6_.id = param1.id;
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_535) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_535);
               }
               ...
               {
                  _loc26_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_286);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1231);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1071);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc30_ = "";
                  _loc31_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_691)
                  {
                     _loc32_ = this.var_229.getRoomItemPlaylist();
                     if(_loc32_ != null)
                     {
                  ...
                  {
                     _loc33_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_410.length);
                     _loc28_ = parseInt(_loc33_);
                     _loc31_ = "null";
                  }
                  if(_loc28_ != -1)
                  {
                     _loc34_ = this.var_229.getSongInfo(_loc28_);
                     if(_loc34_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_181)
               {
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_907)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc19_ != null)
               {
                  _loc15_.carryItem = _loc19_.getModel().getNumber(RoomObjectVariableEnum.const_542);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_124)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_155)
               {
                  ...
                  if(_loc19_ != null)
                  {
                     _loc40_ = _loc19_.getModel().getString(RoomObjectVariableEnum.const_742);
                  ...
                  if(!_loc36_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1227;
                  }
                  if(!_loc37_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1033;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1651);
               }
               else
               {
               ...
               _loc21_ = _loc13_.sex;
               _loc22_ = this._container.avatarRenderManager.createAvatarImage(_loc20_,AvatarScaleType.const_54,_loc21_);
               if(_loc22_ != null)
               {
                  _loc22_.setDirection(AvatarSetType.const_37,4);
                  _loc15_.image = _loc22_.getImage(AvatarSetType.const_37,true);
                  _loc22_.dispose();
               }
      ...
      {
         return [RoomSessionUserBadgesEvent.const_73,RoomSessionUserGivableBadgesEvent.const_73];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_73:
               ...
               break;
            case RoomSessionUserGivableBadgesEvent.const_73:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_625.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_625.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_742);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_229 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_229.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_320,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_229 != null)
         {
            _loc2_ = this.var_229.getSongInfo(param1.id);
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_570,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
