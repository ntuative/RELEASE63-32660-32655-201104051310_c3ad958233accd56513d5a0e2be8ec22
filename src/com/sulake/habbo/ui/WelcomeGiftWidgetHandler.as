package com.sulake.habbo.ui
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_815 = [];
         this.var_815.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_815.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_815)
         {
            return;
         }
         for each(_loc1_ in this.var_815)
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetChangeEmailMessage.const_693);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniActionMessage.const_706:
               ...
               break;
            case RoomWidgetChangeEmailMessage.const_693:
