package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_675,RoomWidgetEcotronBoxOpenMessage.const_862,RoomWidgetEcotronBoxOpenedMessage.const_1502];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_675:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_862:
