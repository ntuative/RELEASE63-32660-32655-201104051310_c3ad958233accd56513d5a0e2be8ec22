package com.sulake.habbo.ui
{
   ...
   public class UserNotificationWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserNotificationMessage.const_1056);
         return _loc1_;
      }
      
      public function getProcessedEvents() : Array
      {
         return [RoomSessionUserNotificationEvent.const_119];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserNotificationEvent.const_119:
               _loc2_ = param1 as RoomSessionUserNotificationEvent;
               _loc3_ = new RoomWidgetUserNotificationEvent(RoomWidgetUserNotificationEvent.const_471);
