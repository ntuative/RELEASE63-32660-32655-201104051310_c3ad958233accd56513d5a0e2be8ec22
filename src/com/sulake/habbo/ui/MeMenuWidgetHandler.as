   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_881,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_833,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_169 && !this.var_169.disposed && this.var_169.events)
            {
               this.var_169.events.removeEventListener(HabboToolbarEvent.const_70,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_483,this.onHelpTutorialEvent);
         ...
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_881,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_833,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_483,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1552)
            {
               ...
               this.var_1552 = _loc2_;
               this.var_2006 = _loc1_;
            }
            else
            {
         ...
         if(this.var_169 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1215,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
               _loc5_.bitmapData = _loc1_;
            }
            this.var_169.events.dispatchEvent(_loc5_);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_876);
         _loc1_.push(RoomWidgetDanceMessage.const_726);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_773);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_919);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_404);
         _loc1_.push(RoomWidgetStopEffectMessage.const_673);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1608);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1032);
         _loc1_.push(RoomWidgetToolbarMessage.const_719);
         _loc1_.push(RoomWidgetToolbarMessage.const_812);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_360);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1534);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1211);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_784);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_689);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_754);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1659);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_817);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_763);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_697);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_689:
               ...
               break;
            case RoomWidgetWaveMessage.const_876:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_726:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_773:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_404:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1183)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_191,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_919:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1100:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1124:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1530:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_76);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1644:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_673:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_784:
               ...
               break;
            case RoomWidgetToolbarMessage.const_719:
               ...
               if(this.var_169)
               {
                  this.var_169.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_60,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
               ...
               break;
            case RoomWidgetToolbarMessage.const_812:
               ...
               {
                  this.var_169.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_495,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_360:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_590));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_754:
            ...
            case RoomWidgetStoreSettingsMessage.const_763:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_371,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_697:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
            ...
            case RoomWidgetClothingChangeMessage.const_382:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_873));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_914));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_483:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_576));
         }
      }
