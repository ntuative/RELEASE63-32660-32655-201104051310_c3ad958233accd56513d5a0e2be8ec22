package com.sulake.habbo.toolbar
{
   public class StateItem
   {
      ...
      private var var_202:int = 120;
      
      private var var_1734:String;
      
      private var var_1366:String = "-1";
      
      private var var_1733:String = "-1";
      
      private var var_1732:String = "-1";
      ...
      public function StateItem(param1:XML, param2:String)
      {
         ...
         {
            this.var_1470 = Boolean(param1.@loop);
         }
         ...
         {
            this.var_202 = int(param1.@timer);
         }
         if(param1.attribute("namebase").length() > 0)
         {
            this.var_1734 = param1.@namebase;
         }
         else
         {
         ...
         {
            this.var_1733 = this._id;
         }
         if(param1.attribute("state_default").length() > 0)
         {
            this.var_1732 = param1.@state_default;
         }
         if(param1.attribute("tooltip").length() > 0)
         {
            this.var_2356 = param1.@tooltip;
         }
         if(param1.attribute("background").length() > 0)
         {
            this.var_467 = param1.@background;
         }
