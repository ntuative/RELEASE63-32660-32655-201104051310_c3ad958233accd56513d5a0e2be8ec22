package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_2301:int = 5;
      
      private var var_2393:int;
      
      private var var_158:Number;
      
      private var var_2395:XML;
      ...
      {
         return this.var_1411.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2395.elements("menu");
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_752.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      {
         return this.var_752.indexOf(param1) > -1;
      }
      ...
      public function get size() : Number
      {
         ...
         {
            if(this.var_310[_loc2_].exists)
            {
               _loc1_ += this.var_1412;
            }
            _loc2_++;
         }
         return _loc1_;
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1413.length)
         {
            _loc2_ = this.var_752.indexOf(this.var_1413[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_310[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1233 + _loc3_);
                  _loc3_ += this.var_1412;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_310[this.var_752.indexOf(param1)];
      }
