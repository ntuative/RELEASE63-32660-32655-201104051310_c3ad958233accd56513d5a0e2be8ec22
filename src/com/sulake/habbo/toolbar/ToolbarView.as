package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_502:String = "LEFT";
      
      private var var_158:Number = 50;
      
      private var var_1144:Boolean = true;
      
      private var var_1143:Number = 1;
      
      private var var_1415:Number = 0;
      
      private var var_1765:Number = 15;
      
      private var var_1764:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IConnection, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_225 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_74,HabboWindowStyle.const_1186,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1144 = String(_loc8_.relocate_by_drag.@state) == "true";
         if(this.var_1144)
         {
         ...
         this.var_1143 = _loc8_.toolbar.@margin_top;
         this.var_1415 = _loc8_.toolbar.@margin_bottom;
         this.var_1765 = _loc8_.toolbar.@min_group_margin;
         this.var_1764 = _loc8_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc9_,this.var_252,param1,param2,param3,this._window,this.var_303);
         this.createGroupsFromXmlList(_loc10_,this.var_617,param1,param2,param3,this.var_225,this.var_303);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IConnection, param6:IWindowContainer, param7:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc11_ < param1.length())
         {
            ...
            _loc10_ = new ToolbarIconGroup(param3,param4,param5,_loc11_,this._events,param6,param7,this.var_158,this._config);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_158,this.var_502,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_502);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_158,this.var_502);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_158,this.var_502);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_829);
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_225.x = this.var_158 + this.var_1764;
               this.var_225.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_225.x = 0;
               this.var_225.y = this.var_158 + this.var_1764;
         ...
         _loc4_ -= this.var_1415;
         _loc4_ -= this.var_1143;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1143;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_252.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1765,(this._window.height - _loc5_ * _loc8_ - this.var_1143 - this.var_1415) / (this.var_252.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1765,(this._window.width - _loc5_ * _loc8_ - this.var_1143 - this.var_1415) / (this.var_252.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_252.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_502;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1144 && this.var_1414)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_502)
            {
               this.var_502 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_554);
                  _loc3_.orientation = this.var_502;
