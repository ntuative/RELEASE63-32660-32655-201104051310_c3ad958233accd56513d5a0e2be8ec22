package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_219:Boolean = true;
      
      private static const const_1393:Number = 25;
      
      private static const const_1389:Number = 90;
      
      private static const const_1008:int = 50;
      
      private static const const_1401:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1539:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_828 = new Timer(const_1393);
         this.var_828.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_389[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_1008 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_1008 || param1.desktop.height - param1.y < const_1401;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1539.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_389.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1539.getIconLoc(param1.iconId);
      ...
      {
         return this.var_668[this.var_667.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_667[this.var_668.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_667.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_667.splice(_loc3_,1);
            this.var_668.splice(_loc3_,1);
         }
         this.var_668.push(param1.name);
         this.var_667.push(param2);
         param1.addEventListener(WindowEvent.const_270,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_182,this.windowEventListener);
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_389.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_389.splice(this.var_389.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_668.length)
         {
            if(this.var_668[_loc2_] == param1.window.name)
            {
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_389.length)
         {
            _loc2_ = this._itemList[this.var_389[_loc7_]];
            if(_loc2_.active)
            {
