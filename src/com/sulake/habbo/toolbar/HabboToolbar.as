package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1384:LogoutController;
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_302.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
      }
      ...
      {
         this._view = new ToolbarView(this._windowManager,this._assetLibrary,this.var_302.getHabboMainConnection(null),events,this._config);
         if(this._config && this._config.getKey("client.logout.enabled","false") == "true")
         {
            this.var_1384 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_1215,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_134,this.onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_95,this.onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_60,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_495,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1127,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1133,this.onHideWindowEvent);
         this._state = true;
      ...
      private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         ...
         {
            if(param1.type == HabboToolbarShowMenuEvent.const_60)
            {
