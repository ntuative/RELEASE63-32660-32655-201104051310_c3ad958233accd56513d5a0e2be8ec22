package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_904:String = "RCL_LOADER_READY";
      
      private static const const_354:String = "RCL_PUBLICROOM_";
      
      private static const const_1746:int = 0;
      
      private static const const_964:int = 1;
      
      private static const name_4:int = 2;
      
      private static const const_436:String = "place_holder";
      
      private static const const_618:String = "wall_place_holder";
      
      private static const const_619:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_436;
      
      private static const const_620:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_965:String = "selection_arrow";
       
      
      private var var_516:Map = null;
      ...
      private var var_206:PublicRoomData = null;
      ...
      {
         this.var_368 = new Dictionary();
         this._wallItems = new Dictionary();
         this.var_434 = new Dictionary();
         this.var_2504 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_516.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_516.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_785.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_433.add(_loc3_,_loc4_);
               if(this.var_368[_loc7_] == null)
               {
                  this.var_368[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_633.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_634.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_634.remove(_loc7_);
               this.var_634.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2502)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_904));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_518 != null)
         {
            this.var_518.remove(param1);
            this.var_518.add(param1,param2);
         }
         if(this.var_517 != null)
         {
            this.var_517.remove(param2);
            this.var_517.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_518 != null)
         {
            _loc2_ = this.var_518.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_517 != null)
         {
            _loc2_ = this.var_517.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_206 != null && (this.var_206.type == param1 || this.var_206.hasWorldType(param1)))
         {
         ...
         {
            return RoomObjectCategoryEnum.const_347;
         }
         return RoomObjectCategoryEnum.const_165;
      }
      ...
      {
         return [const_436,const_618,const_619,const_620,TILE_CURSOR,const_965];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_433.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_633.getValue(param1) as String;
      ...
      {
         return this.var_955.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_956[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_633.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_785.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_206 != null && this.var_206.hasWorldType(const_354 + param1))
         {
            return this.var_206.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_234 || param1 == RoomObjectVisualizationEnum.const_75 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_634.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2503 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_368[_loc4_] == null)
                     {
                        this.var_368[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_206 = this.var_1459.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_775,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2504.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1712);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_434[_loc5_] != null)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_566,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_434[param1];
            this.var_956.add(_loc6_,_loc3_);
         }
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_516.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = this.var_516.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_516.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_545.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(this.getObjectCategory(const_354 + param1) == RoomObjectCategoryEnum.const_81)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_206.getWorldHeightScale(const_354 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_206 != null)
         {
            return this.var_206.getWorldScale(const_354 + param1);
         }
         return 32;
      }
      ...
      public function setActiveObjectType(param1:int, param2:String) : void
      {
         ...
         this.var_433.add(param1,param2);
      }
   }
}
