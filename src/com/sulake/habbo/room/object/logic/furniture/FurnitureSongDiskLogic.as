package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSongDiskLogic extends FurnitureLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            _loc2_ = object.getModelController().getString(RoomObjectVariableEnum.const_309);
            _loc3_ = int(_loc2_);
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_535,RoomWidgetInfostandExtraParamEnum.const_410 + _loc3_);
         }
      }
   }
}
