package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private static const const_437:int = 50;
      
      private static const const_953:int = 3000;
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_744 != _loc2_)
         {
            ...
            if(_loc3_ * const_437 > const_953)
            {
               this.var_1131 = const_953 / _loc3_;
            }
            else
            {
               this.var_1131 = const_437;
            }
            this.var_1386 = getTimer();
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_744 && param1 >= this.var_1386 + this.var_1131)
            {
               _loc3_ = param1 - this.var_1386;
               ...
               this.var_1386 = param1 - (_loc3_ - _loc4_ * this.var_1131);
            }
         }
      }
   }
