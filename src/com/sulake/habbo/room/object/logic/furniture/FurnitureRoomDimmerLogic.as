package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomDimmerLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_127,RoomObjectWidgetRequestEvent.const_108,RoomObjectDimmerStateUpdateEvent.const_64];
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_2005)
         {
            if(eventDispatcher != null && object != null)
            {
               ...
               _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_108,_loc1_,_loc2_);
