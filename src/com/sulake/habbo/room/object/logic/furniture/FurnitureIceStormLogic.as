   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2470 = param1.extra;
            this.var_1169 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1169 > 0 && param1 >= this.var_1169)
         {
            this.var_1169 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1733,String(this.var_1733),this.var_2470);
