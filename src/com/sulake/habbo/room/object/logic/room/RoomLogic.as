package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1454:uint = 16777215;
      
      private var var_1827:int = 255;
      
      private var var_1174:uint = 16777215;
      
      private var var_1828:int = 255;
      
      private var var_1175:int = 0;
      
      private var var_1825:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_460,RoomObjectMouseEvent.const_135];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1164,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_646,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_753,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_642,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_651,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1175)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1826;
            if(_loc2_ - this.var_1175 >= this.var_1825)
            {
               _loc3_ = this.var_1174;
               _loc4_ = this.var_1828;
               this.var_1175 = 0;
            }
            else
            {
               _loc7_ = this.var_1454 >> 16 & 255;
               _loc8_ = this.var_1454 >> 8 & 255;
               _loc9_ = this.var_1454 & 255;
               _loc10_ = this.var_1174 >> 16 & 255;
               _loc11_ = this.var_1174 >> 8 & 255;
               _loc12_ = this.var_1174 & 255;
               _loc13_ = (_loc2_ - this.var_1175) / this.var_1825;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1827 + (this.var_1828 - this.var_1827) * _loc13_;
               this._color = _loc3_;
               this.var_1826 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_646,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_925:
               param2.setString(RoomObjectVariableEnum.const_327,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_846:
               param2.setString(RoomObjectVariableEnum.const_298,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_802:
               param2.setString(RoomObjectVariableEnum.const_318,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_526:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_229)
               {
                  _loc5_ = "null";
               }
               this.var_524.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_770:
               _loc4_ = this.var_524.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_524.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1102,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1210:
               param2.setNumber(RoomObjectVariableEnum.const_753,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1116:
               param2.setNumber(RoomObjectVariableEnum.const_642,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_651,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1078,int(param1.bgOnly));
         this.var_1454 = this._color;
         this.var_1827 = this.var_1826;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_513,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1571,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1681,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1453,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_513,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_164 || _loc12_ == RoomPlaneData.const_339)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
