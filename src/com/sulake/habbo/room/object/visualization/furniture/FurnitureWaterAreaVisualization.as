package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1268:String = "shore";
      ...
      {
         if(this.var_2312 == param1 && this.var_2313 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1268)
            {
               this.var_1680 = _loc2_;
               this.var_2312 = param1;
               this.var_2313 = direction;
               return this.var_1680;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1112.indexOf(_loc2_) < 0)
            {
               this.var_1112.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_491 + 2;
         var _loc4_:int = this.var_595 + 2;
         var _loc5_:int = 0;
      ...
      {
         var _loc2_:* = null;
         if(this.var_491 == 0 || this.var_595 == 0)
         {
            ...
            this.var_491 = _loc2_.getNumber(RoomObjectVariableEnum.const_310);
            this.var_595 = _loc2_.getNumber(RoomObjectVariableEnum.const_424);
         }
         this.var_414 = [];
         this.var_594 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_491 * 2 + this.var_595 * 2)
         {
            this.var_414.push(false);
            this.var_594.push(ShoreMaskCreatorUtility.const_78);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_491 + 2;
         var _loc2_:int = this.var_595 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_70,getSize(param3),this.var_414,this.var_594,assetCollection);
      }
