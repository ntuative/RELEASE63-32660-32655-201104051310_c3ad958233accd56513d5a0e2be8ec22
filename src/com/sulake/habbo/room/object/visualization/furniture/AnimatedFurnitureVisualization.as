   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  if(this.usesAnimationResetting())
                  {
                     ...
                     if(_loc4_ > this.var_1935)
                     {
                        this.var_1935 = _loc4_;
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this._animationData.isImmediateChange(this.var_992,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this._animationData.hasAnimation(this.var_992,_loc6_))
                  {
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_120 != null)
         {
            this.var_120.setLayerCount(this.var_600);
         }
      }
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_120.animationOver || this.var_993)
         {
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc11_:* = null;
         var _loc12_:int = 0;
         if(param1.animationOver && !this.var_993)
         {
            return 0;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(!_loc9_ || this.var_993)
            {
               ...
               if(this.var_993 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  _loc12_ = 0;
                  if(_loc11_ != null)
                  {
                  ...
                  if(_loc12_ == AnimationFrame.const_1121)
                  {
               ...
               if(_loc11_ == null || _loc11_.remainingFrameRepeats == AnimationFrame.const_562)
               {
                  _loc10_ = true;
                  _loc9_ = true;
               }
