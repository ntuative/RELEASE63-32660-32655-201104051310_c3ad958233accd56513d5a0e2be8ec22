package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1723:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2472:Number = NaN;
      
      private var var_2475:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1171:String = null;
      ...
      private var var_2476:Number = 0.0;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1445 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1445;
            this.var_1445 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2376;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_402:
               break;
            case LayerData.const_1091:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1181:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_465 != _loc3_.getUpdateID() || param1 != var_89 || param2 != this.var_2472)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2475 = _loc3_.getNumber(RoomObjectVariableEnum.const_227);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_290));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1171 = this.getAdClickUrl(_loc3_);
            if(this.var_1171 == null || this.var_1171.indexOf("http") != 0)
            {
               this.var_1171 = null;
            }
            this.var_2376 = this.var_1171 != null;
      ...
      {
         if(this.var_2473 != param2 || this.var_2476 != param1)
         {
            this.var_950 = [];
            this.var_951 = [];
            this.var_772 = [];
            ...
            this.var_2474 = this.getSize(param1);
      ...
      {
         this.var_600 = param1;
         this.var_1814 = this.var_600 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_466.length)
         {
            return "";
         }
         var _loc3_:String = this.var_950[param2];
         var _loc4_:Boolean = this.var_951[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2474;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1814)
            {
               _loc6_ = FurnitureVisualizationData.const_466[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_950[param2] = _loc3_;
            this.var_951[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_771[param3] != null && !this.var_1813)
         {
