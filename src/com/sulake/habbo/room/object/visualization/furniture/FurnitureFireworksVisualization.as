package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureFireworksVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private var var_232:FurnitureParticleSystem;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_639)
         {
            for each(_loc1_ in this.var_639)
            {
               _loc1_.dispose();
            }
            this.var_639 = null;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               this.readDefinition();
               this.var_232 = this.var_639[param1];
               _loc3_ = true;
            }
      ...
      override protected function setAnimation(param1:int) : void
      {
         if(this.var_232)
         {
            this.var_232.setAnimation(param1);
         }
      ...
      {
         if(this.var_232 && this.var_232.controlsSprite(param3))
         {
            return this.var_232.getSpriteYOffset(param1,param2,param3);
         }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1239);
         if(_loc3_.length == 0)
         {
