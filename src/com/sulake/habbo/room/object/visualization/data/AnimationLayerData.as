   ...
   public class AnimationLayerData
   {
      ...
      public function calculateLength() : void
      {
         ...
         while(_loc1_ < this.var_238.length)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_464 += _loc2_.frameCount;
            }
            _loc1_++;
         }
      }
      ...
      public function getFrame(param1:int, param2:int) : AnimationFrame
      {
         ...
         var _loc3_:* = null;
         param2 /= this.var_2036;
         var _loc4_:Boolean = false;
         var _loc5_:int = 0;
         if(!this.var_1839)
         {
            _loc6_ = param2 / this.var_464;
            param2 %= this.var_464;
            if(this._loopCount > 0 && _loc6_ >= this._loopCount || this._loopCount <= 0 && this.var_464 == 1)
            {
               param2 = this.var_464 - 1;
               _loc4_ = true;
            }
            _loc7_ = 0;
            _loc5_ = 0;
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:int, param4:int, param5:Boolean) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            _loc12_ = this.var_2036 * _loc11_;
            if(param5)
            {
               _loc12_ = 0;
            }
            _loc13_ = false;
            if(!this.var_1839 && !param2.isRandom)
            {
