package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class AnimationData
   {
      ...
      public static const const_1959:int = 0;
      ...
      private var var_1432:Array = null;
      ...
      {
         if(this.var_1432 != null && this.var_1432.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function getStartFrame(param1:int) : int
      {
         ...
         return Math.random() * this.var_464;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         if(_loc10_ > this.var_464)
         {
            this.var_464 = _loc10_;
         }
         return true;
      }
