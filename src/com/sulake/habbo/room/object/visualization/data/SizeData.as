package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_380:int = 1000;
      ...
      private var var_1526:int = 360;
      
      private var var_826:DirectionData = null;
      
      private var var_273:Map;
      
      private var _colors:Map;
      
      private var var_1249:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_826 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_273 != null)
         {
            ...
            {
               _loc2_ = this.var_273.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_826,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_273.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_826);
            this.defineDirection(_loc3_,_loc8_);
            this.var_273.add(String(_loc7_),_loc3_);
            this.var_1968 = -1;
            this.var_1249 = null;
            _loc5_++;
         }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1091);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1181);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1526 / 2) % 360 / this.var_1526;
         if(this.var_273.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_273.getKey(_loc5_)) * this.var_1526;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_273.getKey(_loc4_));
         }
         return const_1604;
      }
      ...
      {
         if(param1 == this.var_1968)
         {
            return this.var_1249;
         }
         var _loc2_:* = null;
         _loc2_ = this.var_273.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_826;
         }
         this.var_1968 = param1;
         this.var_1249 = _loc2_;
         return this.var_1249;
      }
