package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1316:String = "head";
      
      private static const const_615:int = 1;
      
      private static const const_958:int = 1000;
      
      private static const const_1317:String = "pet_experience_bubble_png";
      
      private static const const_1318:int = 0;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1317) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2459)
            {
               this.var_2459 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_175)
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_263);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_144);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_263);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_1835 = _loc3_.getNumber(RoomObjectVariableEnum.const_361) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_196);
            if(!isNaN(_loc8_))
            {
               this.var_1801 = _loc8_;
            }
            else
            {
               this.var_1801 = direction;
            }
            this.var_1436 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2346 = _loc3_.getNumber(RoomObjectVariableEnum.const_852);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_794);
            if(_loc9_ != this.var_1800)
            {
               this.var_1800 = _loc9_;
               this.var_2458 = this.var_1800.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_366 != null)
         {
            ...
            if(this.var_1436 > 0)
            {
               ...
               if(_loc2_ < const_958)
               {
                  this.var_366.alpha = int(Math.sin(_loc2_ / const_958 * 0) * 255);
      ...
      {
         return super.getAdditionalSpriteCount() + const_615;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2458);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_615)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_615))
            {
               if(param2 >= FurnitureVisualizationData.const_466.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_466[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1801);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_89,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1316)
            {
               this.var_947[param1] = true;
            }
            else
            {
               this.var_947[param1] = false;
            }
         }
