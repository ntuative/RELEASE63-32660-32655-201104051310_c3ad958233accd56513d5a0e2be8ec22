package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_893:IPlaneRasterizer = null;
      
      private var var_704:PlaneMaskManager = null;
      ...
      private var var_411:PlaneBitmapData = null;
      ...
      private var var_725:Boolean = true;
      ...
      {
         return this._isVisible && this.var_725;
      }
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_611);
                  return param1;
               }
            }
         }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_893.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_411;
         if(_loc3_ == null)
         {
         ...
         if(this.var_725 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_347))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_299.length * param1.scale;
            ...
            if(this.var_893 != null)
            {
               _loc3_ = this.var_893.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1661,this.var_2289,this.var_2287,this.var_2286,this.var_2290,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1609 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_725)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1359.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1359[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1073);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_150.z - originZ,this.var_112.z - originZ,this.var_84.z - originZ,this.var_113.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2184 = relativeDepth;
            this._isVisible = true;
            this.var_1609 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2288);
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_894)
         {
            ...
            {
               _loc4_ = this.var_246[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_246.length == this.var_895.length)
         {
            while(_loc1_ < this.var_246.length)
            {
               _loc4_ = this.var_246[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
         ...
         if(this.var_346.length > this.var_1358.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_894 || this.var_246.length == 0 && this.var_346.length == 0 && !this.var_347 || this.var_704 == null)
         {
            return;
         }
         ...
         if(this.var_347)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_579);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_246.length)
            {
               _loc3_ = this.var_246[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_70.width - this.var_70.width * _loc3_.leftSideLoc / this.var_299.length;
                  _loc11_ = this.var_70.height - this.var_70.height * _loc3_.rightSideLoc / this.var_298.length;
                  _loc12_ = _loc3_.type;
                  this.var_704.updateMask(this.var_70,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_346.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_70.width - this.var_70.width * _loc4_.leftSideLoc / this.var_299.length;
                  _loc11_ = this.var_70.height - this.var_70.height * _loc4_.rightSideLoc / this.var_298.length;
                  _loc13_ = this.var_70.width * _loc4_.leftSideLength / this.var_299.length;
                  _loc14_ = this.var_70.height * _loc4_.rightSideLength / this.var_298.length;
                  this.var_70.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1358.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_347 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_219.copyChannel(param1,param1.rect,const_611,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_219.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_219,this.var_219.rect,const_611,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
