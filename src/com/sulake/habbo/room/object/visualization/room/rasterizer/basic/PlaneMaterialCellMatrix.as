package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1636:int = const_377;
      ...
      public static const ALIGN_DEFAULT:int = const_114;
         ...
         if(this.isStatic)
         {
            if(this.var_29 != null)
            {
               if(this.var_29.width == param2 && this.var_29.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_591,param6,param7);
                     return param1;
                  }
                  return this.var_29;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this._align == const_114)
         {
            _loc5_ = new Rectangle(0,0,this.var_29.width,this.var_591);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_29.height - this.var_591,this.var_29.width,this.var_591);
         }
