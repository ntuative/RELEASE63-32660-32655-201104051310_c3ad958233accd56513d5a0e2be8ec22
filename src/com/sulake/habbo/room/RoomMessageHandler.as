package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1513:int = -1.0E9;
      
      private var var_822:Object;
      
      public function RoomMessageHandler(param1:IRoomCreator)
      {
         this.var_822 = new Object();
         super();
         this.var_12 = param1;
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_822.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_822.objectData);
            this.var_822.objectData = null;
         }
         else
         {
            this.var_822.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_822.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_822.objectData = _loc6_;
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_892);
         var _loc8_:int = 0;
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_1099:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1031:
                     _loc10_ = "std";
               }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1207,_loc3_.status);
         }
      }
