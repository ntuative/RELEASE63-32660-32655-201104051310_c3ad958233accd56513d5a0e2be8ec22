   ...
   public class RoomObjectFactory extends Component implements IRoomObjectFactory
   {
      ...
      public function addObjectEventListener(param1:Function) : void
      {
         ...
         if(this.var_980.indexOf(param1) < 0)
         {
            ...
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1201.getKeys())
               {
      ...
      public function createRoomObjectLogic(param1:String) : IRoomObjectEventHandler
      {
         ...
         switch(param1)
         {
            ...
            case RoomObjectLogicEnum.const_1434:
               ...
               break;
            case RoomObjectLogicEnum.const_1517:
               _loc2_ = FurniturePresentLogic;
               break;
            case RoomObjectLogicEnum.const_1656:
               _loc2_ = FurnitureTrophyLogic;
               break;
            case RoomObjectLogicEnum.const_1680:
            ...
            case RoomObjectLogicEnum.const_1567:
               ...
               break;
            case RoomObjectLogicEnum.const_1627:
            ...
            case RoomObjectLogicEnum.const_1638:
               ...
               break;
            case RoomObjectLogicEnum.const_1528:
            ...
            case RoomObjectLogicEnum.const_1649:
               ...
               break;
            case RoomObjectLogicEnum.const_1503:
         ...
         if(_loc3_ is IRoomObjectEventHandler)
         {
            ...
            if(this.var_1882.getValue(param1) == null)
            {
               this.var_1882.add(param1,true);
