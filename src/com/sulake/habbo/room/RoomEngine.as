package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_607:String = "temporary_room";
      ...
      private static const const_1260:String = "tile_cursor";
      
      private static const const_943:int = -3;
      
      private static const const_1261:String = "selection_arrow";
      
      private static const OVERLAY_SPRITE:String = "overlay";
      
      private static const const_351:String = "object_icon_sprite";
      
      private static const const_433:int = 15;
      
      private static const const_942:int = 40;
      ...
      private var var_884:IRoomRendererFactory = null;
      
      private var var_718:IRoomObjectFactory = null;
      
      private var var_545:IRoomObjectVisualizationFactory = null;
      ...
      private var var_717:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_717 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_718.release(new IIDRoomObjectFactory());
            this.var_718 = null;
         }
         if(this.var_545 != null)
         {
            this.var_545.release(new IIDRoomObjectVisualizationFactory());
            this.var_545 = null;
         }
         ...
         {
            this.var_884.release(new IIDRoomRendererFactory());
            this.var_884 = null;
         }
         ...
         if(this.var_300 != null)
         {
            ...
            {
               _loc2_ = this.var_300.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_300.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_300.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            _loc2_ = this._roomManager.getRoom(this.getRoomIdentifier(this.var_97,this.var_96));
      ...
      {
         this.var_1080 = false;
         if(this.var_486 && this.var_486.length > 0)
         {
      ...
      private function addBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc3_:int = this.var_486.indexOf(param2);
         if(_loc3_ == -1)
         {
            this.var_486.push(param2);
            this.var_1080 = true;
         }
      }
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_885 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_300.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               _loc9_ = _loc4_.method_3;
               _loc10_ = this.getRoomObject(_loc5_,_loc6_,_loc8_,_loc9_);
               if(_loc10_ != null)
               {
                  if(_loc5_ != this.var_97 || _loc6_ != this.var_96 || !this.var_1082)
                  {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc14_ || _loc9_.screenHt != _loc15_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc))
               {
                  ...
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_671) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_760) - 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_825) + 0.5;
                  _loc20_ = _loc10_.getNumber(RoomVariableEnum.const_809) + 0.5;
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_718 = param2 as IRoomObjectFactory;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_545 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_13 != null)
         {
            this.var_13.visualizationFactory = this.var_545;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_347);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_884 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_904,this.onContentLoaderReady);
            this.var_13.initialize(events,this.var_161);
         }
         this.var_2205 = this.var_161.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_904)
         {
            this.var_2204 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_322.events.addEventListener(AdEvent.const_581,this.showRoomAd);
         this.var_322.events.addEventListener(AdEvent.const_853,this.onRoomAdImageLoaded);
         this.var_322.events.addEventListener(AdEvent.const_842,this.onRoomAdImageLoaded);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_13.sessionDataManager = this._sessionDataManager;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_718 != null)
         {
            this.var_718.addObjectEventListener(this.roomObjectEventHandler);
         }
      }
      
      private function initializeRoomManager() : void
      {
         if(this.var_718 == null || this.var_545 == null || this._roomManager == null || this.var_884 == null || this._communication == null || this.var_161 == null || !this.var_2204)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_485 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_769,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_343.length)
            {
               _loc3_ = this.var_343.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1206,_loc5_);
            if(_loc5_ == 0)
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1206);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_485)
         {
            _loc5_ = this.var_343.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_343.add(_loc4_,_loc5_);
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_312,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_352,_loc11_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1158,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_848,1,true);
            _loc12_ = parseInt(this.var_161.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1083,_loc12_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_352,const_608,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_848,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_892,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_671,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_825,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_760,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_809,_loc18_);
               _loc13_ += _loc15_ * 423 + _loc16_ * 671 + _loc17_ * 913 + _loc18_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1049,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_925,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_327,param3);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_846,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_298,param4);
            }
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_802,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_318,param5);
            }
            if(param2 != null)
            {
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_526,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_229);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_711,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_649,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_711,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_649,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1112,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1203,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_944,const_1260,RoomObjectCategoryEnum.const_347);
         if(this.var_161.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_943,const_1261,RoomObjectCategoryEnum.const_347);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_352,RoomObjectCategoryEnum.const_81);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc10_ = this.var_343.getValue(_loc9_);
            if(_loc10_ == null)
            {
               _loc10_ = new RoomData(param1,param2,null);
               this.var_343.add(_loc9_,_loc10_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_925,param3);
         ...
         if(param4 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_846,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc8_);
         }
         if(param5 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_802,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc8_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1597,param3,param4,param5);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1116,param3);
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_300.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_335,param1,param2));
      }
      ...
      public function setOwnUserId(param1:int, param2:int, param3:int) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            _loc4_.method_3 = RoomObjectCategoryEnum.const_34;
         }
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_884.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_892);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_711);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_649);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1112);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1203);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc8_:int = param2 - this.var_1344;
         var _loc9_:int = param3 - this.var_1342;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1082 = true;
               this.var_883 = false;
               this.var_2203 = this.var_1344;
               this.var_2206 = this.var_1342;
            }
         }
         else if(param4 == MouseEvent.MOUSE_UP)
         {
            if(this.var_1082)
            {
               ...
               if(this.var_2205)
               {
                  _loc10_ = this.getRoomInstanceData(this.var_97,this.var_96);
                  if(_loc10_ != null)
                  {
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1082)
            {
               if(!this.var_883)
               {
                  _loc8_ = param2 - this.var_2203;
                  _loc9_ = param3 - this.var_2206;
                  if(_loc8_ <= -const_433 || _loc8_ >= const_433 || _loc9_ <= -const_433 || _loc9_ >= const_433)
                  {
                     this.var_883 = true;
                  }
                  _loc8_ = 0;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_97,this.var_96,param1);
         if(_loc9_ != null)
         {
            _loc10_ = this.getOverlaySprite(_loc9_);
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_351);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_552,this.var_97,this.var_96,-1,RoomObjectCategoryEnum.const_165));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_75 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_352,const_608);
                     this.var_75.handleRoomObjectEvent(_loc14_,this.var_97,this.var_96);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc5_ = this.getRoomObjectImage(this.var_97,this.var_96,param1,param2,new Vector3d(),1,null);
         }
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_97,this.var_96,this.var_1343);
         if(_loc6_ != null)
         {
            _loc9_ = this.getOverlaySprite(_loc6_);
            this.removeOverlayIconSprite(_loc9_,const_351);
            _loc10_ = this.addOverlayIconSprite(_loc9_,const_351,_loc5_.data);
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1344 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1342 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_97,this.var_96,this.var_1343);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_351);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_97,this.var_96,this.var_1343);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_351);
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_75 != null)
         {
            return this.var_75.modifyRoomObject(this.var_97,this.var_96,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_75 != null)
         {
            ...
            {
               return this.var_75.modifyWallItemData(this.var_97,this.var_96,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_75 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_75.deleteWallItem(this.var_97,this.var_96,param1);
            }
         }
         return false;
      }
      ...
      {
         var _loc5_:IRoomInstance = this.getRoom(this.var_97,this.var_96);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_848) != 0)
         {
            return false;
         }
         if(this.var_75 != null)
         {
            return this.var_75.initializeRoomObjectInsert(this.var_97,this.var_96,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_75 != null)
         {
            this.var_75.cancelRoomObjectInsert(this.var_97,this.var_96);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_943,RoomObjectCategoryEnum.const_347);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_944,RoomObjectCategoryEnum.const_347);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_227,_loc7_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_286,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_412,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_897,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1231,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1071,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_428,param1,param2,param3,RoomObjectCategoryEnum.const_27));
         }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_227,_loc6_,false);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_286,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_412,_loc7_,true);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_428,param1,param2,param3,RoomObjectCategoryEnum.const_26));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1154) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1139);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_526,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_770,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_428,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
         return true;
      }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_901,this.var_97,this.var_96,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_75 != null)
         {
            this.var_75.handleRoomObjectEvent(param1,this.var_97,this.var_96);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_227));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_309);
                     break;
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               _loc8_.addPlane(RoomPlaneData.const_183,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
               _loc8_.addPlane(RoomPlaneData.const_164,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
               _loc8_.addPlane(RoomPlaneData.const_164,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc8_.addPlane(RoomPlaneData.const_339,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               _loc9_ = _loc8_.getXML();
               param1.getEventHandler().initialize(_loc9_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_327,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_298,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_318,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_526,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         _loc10_.id = -1;
         if(!this.var_485 || param1 == null)
         {
            return _loc10_;
         }
         var _loc11_:IRoomInstance = this._roomManager.getRoom(const_607);
         if(_loc11_ == null)
         {
            _loc11_ = this._roomManager.createRoom(const_607,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         }
         var _loc12_:int = this.var_717.reserveNumber();
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.const_27:
            case RoomObjectCategoryEnum.const_26:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_227,int(param2));
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_309,param7);
               break;
            case RoomObjectCategoryEnum.const_34:
               if(param1 == "user" || param1 == "bot" || param1 == "pet")
               {
                  _loc14_.getModelController().setString(RoomObjectVariableEnum.const_190,param2);
               }
               else
               {
         ...
         {
            this.var_1081.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1052,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_717.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_97,this.var_96,const_352,RoomObjectCategoryEnum.const_81,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this._roomManager.getRoom(const_607);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1052);
               ...
               this.var_717.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1081.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_381,param1.image,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1122,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1147,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1065,RoomObjectVariableEnum.const_381,param1.clickUrl);
      ...
      public function requestRoomAdImage(param1:int, param2:int, param3:String, param4:String) : void
      {
         ...
         {
            this.var_322.loadRoomAdImage(param1,param2,param3,param4);
         }
      }
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_853:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1022,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
               break;
            case AdEvent.const_842:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1059,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
         }
         if(_loc4_ != null)
         {
            _loc3_.getEventHandler().processUpdateMessage(_loc4_);
