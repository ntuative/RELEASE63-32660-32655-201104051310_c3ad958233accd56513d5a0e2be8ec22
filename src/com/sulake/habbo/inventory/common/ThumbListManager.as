package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_91 = this.var_590.height;
         this.var_1104 = param5;
         this.var_898 = param6;
         this.var_220 = Math.floor(this.var_1104 / this._thumbWidth);
         this.var_25 = new BitmapData(this.var_1104,this.var_898);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_589 = this.resolveRowCountFromList();
         if(this.var_589 == 0)
         {
            this.var_25 = new BitmapData(this.var_1104,this.var_898);
            return;
         }
         this.var_25 = new BitmapData(Math.max(this.var_220 * this._thumbWidth,this.var_1104),Math.max(this.var_589 * this.var_91,this.var_898),true,16777215);
         this.var_25.fillRect(this.var_25.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_589)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_220)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     this.var_25.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * this._thumbWidth,_loc3_ * this.var_91),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_220 && this.var_25.height < _loc3_.y * this.var_91)
         {
            _loc2_ = new BitmapData(this.var_25.width,this.var_25.height + this.var_91);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_220 - 1),0,this._thumbWidth,this.var_25.height);
         _loc2_.copyPixels(this.var_25,_loc4_,new Point(0,this.var_91),null,null,true);
         _loc4_ = new Rectangle(0,this.var_91,this._thumbWidth * (this.var_220 - 1),this.var_25.height - this.var_91);
         _loc2_.copyPixels(this.var_25,_loc4_,new Point(this._thumbWidth,this.var_91),null,null,true);
         this.var_25 = _loc2_;
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < this.var_589 - 1)
         {
            _loc7_ = this.var_25.width - this._thumbWidth;
            _loc8_ = this.var_25.height - (param1.y + 1) * this.var_91;
            ...
            this.var_25.fillRect(new Rectangle(0,this.var_25.height - this.var_91,this.var_25.width,this.var_91),4294967295);
            _loc3_ = new Point(this.var_25.width - this._thumbWidth,_loc2_.y - this.var_91);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(this.var_25.width,this.var_25.height - this.var_91);
               _loc2_ = new Rectangle(0,0,this.var_25.width,this.var_25.height - this.var_91);
               _loc11_.copyPixels(this.var_25,_loc2_,new Point(0,0),null,null,true);
               this.var_25 = _loc11_;
               --this.var_589;
            }
         }
         if(this.var_25.height < this.var_898)
         {
            _loc12_ = new BitmapData(this.var_25.width,this.var_898);
