package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1585:uint = 9;
      
      public static const const_204:uint = 0;
      
      public static const const_193:uint = 1;
      
      public static const const_376:uint = 2;
      
      public static const const_349:uint = 3;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_761 = true;
         this.state = const_193;
         this.var_55.setup(param1,param3,param4,param6);
         this.var_55.updateItemList(this.var_767);
      ...
      public function close() : void
      {
         if(this.var_761)
         {
            if(this._state != const_204 && this._state != const_245)
            {
      ...
      {
         this.var_55.setMinimized(param1 != InventoryCategory.const_76);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_766 + " OTHER: " + this.var_1163);
         ...
         {
            case const_204:
               if(param1 == const_193 || param1 == const_245)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      {
         if(this._state == const_376)
         {
            this.state = const_349;
         }
      }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_55.alertPopup(TradingView.const_1171);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_767)
            {
               this.var_766 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1163 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_55.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_767)
            {
               this.var_55.alertPopup(TradingView.const_1238);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_258.length < const_1585)
         {
