package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_952:uint = 4284532064;
      
      private static const const_951:uint = 2577770;
      
      public static const const_1051:int = 0;
      ...
      private var var_601:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_601 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_202)
            {
               this.var_202.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_202.stop();
               this.var_202 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1721 = this.createMinimizedWindow();
         }
         if(!this.var_2347)
         {
            return this.var_71;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_71)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_17.ownUserAccepts ? uint(const_952) : uint(const_951);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_17.otherUserAccepts ? uint(const_952) : uint(const_951);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_202 = new Timer(1000,3);
            this.var_202.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_202.reset();
         this.var_202.repeatCount = 3;
         this.var_202.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_202.currentCount));
         if(this.var_202.currentCount == 3)
         {
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1547)
            {
            ...
            this.var_601.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_446);
            this.var_601.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_601.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         var _loc7_:ISongInfo = this.var_376.musicController.getSongInfo(_loc6_.extra);
         if(_loc7_ != null)
         {
         ...
         else if(param3)
         {
            ...
            this.var_182.push(param4);
            this.var_182.push(param1);
            this.var_182.push(param5);
            this.var_376.musicController.requestSongInfoWithoutSamples(_loc6_.extra);
         }
         return param2;
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_182.length > 0)
         {
            _loc2_ = this.var_182.pop();
            _loc3_ = this.var_182.pop();
            _loc4_ = uint(this.var_182.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_17.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_17.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_601.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_446);
               }
            }
            else
            {
               this.var_182.push(_loc4_);
               this.var_182.push(_loc3_);
