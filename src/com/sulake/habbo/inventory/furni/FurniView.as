package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1762:int = 120;
      ...
      private var var_780:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_376 = param6;
         this.var_376.events.addEventListener(SongInfoReceivedEvent.const_140,this.onSongInfoReceivedEvent);
         this.var_442 = new Map();
         this.var_442.add(FurniModel.const_48,new FurniGridView(this.var_69,FurniModel.const_48,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_442.add(FurniModel.const_51,new FurniGridView(this.var_69,FurniModel.const_51,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_376)
            {
               if(this.var_376.events != null)
               {
                  this.var_376.events.removeEventListener(SongInfoReceivedEvent.const_140,this.onSongInfoReceivedEvent);
               }
               this.var_376 = null;
            }
            this.var_182 = null;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_442.getValue(this.var_441);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_69.getCategoryContent(this.var_441);
         if(!this.var_69.isListInited())
         {
            _loc2_ = this.const_964;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1761;
         }
         else
         {
            _loc2_ = this.const_1764;
         }
         if(this.var_2334 == _loc2_)
         {
            return;
         }
         this.var_2334 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_48,FurniModel.const_51];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_442.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_442.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_442.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_69.getGroupItemInIndex(_loc3_,this.var_441);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_298);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_327);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_318);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_780 && this.var_780.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc13_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_774)
               {
                  _loc24_ = this.var_376.musicController.getSongInfo(_loc5_.extra);
                  if(_loc24_ != null)
                  {
                     _loc13_.text = _loc24_.name;
                  }
                  else
                  {
                     this.var_376.musicController.requestSongInfoWithoutSamples(_loc5_.extra);
                     this.var_182.push(_loc5_.extra);
                  }
               }
            }
         ...
         if(_loc14_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_774)
               {
                  _loc25_ = this.var_376.musicController.getSongInfo(_loc5_.extra);
                  if(_loc25_ != null)
                  {
                     _loc14_.text = _loc25_.creator;
                  }
                  else
                  {
                     this.var_376.musicController.requestSongInfoWithoutSamples(_loc5_.extra);
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1762)
         {
            _loc3_ = this.const_1762;
         }
         ...
         else if(param1.type == WindowEvent.const_59)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_365);
            }
         }
      }
      ...
      {
         if(this.var_182.indexOf(param1.id as Number) != -1)
         {
            this.updateActionView();
            while(this.var_182.indexOf(param1.id as Number) != -1)
            {
               this.var_182.splice(this.var_182.indexOf(param1.id as Number),1);
            }
         }
      }
   }
