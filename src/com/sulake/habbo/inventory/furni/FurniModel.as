package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_48:String = "S";
      
      public static const const_51:String = "I";
      
      public static const const_365:String = "pets";
      ...
      private var var_1747:Vector.<Array>;
      
      private var var_1746:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_376 = param8;
         this.var_609 = new Timer(const_1283,1);
         this.var_609.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2366 = XML(_loc10_.content);
         this.clearFurniList();
         this._view = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine,this.var_376);
         this._view.switchCategory(const_48);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_609.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_609.stop();
               this.var_609 = null;
            }
            if(this.var_203 != null)
            {
               this.var_203.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_203.stop();
               this.var_203 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_48)
            {
               ...
               {
                  this.var_1747 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1747;
            }
            else
            {
               if(this.var_1746 == null)
               {
                  this.var_1746 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1746;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_299)
         {
         ...
         if(this.var_918 == null)
         {
            this.var_918 = this._windowManager.buildFromXML(this.var_2366) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_918.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_48,const_51];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_203 = new Timer(param1,1);
            this.var_203.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_203.start();
         }
         else
         {
         ...
         if(param1 == InventoryCategory.const_76 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_51:
                  ...
                  break;
               case const_365:
                  this._controller.toggleInventoryPage(InventoryCategory.const_141);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_422);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_48,const_51];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_48,const_51];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_610.add(const_48,new Array());
         this.var_610.add(const_51,new Array());
         if(this._view != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_328 || _loc3_.category == FurniCategory.const_344 || _loc3_.category == FurniCategory.const_299)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_610.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_610.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_659)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
