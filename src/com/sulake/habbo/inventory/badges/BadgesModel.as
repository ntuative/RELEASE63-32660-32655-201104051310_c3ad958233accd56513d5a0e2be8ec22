package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2045:int = 5;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_1040.length)
         {
            if(this.var_1040[_loc2_] == param1)
            {
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this._sessionDataManager.getBadgeImage(param1);
