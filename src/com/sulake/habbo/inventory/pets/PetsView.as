package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_396:PetsGridItem;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_396);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_682.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_264.removeGridItem(_loc2_.window);
         if(this.var_396 == _loc2_)
         {
            this.var_396 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_682 == null || this.var_682.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_682.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_682.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_682.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_396.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_59)
         {
            ...
            {
               case "tab_floor":
                  this.var_69.switchCategory(FurniModel.const_48);
                  break;
               case "tab_wall":
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_396 != null)
         {
            this.var_396.setSelected(false);
         }
         this.var_396 = param1;
         if(this.var_396 != null)
         {
            this.var_396.setSelected(true);
         }
