package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_856:int = 0;
      
      protected var var_689:BitmapData;
      
      protected var var_2808:int;
      
      protected var var_1576:Boolean;
      
      protected var var_2091:Boolean;
      
      protected var var_2865:BitmapData;
      
      private const const_2008:int = 8947848;
      
      private const const_2009:int = 13421772;
      
      private const const_1734:Number = 1;
      
      private const const_1735:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this._type = param1;
         this._window = param4;
         this.var_1417 = this._window.findChildByTag("BG_COLOR");
         this._roomEngine = param5;
         this.var_2865 = param6;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2864 == FurniModel.const_48)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1354));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2090);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_659)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1735;
               _loc1_.blend = this.const_1735;
            }
            else
            {
               this._window.blend = this.const_1734;
               _loc1_.blend = this.const_1734;
            }
         }
         if(this.isSelected)
         {
            this.var_1417.color = this.const_2008;
         }
         else
         {
            this.var_1417.color = this.const_2009;
         }
