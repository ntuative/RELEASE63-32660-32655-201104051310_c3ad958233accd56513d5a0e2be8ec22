   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc6_.method_1 >= 0)
            {
               _loc7_.isActive = true;
               _loc7_.secondsLeft = _loc6_.method_1;
               ++_loc7_.effectsInInventory;
            }
            else if(_loc6_.method_1 == -1)
            {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_916);
         _loc2_.refreshViews();
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_141);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_422);
      ...
      {
         var _loc2_:* = null;
         if(this._inventory.isInventoryCategoryInit(InventoryCategory.const_422))
         {
