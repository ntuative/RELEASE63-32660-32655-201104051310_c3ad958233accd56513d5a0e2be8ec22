package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      private var var_1271:Dictionary;
      ...
      {
         this.var_1271 = new Dictionary();
         super();
         this.var_69 = param1;
         this._assetLibrary = param3;
         this._windowManager = param2;
         this._sessionDataManager = param5;
         ...
         this.var_456.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this._sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_142,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_456)
            {
               this.var_456.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_456.reset();
               this.var_456 = null;
            }
            this._disposed = true;
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_456.running);
         this.var_1271[param1.badgeId] = param1.badgeImage;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1271[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this._sessionDataManager.getBadgeImage(param2.badgeId);
            this.var_1271[param2.badgeId] = _loc4_;
         }
