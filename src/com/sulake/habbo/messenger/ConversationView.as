package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_959:int = 100;
      
      private static const const_1319:int = 20;
       
      
      private var var_143:HabboMessenger;
      
      private var var_2462:IScrollbarWindow;
      
      private var var_1802:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_143 = param1;
         this.var_1802 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_62 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2462 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_143.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_959 + const_1319)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_143.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1320;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1802.enable();
         }
         else
         {
            this.var_1802.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_62.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_511.messages.length - const_959);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_143.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_728 || param3.type == Message.const_707 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_143.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_143.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_143.send(new FollowFriendMessageComposer(this.var_511.id));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_143.conversations.closeConversation();
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_707)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1230)
         {
            return 4294927974;
         }
