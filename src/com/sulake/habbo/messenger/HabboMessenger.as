package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_572:Conversations;
      
      private var var_242:MessengerView;
      ...
      {
         var _loc2_:Conversation = this.var_572.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            this.var_572.setSelected(_loc2_);
            this.var_242.openMessenger();
            this.var_242.refresh();
         }
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_572.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_572.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      public function playSendSound() : void
      {
         ...
         {
            this.var_376.playSound(HabboSoundTypesEnum.const_1204);
         }
      }
      ...
      {
         this.var_572 = new Conversations(new ConversationsDeps(this));
         this.var_242 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            this.var_169.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         this.var_169.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.MESSENGER));
         var _loc3_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_95,HabboToolbarIconEnum.MESSENGER);
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_242.isMessengerOpen())
            {
               this.var_242.close();
            }
            else
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_707,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1137,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_572.addMessageAndUpdateView(param1);
         if(!this.var_242.isMessengerOpen())
         {
            if(this.var_376 != null)
            {
               this.var_376.playSound(HabboSoundTypesEnum.const_1176);
            }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1230,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_572.addMessageAndUpdateView(_loc3_);
      }
