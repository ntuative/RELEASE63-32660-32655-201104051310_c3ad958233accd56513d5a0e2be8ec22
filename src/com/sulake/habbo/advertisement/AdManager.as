package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1165:BitmapData = null;
      
      private var var_1166:BitmapData = null;
      ...
      {
         this.var_302 = param2 as IHabboCommunicationManager;
         if(this.var_302 == null)
         {
            return;
         }
         this._connection = this.var_302.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2463 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2464 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2465 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1807 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_228 != null && this.var_228.running)
         {
            this.var_228.reset();
            return false;
         }
         ...
         if(this.var_1807 > 0 && this.var_1808 >= this.var_1807)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1167;
         if(_loc1_ > this.var_2464)
         {
            ++this.var_1808;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1442 = _loc2_.imageUrl;
         this.var_2466 = _loc2_.clickUrl;
         this.var_1167 = getTimer();
         if(this.var_1442 != "")
         {
            ...
            {
               this.var_228 = new Timer(this.var_2465,1);
               this.var_228.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_228.running)
            {
               this.var_228.reset();
            }
            this.var_228.start();
            _loc4_ = new URLRequest(this.var_1442);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_539,0,0,param1.bitmapData,this.var_2466));
            this.var_1167 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_604));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1441 = _loc2_.imageUrl;
         this.var_1809 = _loc2_.clickUrl;
         if(this.var_1441 != "" && this.var_1809 != "")
         {
            _loc3_ = this.var_1441;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1441);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_581,0,0,_loc4_,_loc2_.assetName,this.var_1809,this.var_1165,this.var_1166));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1165 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1166 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_621.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_621.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_621.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_853,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_842,_loc5_.roomId,0,null,_loc5_.imageUrl,_loc5_.clickUrl,null,null,_loc5_.objectId));
         }
      }
   }
}
