package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class TextCropper implements IDisposable
   {
      ...
      public function crop(param1:ITextWindow) : void
      {
         ...
         {
            _loc3_ = this.var_554.getCharIndexAtPoint(param1.width - this.var_2918,this.var_554.textHeight / 2);
            param1.text = param1.text.slice(0,_loc3_) + this.var_2917;
         }
      }
   }
}
