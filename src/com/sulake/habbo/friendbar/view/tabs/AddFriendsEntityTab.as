package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsEntityTab extends Tab
   {
      ...
      private static const const_1772:String = "title";
      ...
      {
         super();
         _window = var_1300.buildFromXML(var_855.getAssetByName(const_1394).content as XML) as IWindowContainer;
         _window.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMouseClick);
         var _loc1_:IBitmapWrapperWindow = _window.findChildByName(const_1396) as IBitmapWrapperWindow;
         _loc1_.disposesBitmap = false;
         _loc1_.bitmap = var_855.getAssetByName(const_1395).content as BitmapData;
