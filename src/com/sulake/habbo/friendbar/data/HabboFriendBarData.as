package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_636:String = "FriendBar";
      
      private static const const_637:String = "user_interaction";
      
      private static const TRACKING_EVENT_ACTION_VISIT:String = "visit_btn_click";
      
      private static const const_1411:String = "chat_btn_click";
      
      private static const const_1410:String = "find_friends_btn_click";
       
      
      private var var_213:IHabboCommunicationManager;
      
      private var var_1042:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_213)
            {
               this.var_213.release(new IIDHabboCommunicationManager());
               this.var_213 = null;
            }
            if(this.var_1042)
            {
               this.var_1042.release(new IIDHabboMessenger());
               this.var_1042 = null;
            }
            this.var_144 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_213)
         {
            this.var_213.getHabboMainConnection(null).send(new FollowFriendMessageComposer(param1));
            this.var_213.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_636,const_637,TRACKING_EVENT_ACTION_VISIT));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_1042)
         {
            this.var_1042.startConversation(param1);
            if(this.var_213)
            {
               this.var_213.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_636,const_637,const_1411));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_213)
         {
            this.var_213.getHabboMainConnection(null).send(new FindNewFriendsMessageComposer());
            this.var_213.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_636,const_637,const_1410));
         }
      }
      
      private function onCommunicationManagerAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_213 = param2 as IHabboCommunicationManager;
         this.var_213.addHabboConnectionMessageEvent(new MessengerInitEvent(this.onMessengerInitialized));
         this.var_213.addHabboConnectionMessageEvent(new FriendListUpdateEvent(this.onFriendListUpdate));
         this.var_213.addHabboConnectionMessageEvent(new FindFriendsProcessResultEvent(this.onFindFriendProcessResult));
      }
      
      private function onMessengerComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_1042 = param2 as IHabboMessenger;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_144 = !!const_285 ? this.sortByNameAndOnlineStatus(this.var_144) : this.sortByName(this.var_144);
         }
         events.dispatchEvent(new FriendBarUpdateEvent(FriendBarUpdateEvent.const_528));
      }
