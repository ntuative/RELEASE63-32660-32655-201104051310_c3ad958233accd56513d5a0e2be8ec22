package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_59:Quest;
      
      private var _view:IWindow;
      
      private var var_488:int;
      
      private var var_2249:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_59.type)
         {
            ...
            case QuestTypeEnum.WEAR_BADGE:
               ...
               this.var_2249 = this.find("quest.content.itemlist") as IScrollableListWindow;
               if(!this._view)
               {
                  throw new Error("[QuestView] Could not create view for quest type: " + this.var_59.type + " !");
               }
               this._view.addEventListener(WindowEvent.const_38,this.onResized);
               return;
               break;
            default:
               throw new Error("[QuestView] View not defined for quest type: " + this.var_59.type + " !");
         }
      }
      ...
      public function onActivateQuest(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(this.var_59)
         {
            this.var_64.controller.activateQuest(this.var_59);
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc38_:* = null;
         var _loc39_:* = null;
         var _loc1_:String = ["quest",this.var_64.code,this.var_59.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_64.code,"type_" + this.var_59.type.toLowerCase()].join(".");
         ...
         if(this.var_59.type == QuestTypeEnum.FIND_STUFF)
         {
            _loc34_ = this.var_59.roomItemTypeName.split("*");
         ...
         else if(this.var_59.type == QuestTypeEnum.FIND_HIDDEN_STUFF)
         {
            this.var_64.controller.questEngine.setImageFromAsset(_loc15_,"icon_quest_hidden",this.onPreviewImageReady);
         }
         else if(this.var_59.type == QuestTypeEnum.GIVE_BADGE)
         {
            this.var_64.controller.questEngine.setImageFromAsset(_loc15_,this.var_59.questBadgeAchievementTypeId,this.onPreviewImageReady);
         }
         else if(this.var_59.type == QuestTypeEnum.PLACE_ITEM)
         {
            this.var_488 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         else if(this.var_59.type == QuestTypeEnum.PICKUP_ITEM)
         {
            this.var_488 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         else if(this.var_59.type == QuestTypeEnum.ROTATE_ITEM)
         {
            this.var_488 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         else if(this.var_59.type == QuestTypeEnum.MOVE_ITEM)
         {
            this.var_488 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         else if(this.var_59.type == QuestTypeEnum.SWITCH_ITEM_STATE)
         {
            this.var_488 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         else if(this.var_59.type == QuestTypeEnum.STACK_ITEM)
         {
            this.var_488 = -1;
            QuestUtils.setElementImage(this.find("quest.image") as IBitmapWrapperWindow,new BitmapData(1,1,true));
         }
         ...
         switch(this.var_59.status)
         {
            case QuestStatusEnum.const_414:
            ...
            case QuestStatusEnum.const_200:
               ...
               _loc19_ = 4290822336;
               break;
            case QuestStatusEnum.const_698:
               this.setText("quest.status","quest.completed");
               _loc17_.visible = true;
               _loc19_ = 4290822336;
               break;
            case QuestStatusEnum.const_211:
         ...
         this.var_64.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_59.rewardCurrencyAmount.toString());
         this.setText("quest.reward.title",_loc13_);
         this.setText("quest.reward.desc",_loc14_,true,true);
         var _loc20_:int = this.var_59.endDate.date;
         var _loc21_:int = this.var_59.endDate.month + 1;
         var _loc22_:int = this.var_59.endDate.fullYear;
         var _loc23_:int = this.var_59.endDate.minutes;
         var _loc24_:int = this.var_59.endDate.hours;
         ...
         var _loc32_:String = "icon_" + this.var_64.code + "_reward_" + this.var_59.rewardCurrencyAmount;
         ...
         if(_loc33_)
         {
            this.var_585 = new Timer(20,1);
            this.var_585.addEventListener(TimerEvent.TIMER,this.onShowReward);
            this.var_585.start();
      ...
      private function setText(param1:String, param2:String, param3:Boolean = true, param4:Boolean = false) : void
      {
         ...
         if(_loc5_)
         {
            ...
            if(param4 && _loc5_ is IHTMLTextWindow)
            {
               ...
               (_loc5_ as IHTMLTextWindow).linkTarget = LinkTarget.const_882;
            }
         }
      }
