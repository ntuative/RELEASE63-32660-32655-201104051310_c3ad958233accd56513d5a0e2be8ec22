package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1799:IAlertDialog;
      ...
      public function IncomingMessages(param1:HabboQuestEngine)
      {
         super();
         this.var_56 = param1;
         this._communication = this.var_56.communication;
      ...
      private function onQuestList(param1:IMessageEvent) : void
      {
         ...
         this.var_56.controller.openCampaign(_loc2_.campaignCode,_loc2_.activityPointType,_loc2_.quests,_loc2_.isPushMessage);
      }
      ...
      private function onQuestAccepted(param1:IMessageEvent) : void
      {
         ...
         this.var_56.controller.questAccepted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onQuestCompleted(param1:IMessageEvent) : void
      {
         ...
         this.var_56.controller.questCompleted(_loc2_.campaignCode,_loc2_.questData);
      }
      ...
      private function onAvailableQuestCampaigns(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:String = this.var_56.configuration.getKey("questing.excludedCampaignCode","");
         if(this.var_56.defaultCampaignCode == _loc4_)
         {
            this.var_56.defaultCampaignCode = "";
         }
         ...
         else
         {
            ...
            this.var_56.controller.openCampaigns(_loc3_);
         }
      }
      ...
      private function onExpiredQuestCampaigns(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_56.controller.openCampaigns(_loc2_.campaignCodes,true);
         }
      }
      
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(this.var_56.toolbar != null && this.var_56.configuration != null)
         {
            this.var_56.defaultCampaignCode = this.getCampaignCode();
            this._communication.getHabboMainConnection(null).send(new GetAvailableQuestCampaignsMessageComposer());
         }
         this.var_56.inRoom = true;
      }
      
      private function getCampaignCode() : String
      {
         var _loc1_:String = this.var_56.configuration.getKey("questing.defaultCampaign","");
         var _loc2_:String = this.var_56.configuration.getKey("questing.defaultCampaign.override","");
         var _loc3_:String = this.var_56.configuration.getKey("questing.excludedCampaignCode","");
      ...
      private function setQuestingEnabled(param1:Boolean) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_56.toolbar != null)
         {
            if(param1)
            {
               _loc2_ = this.var_56.defaultCampaignCode;
               _loc3_ = _loc2_.length > 0 && _loc2_ == this.var_56.configuration.getKey("questing.defaultCampaign.override","");
               _loc4_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_95,HabboToolbarIconEnum.QUESTS);
               _loc4_.iconState = "0";
               this.var_56.toolbar.events.dispatchEvent(_loc4_);
               if(this.var_56.habboHelp && _loc3_)
               {
                  ...
                  this.var_56.habboHelp.setWelcomeNotifications(_loc5_);
               }
               this._communication.getHabboMainConnection(null).send(new GetExpiredQuestCampaignsMessageComposer());
            }
            else
            {
               this.var_56.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
      ...
      {
         this.var_56.controller.close();
         this.var_56.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_134,HabboToolbarIconEnum.QUESTS));
         this.var_56.inRoom = false;
         this.var_56.controller.closeReminderOnExitRoom();
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_56.controller.updatePurse();
      }
