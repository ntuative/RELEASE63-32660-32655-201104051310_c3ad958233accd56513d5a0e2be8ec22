package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1758:String = "noconvinfo";
      
      private static const const_1759:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1482:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1482 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this._friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_60,HabboToolbarIconEnum.FRIENDLIST,this.var_16));
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1041 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_267 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1482.prepare(this.var_1041);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1046,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1076,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_705,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_653,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_705,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_653,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1481 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1481.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1877 == -1 ? 0 : int(this.var_16.height - this.var_1877);
         var _loc4_:int = this.var_1875 == -1 ? 0 : int(this.var_16.width - this.var_1875);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_267.y = Util.getLowestPoint(this.var_16.content);
         this.var_267.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1072,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_705,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1046,false);
         ...
         this.var_1877 = this.var_16.height;
         this.var_1875 = this.var_16.width;
