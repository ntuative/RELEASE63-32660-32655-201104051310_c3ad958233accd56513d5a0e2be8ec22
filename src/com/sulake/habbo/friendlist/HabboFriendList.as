package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2617:FriendListLookAndFeel;
      
      private var var_444:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1911:OpenedToWebPopup;
      ...
      private var var_1912:AvatarSearchResults;
      ...
      {
         this.var_2617 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_101 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1912 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_143)
         {
            this.var_143.release(new IIDHabboMessenger());
            this.var_143 = null;
         }
         if(this.var_184)
         {
         ...
         if(this.var_1066)
         {
            this.var_1066.release(new IIDAvatarRenderManager());
            this.var_1066 = null;
         }
         ...
         if(this.var_810)
         {
            this.var_810.release(new IIDSessionDataManager());
            this.var_810 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1911 = new OpenedToWebPopup(this);
         }
         this.var_1911.show(x,y);
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_95,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_377.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_169.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_334,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1066.createAvatarImage(param1,AvatarScaleType.const_90,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_143 = param2 as IHabboMessenger;
      ...
      {
         this.var_169 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_1115,this.getText("friendlist.friends")));
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_391,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_101.addFriend(new Friend(_loc4_));
         }
         this.var_444 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_647)
         {
         ...
         this.var_169.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_101.findCategory(FriendCategory.const_391);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_444.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_408));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_444.findTab(FriendListTab.const_99).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_444.findTab(FriendListTab.const_99);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1912.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_444.findTab(FriendListTab.const_99);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_810 || !this.var_377)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_810.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this.var_377.vipLimit;
         }
         else if(this.var_810.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_45))
         {
