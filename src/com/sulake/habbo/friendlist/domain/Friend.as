package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1859:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1003 = param1.gender;
         this.var_798 = param1.online;
         this.var_1731 = param1.followingAllowed && param1.online;
         this.var_657 = param1.figure;
         this.var_1685 = param1.motto;
         this.var_1686 = param1.lastAccess;
         this.var_1564 = param1.categoryId;
