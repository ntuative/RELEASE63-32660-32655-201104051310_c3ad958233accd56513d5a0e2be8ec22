package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         if(this.var_979 >= this.getPageCount())
         {
            this.var_979 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_234.length / const_415);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_979 * const_415;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_979 + 1) * const_415,this.var_234.length);
      }
