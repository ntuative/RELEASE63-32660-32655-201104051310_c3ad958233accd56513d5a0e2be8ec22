package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1775:String = "no_reqs_info";
      ...
      private var var_2025:IContainerButtonWindow;
      
      private var var_2024:IContainerButtonWindow;
      ...
      {
         this.var_2025 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2024 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2024.procedure = this.onDismissAllButtonClick;
         this.var_2025.procedure = this.method_10;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_168)
         {
         ...
         else if(param1.state == FriendRequest.const_389)
         {
         ...
         else if(param1.state == FriendRequest.const_1192)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_389;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_294,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_389 && _loc4_.state != FriendRequest.const_388)
            {
               _loc4_.state = FriendRequest.const_388;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_294,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function method_10(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_389 && _loc4_.state != FriendRequest.const_388)
            {
               ...
               _loc4_.state = FriendRequest.const_389;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2025,_loc1_);
         this.setEnabled(this.var_2024,_loc1_);
      }
