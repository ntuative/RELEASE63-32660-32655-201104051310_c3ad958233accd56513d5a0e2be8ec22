package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_960:uint = 11;
      ...
      private var var_205:IHabboFriendList;
      
      private var var_1168:IHabboWindowManager;
      ...
      private var var_259:PerformanceTracker = null;
      
      private var var_431:FramerateTracker = null;
      
      private var var_260:LatencyTracker = null;
      
      private var var_624:LagWarningLogger = null;
      
      private var var_623:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_259 = new PerformanceTracker();
         this.var_431 = new FramerateTracker();
         this.var_260 = new LatencyTracker();
         this.var_624 = new LagWarningLogger();
         this.var_623 = new ToolbarClickTracker(this);
         this.var_1443 = new Array(const_960);
         var _loc4_:int = 0;
         while(_loc4_ < const_960)
         {
            this.var_1443[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1515,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1535,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1695,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_894,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1169,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1168)
            {
               this.var_1168.release(new IIDHabboWindowManager());
               this.var_1168 = null;
            }
            if(this.var_322)
            {
            ...
            if(this.var_205)
            {
               if(!this.var_205.disposed)
               {
                  Component(this.var_205).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_205).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_205).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_205).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_205).events.removeEventListener(HabboFriendListTrackingEvent.const_408,this.onFriendlistTrackingEvent);
               }
               this.var_205.release(new IIDHabboFriendList());
               this.var_205 = null;
            }
            if(this.var_131)
            {
            ...
            if(this.var_169)
            {
               if(!this.var_169.disposed)
               {
                  this.var_169.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
               }
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_312,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_335,this.onRoomAction);
               }
            ...
            {
               this.var_313.stop();
               this.var_313.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_313 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_184)
         {
            if(this.var_260 != null)
            {
               this.var_260.configuration = this.var_184;
            }
            if(this.var_259 != null)
            {
            ...
            this.trackLoginStep(HabboLoginTrackingStep.const_1457);
            if(this.var_184)
            {
               if(this.var_624 != null)
               {
                  this.var_624.configure(this.var_184);
               }
               if(this.var_431 != null)
               {
               ...
               {
                  this.var_623.configure(this.var_184);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_682,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_930,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_71,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_514,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_624 != null)
            {
               this.var_624.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_930)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1647);
         }
         else if(param1.type == HabboHotelViewEvent.const_514)
         {
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1630);
               break;
            case HabboCommunicationEvent.const_682:
               this.trackLoginStep(HabboLoginTrackingStep.const_1666,String(this._communication.port));
               break;
      ...
      {
         this.var_1168 = IHabboWindowManager(param2);
         if(this.var_1168)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_184)
            {
               if(this.var_184.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1443)
                  {
                  ...
                  if(this.var_259 != null)
                  {
                     _loc4_["null"] = this.var_259.flashVersion;
                     _loc4_["null"] = this.var_259.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1224);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1224,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_205 = param2 as IHabboFriendList;
         Component(this.var_205).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_205).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_205).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_205).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_205).events.addEventListener(HabboFriendListTrackingEvent.const_408,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_408:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2469)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1555);
            this.var_2469 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1169,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_894,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_312,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_335,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_322 = param2 as IAdManager;
         this.var_322.events.addEventListener(AdEvent.const_581,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_169 = param2 as IHabboToolbar;
         this.var_169.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_312)
         {
            if(this.var_1812 < 1)
            {
               if(!this.var_313)
               {
                  this.var_313 = new Timer(60000,1);
                  this.var_313.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_313.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_335)
         {
            if(this.var_313)
            {
               this.var_313.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_623)
         {
            this.var_623.track(param1.iconName);
         }
      }
      ...
      {
         this.var_624.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_512 > -1 && _loc2_ < this.var_512)
         {
            ++this.var_1811;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1811);
         }
         if(this.var_512 > -1 && _loc2_ - this.var_512 > 15000)
         {
            ++this.var_1810;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1810);
         }
         this.var_512 = _loc2_;
         if(this.var_259 != null)
         {
            this.var_259.update(param1,this.var_512);
         }
         if(this.var_260 != null)
         {
            this.var_260.update(param1,this.var_512);
         }
         if(this.var_431 != null)
         {
            this.var_431.trackUpdate(param1,this,this.var_512);
         }
         if(this.var_624 != null)
         {
            this.var_624.update(this.var_512);
         }
      }
   }
}
