package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_513:IKeyExchange;
      
      private var var_953:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2489:PseudoRandom;
      ...
      private var var_230:HabboHotelView;
      
      private var var_1450:String = "";
      
      private const const_1741:String = "fuselogin";
      ...
      {
         if(param1 && !this.var_627)
         {
            this.var_627 = param1;
            this.var_57.initConnection(HabboConnectionType.const_267);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_91,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_57 && this.var_161 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_230 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_161.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_161.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_230.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_161.getKey("use.sso.ticket") == "1";
         this.var_627 = this.var_161.getKey("sso.ticket",null);
         this.var_1820 = this.var_161.getKey("flash.client.url","");
         this.var_2488 = this.var_161.getKey("external.variables.txt","");
         if(this.var_230 == null)
         {
            this.var_230 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_57.mode = HabboConnectionType.const_92;
            if(this.var_627)
            {
               this.var_57.initConnection(HabboConnectionType.const_267);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_467,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_57.mode = HabboConnectionType.const_1073;
            }
         }
         this.var_57.initConnection(HabboConnectionType.const_267);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_682);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2489 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_57.mode)
         {
            case HabboConnectionType.const_92:
               _loc6_ = "";
               ...
               this.var_230.loadBannerImage(_loc7_ + "?token=" + this.var_1450,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1073:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1537:
               this.var_953 = this.generateRandomHexString(30);
               this.var_513 = new DiffieHellman(new BigInteger(this.var_161.getKey("connection.development.prime"),16),new BigInteger(this.var_161.getKey("connection.development.generator"),16));
               this.var_513.init(this.var_953);
               _loc8_ = this.var_513.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_513.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_513.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2489);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1820,this.var_2488));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1741,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_627 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_627);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2487)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1450);
         ...
         this.var_513 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_513.init(_loc14_);
            _loc15_ = this.var_513.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_953 = _loc14_;
            }
