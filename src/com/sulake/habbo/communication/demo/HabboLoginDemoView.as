package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_467:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_160.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_129,HabboWindowStyle.const_44,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1741,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1741,"/");
         ...
         {
            dispatchEvent(new Event(const_467));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_135.removeEventListener(SSOTicket.const_372,this.onParsedTicketSuccess);
            this.var_135.removeEventListener(SSOTicket.const_338,this.onParsedTicketFailure);
            this.var_135 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_135 = new SSOTicket(this.var_160.assets,_loc3_,_loc2_,param1);
         this.var_135.addEventListener(SSOTicket.const_372,this.onParsedTicketSuccess);
         this.var_135.addEventListener(SSOTicket.const_338,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_135.ticket);
         Logger.log("Has Facebook: " + this.var_135.isFacebookUser);
         if(this.var_135.isFacebookUser)
         {
            this.var_160.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_160.flashClientUrl = this.var_135.flashClientUrl;
         this.var_160.ssoTicket = this.var_135.ticket;
         this.var_135.removeEventListener(SSOTicket.const_372,this.onParsedTicketSuccess);
         this.var_135.removeEventListener(SSOTicket.const_338,this.onParsedTicketFailure);
         this.var_135 = null;
         dispatchEvent(new Event(const_467));
