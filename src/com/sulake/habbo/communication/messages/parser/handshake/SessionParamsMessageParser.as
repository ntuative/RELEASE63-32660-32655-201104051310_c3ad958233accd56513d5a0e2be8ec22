package com.sulake.habbo.communication.messages.parser.handshake
{
   ...
   public class SessionParamsMessageParser implements IMessageParser
   {
      ...
      protected var var_2089:Boolean;
      
      protected var var_2085:Boolean;
      
      protected var var_2381:String;
      
      protected var var_2088:Boolean;
      
      protected var var_2086:Boolean;
      
      protected var var_2087:Boolean;
      
      protected var _confPartnerIntegration:Boolean;
      
      protected var var_2860:Boolean;
      
      protected var var_2859:String;
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            switch(_loc4_)
            {
               case 0:
                  ...
                  this.var_2089 = _loc5_ > 0;
                  break;
               case 1:
                  _loc5_ = param1.readInteger();
                  this.var_2085 = _loc5_ > 0;
                  break;
               case 2:
                  _loc5_ = param1.readInteger();
                  this.var_2088 = _loc5_ > 0;
                  break;
               case 3:
                  _loc5_ = param1.readInteger();
                  this.var_2086 = _loc5_ > 0;
                  break;
               case 4:
                  _loc5_ = param1.readInteger();
