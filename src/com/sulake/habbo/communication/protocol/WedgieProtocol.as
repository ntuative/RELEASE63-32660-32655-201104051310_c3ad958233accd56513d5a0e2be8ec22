package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1572:uint = 1;
      
      public static const const_1494:uint = 2;
       
      
      private var var_1517:IProtocolEncoder;
      
      private var var_1103:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1517 = new WedgieEncoder();
         this.var_1103 = new WedgieDecoder();
      }
      
      public function dispose() : void
      {
         this.var_1517.dispose();
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1572)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1103.getID(_loc4_);
