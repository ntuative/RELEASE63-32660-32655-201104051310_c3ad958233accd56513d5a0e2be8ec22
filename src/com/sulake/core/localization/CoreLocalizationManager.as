package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         var _loc4_:LocalizationDefinition = this.var_1049[param1];
         if(_loc4_ == null)
         {
            _loc4_ = new LocalizationDefinition(param1,param2,param3);
            this.var_1049[param1] = _loc4_;
         }
      }
      
      public function activateLocalization(param1:String) : Boolean
      {
         var _loc2_:LocalizationDefinition = this.var_1049[param1];
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_1049[param1] as ILocalizationDefinition;
      }
      
      public function getActiveLocalizationDefinition() : ILocalizationDefinition
      {
         return this.getLocalizationDefinition(this.var_2849);
      }
      ...
      private function onLocalizationReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.events.dispatchEvent(new Event(LocalizationEvent.const_161));
         }
      }
      ...
      {
         var _loc3_:Localization = this.var_66[param1] as Localization;
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:Localization = this.var_66[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Localization(param1,param2);
            this.var_66[param1] = _loc3_;
         }
         else
         {
         ...
         {
            _loc3_.registerParameter("predefined",this.var_2037);
         }
      }
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_66)
         {
      ...
      {
         var _loc5_:Localization = this.var_66[param1];
         if(_loc5_ == null)
         {
            _loc5_ = new Localization(param1);
            this.var_66[param1] = _loc5_;
         }
      ...
      {
         return this.var_66[param1] as ILocalization;
      }
      ...
      protected function setPredefinedUrl(param1:String) : void
      {
         ...
         for each(_loc2_ in this.var_66)
         {
            if(_loc2_.raw.indexOf("%predefined%") >= 0)
            {
               _loc2_.registerParameter("predefined",this.var_2037);
            }
         }
      }
   }
