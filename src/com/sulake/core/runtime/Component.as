package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_430:String = "_INTERNAL_EVENT_UNLOCKED";
      ...
      public static const const_1120:uint = 4;
       
      
      protected var var_814:uint = 0;
      ...
      private var var_1468:uint;
      
      private var var_497:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_497 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_497.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_497.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1304 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1304);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1468 & const_1120)
         {
            if(_loc3_ == 0)
            {
               if(this.var_497.getTotalReferenceCount() == 0)
               {
                  this._context.method_6(this);
                  this.dispose();
               }
            }
         }
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_916 = false;
            this._events.dispatchEvent(new LockEvent(const_430,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_814 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_497.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_497.getStructByIndex(_loc8_);
