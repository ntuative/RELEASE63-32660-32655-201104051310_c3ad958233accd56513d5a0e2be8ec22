package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1720:uint = 1;
      
      protected static const const_1719:uint = 2;
      
      protected static const const_1722:uint = 4;
      
      protected static const const_1721:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1493:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1109:Boolean = false;
      
      public static const const_1538:int = 2;
      
      private static var var_930:Array = new Array();
      
      private static var var_758:Array = new Array();
      ...
      protected var var_469:uint = 0;
      
      protected var _name:String;
      
      protected var var_1058:Boolean = false;
      
      protected var _debug:Boolean = false;
      
      protected var var_1057:Boolean = false;
      
      protected var var_2870:String = "";
      
      protected var var_2868:String = "";
      
      protected var var_2097:int;
      
      protected var var_1305:int;
      
      protected var var_1306:int;
      
      protected var var_2948:uint = 0;
      
      protected var var_2869:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_42.load(param1.var_240,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1109)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_758[_loc2_] as LibraryLoader;
            ...
            while(var_758.length < const_1538 && false)
            {
               _loc1_ = var_930.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_758.push(_loc1_);
                  _loc1_.var_42.load(_loc1_.var_240,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_1058 ? uint(this.var_1305 - this.var_2097) : uint(getTimer() - this.var_2097);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,this.var_400,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
            try
            {
               this.var_42.close();
            }
      ...
      {
         if(this.var_1057 && !_disposed)
         {
            this.var_1057 = false;
            if(!this.var_1058 && this.var_240)
            {
               this.var_1305 = -1;
               this.var_2097 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1058 && !_disposed && this.var_1306 > 0)
         {
            try
            {
               this.var_42.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_240,const_1493 - this.var_1306);
            if(this.var_2869)
            {
            ...
            --this.var_1306;
            this.var_469 = 0;
            this.var_42.load(this.var_240,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               this.debug("Load event STATUS " + this.var_400 + " for file \"" + this.url + "\"");
               break;
            case Event.UNLOAD:
               this.debug("Load event UNLOAD for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,this.var_400,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case ProgressEvent.PROGRESS:
               this.debug("Load event PROGRESS for file \"" + this.url + "\"  bytes: " + this.bytesLoaded + "/" + this.bytesTotal);
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,this.var_400,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case IOErrorEvent.IO_ERROR:
               this.debug("Load event IO ERROR for file \"" + this.url + "\"");
               if(!this.handleHttpStatus(this.var_400))
               {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_469 = LibraryLoader.name_4;
         ...
         if(this.var_469 == LibraryLoader.const_1721)
         {
         ...
         if(this.var_469 == LibraryLoader.name_4)
         {
            if(this.prepareLibrary())
            {
               ...
               this.removeEventListeners();
               throttle();
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.var_400,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(this._debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,this.var_400,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         }
      }
      ...
      protected function failure(param1:String) : void
      {
         ...
         throttle();
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.var_400,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         dispatchEvent(new Event(LIBRARY_LOADER_FINALIZE));
      }
