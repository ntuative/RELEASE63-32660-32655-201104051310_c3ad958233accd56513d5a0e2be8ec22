package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_262:String = "Number";
      
      public static const const_1439:String = "float";
      
      public static const const_40:String = "Boolean";
      
      public static const const_1450:String = "bool";
      
      public static const const_55:String = "String";
      
      public static const const_265:String = "Point";
      
      public static const const_281:String = "Rectangle";
      
      public static const const_157:String = "Array";
      
      public static const const_226:String = "Map";
      
      private static const const_610:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_609:String = "value";
      
      private static const const_625:String = "true";
      
      private static const const_1736:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_610));
         }
         else
         {
            _loc4_ = param1.child(const_610)[0];
         }
         ...
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_609));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_609)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_226 || _loc5_ == const_157)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1439:
               return Number(param1);
            case const_40:
               return param1 == const_625 || int(param1) > 0;
            case const_1450:
               return param1 == const_625 || int(param1) > 0;
            case const_139:
               return uint(param1);
