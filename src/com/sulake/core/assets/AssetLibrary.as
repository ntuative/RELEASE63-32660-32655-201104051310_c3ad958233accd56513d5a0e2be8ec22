package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1024:String = "AssetLibraryReady";
      
      public static const const_775:String = "AssetLibraryLoaded";
      
      public static const const_1551:String = "AssetLibraryUnloaded";
      
      public static const const_1617:String = "AssetLibraryLoadError";
      
      private static const const_442:String = "name";
      
      private static const const_1005:String = "asset";
      
      private static const const_1007:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1006:String = "library";
      
      private static var var_324:Dictionary;
      
      private static var var_1985:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_544:uint = 0;
      
      private static var var_1008:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_1007 = new Dictionary(false);
         this.var_167 = new Dictionary(false);
         var_1008.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         var _loc5_:XMLList = param2.child(const_1006);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1005);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_442);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1007);
                  if(_loc11_.length())
                  {
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1008.splice(var_1008.indexOf(this),1);
            --var_544;
            this.var_543 = null;
            this.var_1007 = null;
            this.var_167 = null;
      ...
      {
         if(this.var_661 == param1.url && this.var_1009)
         {
            if(!this.var_1010 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_662);
            }
            this.var_1010 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1024));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_167)
         {
            delete this.var_167[_loc1_];
         }
         for(_loc1_ in this.var_1007)
         {
            delete this.var_1007[_loc1_];
         }
         if(this.var_42 != null)
         {
            this.var_42.dispose();
         ...
         this.var_1009 = false;
         this.var_661 = null;
         dispatchEvent(new Event(AssetLibrary.const_1551));
      }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         if(param3 == null)
         {
            _loc5_ = this.method_9(param2.url);
            if(_loc5_ == null)
            {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1053,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1163,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1050,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_167[struct.assetName] == null)
                  {
                     ++this.var_452;
                     this.var_451.push(struct.assetName);
                  }
                  this.var_167[struct.assetName] = asset;
               }
               else
               {
      ...
      {
         var _loc2_:IAsset = this.var_167[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function getAssetByContent(param1:Object) : IAsset
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for(_loc2_ in this.var_167)
         {
            _loc3_ = this.var_167[_loc2_];
      ...
      {
         return this.var_167[param1] != null || (this.var_662 != null ? this.var_662[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_167[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            ...
            this.var_167[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_1985.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_324.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_324[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_324[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_324)
            {
               _loc3_ = AssetTypeDeclaration(var_324[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_324)
            {
               _loc4_ = AssetTypeDeclaration(var_324[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_1009 = true;
         dispatchEvent(new Event(AssetLibrary.const_775));
         dispatchEvent(new Event(AssetLibrary.const_1024));
         if(this.var_1010)
         {
      ...
      private function method_9(param1:String) : AssetTypeDeclaration
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc4_:* = null;
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1006);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1005);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_442).toString() == param1)
               {
                  ...
                  _loc6_ = _loc3_.child(const_1007);
                  if(_loc6_.length())
                  {
