   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_520 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_104 is BitmapDataAsset)
         {
            ...
            this.var_1389 = BitmapDataAsset(this.var_104).var_1389;
            this.var_1390 = BitmapDataAsset(this.var_104).var_1390;
            if(this._bitmap != null)
            {
               this.var_104 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               ...
               case "flipH":
                  ...
                  break;
               case "flipV":
                  this.var_1390 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
