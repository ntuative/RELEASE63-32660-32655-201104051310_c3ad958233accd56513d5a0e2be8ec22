package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1055 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_42 = new Loader();
         this.var_1063 = new LoaderContext();
         this.var_1063.checkPolicyFile = true;
         ...
         {
            this.var_42.load(param2,this.var_1063);
         }
      }
      ...
      {
         this.var_1055 = param1.url;
         var_331 = 0;
         this.var_42.load(param1,this.var_1063);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_331 < var_2874)
            {
               ...
               this.var_42.load(new URLRequest(this.var_1055 + (this.var_1055.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_331),this.var_1063);
               return true;
            }
         }
         return false;
