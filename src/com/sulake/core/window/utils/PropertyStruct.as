package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2916 = param3 == const_226 || param3 == const_157 || param3 == const_265 || param3 == const_281;
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            ...
            case const_281:
               ...
               break;
            case const_139:
               _loc1_ = "<var key=\"" + this.var_684 + "\" value=\"" + "0x" + uint(this.var_195).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_684 + "\" value=\"" + this.var_195 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
