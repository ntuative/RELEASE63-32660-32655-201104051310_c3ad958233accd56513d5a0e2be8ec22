package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_628:String = "}";
      
      private static const const_1383:String = "/*";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_88[const_195],var_88[ITALIC],var_88[BOLD]];
            var_88.reset();
            var_88[const_195] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_628);
         if(countSubStrings(param1,const_629) != countSubStrings(param1,const_628))
         {
            throw new Error("Mismatching amount of \"" + const_629 + "\" versus \"" + const_628 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1383) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1384) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_629)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
