package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1897:String = "_INCLUDE";
      
      public static const const_1866:String = "_TEMP";
      
      private static const const_1368:String = "layout";
      
      private static const const_982:String = "window";
      
      private static const const_983:String = "variables";
      
      private static const const_981:String = "filters";
      
      private static const const_442:String = "name";
      
      private static const const_1379:String = "style";
      
      private static const const_626:String = "params";
      
      private static const const_1375:String = "tags";
      ...
      private static const const_1372:String = "visible";
      
      private static const const_1377:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1205:String = "blend";
      
      private static const const_1376:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1370:String = "treshold";
      
      private static const const_1367:String = "children";
      
      private static const const_1373:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1374:String = "height_min";
      
      private static const const_1378:String = "height_max";
      
      private static const const_625:String = "true";
      
      private static const const_175:String = "0";
      
      private static const const_1371:String = "$";
      
      private static const const_1263:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1369:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1366:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1309:Dictionary;
      
      protected var var_1308:Dictionary;
      
      protected var var_1062:Dictionary;
      
      protected var var_1580:Dictionary;
      
      protected var var_2102:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1309,this.var_1308);
         this.var_1062 = new Dictionary();
         this.var_1580 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1062,this.var_1580);
         this.var_2102 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1366,const_50);
         return param1.replace(const_1369,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1309)
            {
               delete this.var_1309[_loc1_];
            }
            for(_loc1_ in this.var_1308)
            {
               delete this.var_1308[_loc1_];
            }
            for(_loc1_ in this.var_1062)
            {
               delete this.var_1062[_loc1_];
            }
            for(_loc1_ in this.var_1580)
            {
               delete this.var_1580[_loc1_];
            }
            this.var_2102.dispose();
            this.var_2102 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1368)
         {
            _loc8_ = param1.child(const_983);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_981).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1309[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_442,variables,"")));
         style = uint(this.parseAttribute(xml,const_1379,variables,style));
         params = uint(this.parseAttribute(xml,const_626,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1375,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_175));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_175));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_175));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_175));
         visible = this.parseAttribute(xml,const_1372,variables,visible.toString()) == const_625;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_626).length() > 0)
         {
            list = xml.child(const_626).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_442,variables,"") as String;
               if(this.var_1062[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_442)) + "\"!");
               }
               params |= this.var_1062[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1377,variables,caption)));
         if(tag != const_50)
         {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_983)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1373,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1374,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1378,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_625;
         blend = Number(this.parseAttribute(xml,const_1205,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1376,variables,window.clipping.toString()) == const_625;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1370,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_981).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1308[param1.type];
