package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1243:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_862:Number;
      
      protected var var_564:Number;
      
      protected var var_563:Boolean;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_440,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_440 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_440,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_878 ? true : null;
         }
      ...
      {
         this.var_862 = param1;
         this._field.scrollH = this.var_862 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_862 * this.maxScrollH,this.var_564 * this.maxScrollV,width,height);
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         if(!this.var_563)
         {
            if(param2.type == WindowEvent.const_38)
            {
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         if(!_loc7_ && !param1)
         {
            _loc8_ = WindowEvent.allocate(WindowEvent.const_38,this,null);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1129) ? new PropertyStruct(PropertyDefaults.const_747,this._field.antiAliasType,PropertyStruct.const_55,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1043) : PropertyDefaults.const_1441);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1085 ? new PropertyStruct(PropertyDefaults.const_923,this._autoSize,PropertyStruct.const_55,true,PropertyDefaults.const_1208) : PropertyDefaults.const_1513);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_272,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1234 ? new PropertyStruct(PropertyDefaults.const_1041,this._field.gridFitType,PropertyStruct.const_55,true,PropertyDefaults.const_1209) : PropertyDefaults.const_1686);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_715) ? new PropertyStruct(PropertyDefaults.const_375,this._field.textColor,PropertyStruct.const_139,true) : PropertyDefaults.const_1136);
         _loc1_.push(this.var_440 != TextStyleManager.const_195 ? new PropertyStruct(PropertyDefaults.const_425,this.var_440,PropertyStruct.const_55,true,PropertyDefaults.const_857) : PropertyDefaults.const_1142);
         _loc1_.push(this.var_39.left != PropertyDefaults.const_920 ? new PropertyStruct(PropertyDefaults.const_249,this.var_39.left,PropertyStruct.const_42,true) : PropertyDefaults.const_577);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_645 ? new PropertyStruct(PropertyDefaults.const_247,this.var_39.top,PropertyStruct.const_42,true) : PropertyDefaults.const_498);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_823 ? new PropertyStruct(PropertyDefaults.const_224,this.var_39.right,PropertyStruct.const_42,true) : PropertyDefaults.const_462);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_890 ? new PropertyStruct(PropertyDefaults.const_275,this.var_39.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_470);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1185 ? new PropertyStruct(PropertyDefaults.const_680,this._field.mouseWheelEnabled,PropertyStruct.const_40,true) : PropertyDefaults.const_1573);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_262,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_262,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_262,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
