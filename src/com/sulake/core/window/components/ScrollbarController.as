package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1360:String = "increment";
      
      private static const const_1359:String = "decrement";
      
      private static const const_977:String = "slider_track";
      
      private static const const_624:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_693:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_176 = false;
         this.var_20 = param12;
         this._horizontal = param2 == WindowType.const_484;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_20.removeEventListener(WindowEvent.const_38,this.onScrollableResized);
            this.var_20.removeEventListener(WindowEvent.const_500,this.onScrollableScrolled);
         }
         this.var_20 = param1;
         if(this.var_20 != null && !this.var_20.disposed)
         {
            this.var_20.addEventListener(WindowEvent.const_38,this.onScrollableResized);
            this.var_20.addEventListener(WindowEvent.const_500,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_977 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_977) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_624) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_624:
         ...
         if(param2.type == WindowEvent.const_676)
         {
            if(this.var_20 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_291)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_693;
                  }
                  else
                  {
                     this.scrollV -= this.var_693;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_644)
         {
            if(param2.name == const_1360)
            {
               if(this.var_20)
               {
                  this.var_1198 = true;
            ...
            else if(param2.name == const_1359)
            {
               if(this.var_20)
               {
                  this.var_1198 = true;
            ...
            else if(param2.name == const_977)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_624).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_291)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = method_4(this.var_977) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_977) as IScrollableWindow;
               if(_loc1_)
               {
