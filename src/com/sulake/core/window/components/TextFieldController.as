package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1581:uint = 500;
      ...
      {
         this.var_1310 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1123,var_11);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_743 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_203,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_420,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_406,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_746,false,PropertyStruct.const_40,true) : PropertyDefaults.const_1462);
         _loc1_.push(this.var_1318 != PropertyDefaults.const_1023 ? new PropertyStruct(PropertyDefaults.const_821,this.var_1318,PropertyStruct.const_40,true) : PropertyDefaults.const_1618);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1191 ? new PropertyStruct(PropertyDefaults.const_672,_field.selectable,PropertyStruct.const_40,true) : PropertyDefaults.const_1655);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1060 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_40,true) : PropertyDefaults.const_1520);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_821:
                  this.var_1318 = _loc2_.value as Boolean;
                  if(this.var_1318)
                  {
               ...
               case PropertyDefaults.const_746:
                  ...
                  break;
               case PropertyDefaults.const_1097:
