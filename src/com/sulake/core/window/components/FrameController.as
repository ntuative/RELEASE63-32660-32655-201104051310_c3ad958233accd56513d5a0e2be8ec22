package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1314:String = "_HEADER";
      
      private static const const_1312:String = "_CONTENT";
      
      private static const const_1313:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1434:IHeaderWindow;
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1434 = findChildByTag(const_1314) as IHeaderWindow;
            if(!this.var_1434)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_180 = findChildByTag(const_1312) as IWindowContainer;
            if(!this.var_180)
            {
      ...
      {
         return findChildByTag(const_1313) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1240,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1058 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc4_:Boolean = testParamFlag(WindowParam.const_228);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_249,_loc3_.left,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_247,_loc3_.top,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_224,0 - _loc3_.right,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_275,0 - _loc3_.bottom,PropertyStruct.const_42,_loc2_));
         }
         else
         {
