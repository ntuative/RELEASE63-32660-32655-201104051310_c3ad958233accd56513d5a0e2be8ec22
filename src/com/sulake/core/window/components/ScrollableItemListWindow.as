package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1164:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_430)
         {
            this.var_430.removeEventListener(WindowEvent.const_223,this.scrollBarEventProc);
            this.var_430.removeEventListener(WindowEvent.const_182,this.scrollBarEventProc);
            this.var_430 = null;
         }
         if(this.var_1164)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1164)
         {
            this.var_1164 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_430)
         {
            ...
            if(this.var_430)
            {
               this.var_430.addEventListener(WindowEvent.const_223,this.scrollBarEventProc);
               this.var_430.addEventListener(WindowEvent.const_182,this.scrollBarEventProc);
            }
         }
         return this.var_430;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_182)
         {
            this.hideScrollBar();
         }
      }
