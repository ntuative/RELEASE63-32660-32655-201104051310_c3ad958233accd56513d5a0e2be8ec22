package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         else if(param2.type == WindowEvent.const_1195)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_860;
         if(this.var_860 != param1)
         {
            if(this.var_860 != null)
            {
               if(!this.var_860.disposed)
               {
                  this.var_860.deactivate();
               }
            }
            this.var_860 = param1;
