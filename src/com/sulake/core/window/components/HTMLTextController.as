package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_882:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_881:String = "default";
      
      private var var_1074:String = null;
      
      private var var_1625:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1074 == param2)
         {
            return;
         }
         param1.var_1074 = param2;
         param1.var_1625 = null;
         if(param1.var_1074 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1074);
            param1.var_1625 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_800.indexOf(param1) > -1)
         {
            this.var_881 = param1;
         }
      }
      ...
      {
         return this.var_881 == LinkTarget.const_29 ? defaultLinkTarget : this.var_881;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1625;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_882)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_881 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_745,this.var_881,PropertyStruct.const_55,true,PropertyDefaults.const_800));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1467);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_881 = _loc2_.value as String;
               break;
            }
