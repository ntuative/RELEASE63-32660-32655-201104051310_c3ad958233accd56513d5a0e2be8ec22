package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_1060:ITabSelectorWindow;
      
      protected var var_2099:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1060 = findChildByTag(const_1350) as ITabSelectorWindow;
            if(this.var_1060 != null)
            {
               this.var_1060.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2099 = findChildByTag(const_1351) as IWindowContainer;
         }
      ...
      {
         return !!this.var_743 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1060.numSelectables;
      }
