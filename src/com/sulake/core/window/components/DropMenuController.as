package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowEvent = WindowEvent.allocate(WindowEvent.const_317,this,null,true);
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_181 == null || this.var_181.disposed)
         {
            this.var_181 = context.create(name + "::submenu","",WindowType.const_482,var_79,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_900 = false;
            this.getTitleLabel().text = this.var_592 < this.var_247.length && this.var_592 > -1 ? this.var_247[this.var_592] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_510,var_79,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         param2.activate();
         if(this.var_592 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_592).setStateFlag(WindowState.const_53,true);
         }
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1047:
            case WindowMouseEvent.const_58:
               if(param2 is IDropMenuItemWindow)
               {
                  if(param2.testStateFlag(WindowState.const_100))
                  {
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1613,this,null);
         ...
         _loc1_.recycle();
         visible = true;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1510,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1436,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_247.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_752,this.var_247,PropertyStruct.const_157,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_752)
            {
