   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public static function processInteractiveWindowEvents(param1:IInteractiveWindow, param2:WindowEvent) : void
      {
         if(param1.toolTipCaption != PropertyDefaults.const_469)
         {
            ...
            else if(param2.type != WindowMouseEvent.const_210)
            {
      ...
      public static function readInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : void
      {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_768:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_469)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_768,param1.toolTipCaption,PropertyStruct.const_55,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1511);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1081)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_738,param1.toolTipDelay,PropertyStruct.const_272,true));
         }
         else
         {
      ...
      {
         this.var_1310 = param1 == null ? "null" : param1;
      }
      ...
      public function setMouseCursorForState(param1:uint, param2:uint) : uint
      {
         ...
         var _loc3_:uint = this.var_858[param1];
         if(param2 == MouseCursorType.const_29 || param2 == -1)
         {
            this.var_858.remove(param1);
         }
         else
         {
            this.var_858[param1] = param2;
         }
         return _loc3_;
      }
      ...
      public function getMouseCursorByState(param1:uint) : uint
      {
         ...
         return this.var_858.getValue(param1);
      }
