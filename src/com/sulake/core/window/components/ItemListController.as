package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2105:Boolean = false;
      ...
      protected var var_2923:Number = 0.0;
      
      protected var var_2922:Number = 0.0;
      
      protected var var_1065:Boolean = true;
      
      protected var var_472:Boolean = false;
      
      protected var var_1316:Boolean = false;
      
      protected var var_2103:int = 0;
      
      protected var var_2104:int = 0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_109 = 0;
         this.var_95 = 0;
         this._horizontal = param2 == WindowType.const_387;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_176 = var_467 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_363,WindowStyle.const_782,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_38,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_370,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_136,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_184,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1316;
      }
      ...
      {
         var _loc1_:int = this.var_109 - width;
      ...
      {
         return new Rectangle(this.var_697 * this.maxScrollH,this.var_698 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_697)
         {
            ...
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_57);
            _loc2_ = WindowEvent.allocate(WindowEvent.const_500,this,null);
      ...
      {
         this.var_2923 = Math.max(param1,0);
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_370,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_136,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_184,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_43:
               this.var_2103 = _loc3_;
               this.var_2104 = _loc4_;
               this.var_1315 = 0;
               this.var_1314 = 0;
               this.var_1313 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_210:
               if(this.var_1313)
               {
                  this.var_1315 = this.var_2103 - _loc3_;
                  this.var_1314 = this.var_2104 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1315 != 0 && this.var_109 != 0)
                     {
                        this.scrollH += this.var_1315 / this.var_109;
                     }
                  }
                  else if(this.var_1314 != 0 && this.var_95 != 0)
                  {
                     this.scrollV += this.var_1314 / this.var_95;
                  }
                  this.var_2103 = _loc3_;
                  this.var_2104 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_178:
               if(this.var_1313)
               {
                  ...
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1314);
                  }
                  this.var_1313 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1065 && !this.var_566 && this._container)
         {
            this.var_566 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_836)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_401,this._spacing,PropertyStruct.const_42,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1048);
         }
         if(this.var_1065 != PropertyDefaults.const_1030)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_854,this.var_1065,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1458);
         }
         if(this.var_472 != PropertyDefaults.const_1222)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_751,this.var_472,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1484);
         }
         if(this.var_1316 != PropertyDefaults.const_1039)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_875,this.var_1316,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1674);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_854:
                  this.var_1065 = _loc2_.value as Boolean;
                  break;
            }
         }
