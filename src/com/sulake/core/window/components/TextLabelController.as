package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2392 = _loc2_.textWidth;
         this.var_2391 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_363 != _loc2_.color : this.var_363 != null && this.var_363 != PropertyDefaults.const_715) ? new PropertyStruct(PropertyDefaults.const_375,this.var_363,PropertyStruct.const_139,true) : PropertyDefaults.const_1136);
         if(this.var_39)
         {
            if(this.var_39.left != PropertyDefaults.const_920)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_249,this.var_39.left,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_577);
            }
            if(this.var_39.top != PropertyDefaults.const_645)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_247,this.var_39.top,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_498);
            }
            if(this.var_39.right != PropertyDefaults.const_823)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_224,this.var_39.right,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_462);
            }
            if(this.var_39.bottom != PropertyDefaults.const_890)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_275,this.var_39.bottom,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_470);
            }
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_425:
                  ...
                  break;
               case PropertyDefaults.const_375:
