package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_1468:uint = 0;
      
      protected var var_285:Function;
      
      protected var var_1303:int;
      
      protected var var_1302:int;
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            this.var_202 = new Timer(40,0);
            this.var_202.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_202.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1303 *= 0.75;
         this.var_1302 *= 0.75;
         if(Math.abs(this.var_1303) <= 1 && Math.abs(this.var_1302) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_285 != null)
         {
            this.var_285(this.var_1303,this.var_1302);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_202.stop();
            this.var_202.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_202 = null;
         }
         if(this._working)
         {
