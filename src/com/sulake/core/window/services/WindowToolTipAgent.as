package com.sulake.core.window.services
{
   ...
   public class WindowToolTipAgent extends WindowMouseOperator implements IToolTipAgentService
   {
      ...
      override public function begin(param1:IWindow, param2:uint = 0) : IWindow
      {
         if(param1 && !param1.disposed)
         {
            if(param1 is IInteractiveWindow)
            {
               ...
               this.var_1581 = IInteractiveWindow(param1).toolTipDelay;
            }
            else
            {
            ...
            if(this.var_1310 != null && this.var_1310 != "")
            {
               ...
               {
                  this.var_402 = new Timer(this.var_1581,1);
                  this.var_402.addEventListener(TimerEvent.TIMER,this.showToolTip);
               }
               this.var_402.reset();
               this.var_402.start();
            }
      ...
      override public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_402.stop();
            this.var_402.removeEventListener(TimerEvent.TIMER,this.showToolTip);
            this.var_402 = null;
         }
         this.hideToolTip();
      ...
      protected function showToolTip(param1:TimerEvent) : void
      {
         ...
         if(_window && true)
         {
            if(this.var_286 == null || this.var_286.disposed)
            {
               this.var_286 = _window.context.create("undefined::ToolTip",this.var_1310,WindowType.const_426,_window.style,0 | 0,null,null,null,0,null,null) as IToolTipWindow;
            }
            _loc2_ = new Point();
            _window.getGlobalPosition(_loc2_);
            this.var_286.x = _loc2_.x + this.var_1312.x + this.var_1311.x;
            this.var_286.y = _loc2_.y + this.var_1312.y + this.var_1311.y;
         }
      }
