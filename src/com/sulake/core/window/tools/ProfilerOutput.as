package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1340:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1341:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_151:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2882 = new Array();
         this.var_151 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1340() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_151)
         {
            this.var_151.removeStopEventListener(this.refresh);
            this.var_151 = null;
         }
         if(!this.var_151 && param1)
         {
            this.var_151 = param1;
            this.var_151.addStopEventListener(this.refresh);
         }
      }
      ...
      {
         var _loc2_:Array = this.var_151.getProfilerAgentsInArray();
         ...
         if(this.var_1626)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_151.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_151.numBitmapAssetInstances + " / " + this.var_151.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_151.numTrackedBitmapDataInstances + " / " + this.var_151.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1341() as ByteArray;
