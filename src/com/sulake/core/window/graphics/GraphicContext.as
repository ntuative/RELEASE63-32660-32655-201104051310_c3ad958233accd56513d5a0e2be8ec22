package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1550:uint = 0;
      
      public static const const_684:uint = 1;
      
      public static const const_1123:uint = 2;
      
      public static const const_647:uint = 4;
      
      public static const const_1432:uint = 8;
      
      public static const const_1619:uint = 16;
      
      public static const const_1875:uint = 64;
      
      public static const const_1882:uint = 128;
      
      public static const const_1174:uint = 256;
      
      protected static var var_571:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_215.numChildren > 0)
               {
                  this.var_215.removeChildAt(0);
               }
            }
            this.var_215 = null;
            while(numChildren > 0)
         ...
         if(this.var_861)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2100,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2100,16777215);
                  }
                  var_335 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_215 == null)
         {
            this.var_215 = new Sprite();
            this.var_215.name = this.name + " - Child Container";
            this.var_215.mouseEnabled = false;
            addChild(this.var_215);
         }
         return this.var_215;
      }
      ...
      {
         return this.var_215 != null ? int(this.var_215.numChildren) : 0;
      }
