package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1684 = new Point();
         this.var_1368 = new Rectangle();
         this.var_307 = new Rectangle();
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_307.x = param2.x - param1.x;
            this.var_307.y = param2.y - param1.y;
            this.var_307.width = param2.width;
            this.var_307.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_33))
            {
               while(param1.testParamFlag(WindowParam.const_33))
               {
                  ...
                  this.var_307.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_307,WindowRedrawFlag.const_1035);
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            this.addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_57);
         }
      }
      
      protected function getWindowRendererItem(param1:IWindow) : WindowRendererItem
      {
         var _loc2_:WindowRendererItem = this.var_353[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_353[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_875);
            this.var_353[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_654,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_654,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_353[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_353[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            if(!_loc1_.disposed)
            {
               ...
               this.var_307.x = _loc3_.dirty.x;
               this.var_307.y = _loc3_.dirty.y;
               this.var_307.width = _loc3_.dirty.width;
               this.var_307.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_307,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1684,this.var_1368))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1684,this.var_1368))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_33))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1368);
