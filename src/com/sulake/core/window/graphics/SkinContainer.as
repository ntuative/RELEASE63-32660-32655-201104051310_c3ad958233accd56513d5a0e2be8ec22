package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_956:uint = 8;
      
      private static const const_1305:String = "skin";
      
      private static const const_1303:String = "bitmap";
      
      private static const const_1308:String = "fill";
      
      private static const const_1307:String = "text";
      
      private static const const_1304:String = "label";
      
      private static const const_1306:String = "shape";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1792 = new Dictionary();
         this.var_2437 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1792,this.var_2437);
         this.var_2438 = new Dictionary();
         this.var_2439 = new Dictionary();
         StateCodeTable.fillTables(this.var_2438,this.var_2439);
         this.var_429 = new Dictionary();
         this.var_429[const_1305] = BitmapSkinRenderer;
         this.var_429[const_1303] = BitmapDataRenderer;
         this.var_429[const_1308] = FillSkinRenderer;
         this.var_429[const_1307] = TextSkinRenderer;
         this.var_429[const_1304] = LabelRenderer;
         this.var_429[const_1306] = ShapeSkinRenderer;
         this.var_429[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_429[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_334 == null)
         {
            var_334 = new Array();
            var_334.push(WindowState.const_66);
            var_334.push(WindowState.const_87);
            var_334.push(WindowState.const_101);
            var_334.push(WindowState.const_53);
            var_334.push(WindowState.const_100);
            var_334.push(WindowState.const_84);
            var_334.push(WindowState.const_109);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2857 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1792[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_940[param1] = new Array(const_956);
         }
         this.var_940[param1][param2] = param3;
         if(this.var_941[param1] == null)
         {
            this.var_941[param1] = new Array(const_956);
         }
