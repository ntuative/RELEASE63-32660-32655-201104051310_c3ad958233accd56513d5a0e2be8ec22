package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1058:int = 2;
      ...
      private var var_168:IRoomManagerListener;
      
      private var var_2944:IRoomContentLoader;
      
      private var var_663:IRoomObjectFactory = null;
      
      private var var_545:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1255:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_566,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_791,this.onContentLoaded);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_122.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_122.getWithIndex(_loc2_) as IRoomInstance;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_663 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_663 == null || this.var_545 == null)
         {
            return;
         }
         this._state = const_1688;
         if(this.var_1255 != null)
         {
            _loc1_ = this.var_1255;
            this.var_1255 = null;
            this.initialize(_loc1_,this.var_168);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_664.indexOf(_loc5_) < 0)
            {
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_628.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_628.push(param1);
         var _loc3_:int = this.var_122.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_122.getWithIndex(_loc3_) as RoomInstance;
            if(_loc4_ != null)
            {
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         this.var_122.add(String(param1),_loc3_);
         var _loc4_:int = this.var_628.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_628[_loc4_];
      ...
      {
         return this.var_122.getValue(param1) as IRoomInstance;
      }
      
      public function disposeRoom(param1:String) : Boolean
      {
         var _loc2_:IRoomInstance = this.var_122.remove(param1) as IRoomInstance;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_545.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_545.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_663.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_663 != null)
         {
            return this.var_663.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_650)
         {
            return;
         }
         if(this.var_58 == null)
         {
            this._state = const_650;
            return;
         }
         if(this.var_58.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_664.indexOf(param1);
            if(_loc2_ >= 0)
            {
            ...
            {
               this._state = const_887;
               if(this.var_168 != null)
               {
                  this.var_168.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_650;
            this.var_168.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_168 != null)
            {
               this.var_168.contentLoaded(null,false);
            }
            return;
         }
         if(this.var_1014.indexOf(_loc2_) < 0)
         {
            this.var_1014.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_1014.length > 0)
         {
            _loc2_ = this.var_1014[0];
            this.var_1014.splice(0,1);
            _loc3_ = this.var_58.getVisualizationXML(_loc2_);
            if(_loc3_ == null)
            {
               if(this.var_168 != null)
               {
                  this.var_168.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_168 != null)
            {
               this.var_168.contentLoaded(_loc2_,true);
            }
            if(this.var_664.length > 0)
            {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_58 == null || this.var_545 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_545.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
         var _loc8_:int = this.var_122.length - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = this.var_122.getWithIndex(_loc8_) as RoomInstance;
            _loc10_ = this.var_122.getKey(_loc8_);
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_545.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_663.createRoomObjectLogic(_loc6_);
                              ...
                              if(this.var_168 != null)
                              {
                                 this.var_168.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:int = this.var_122.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = this.var_122.getWithIndex(_loc2_) as RoomInstance;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
