package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_736:Number = 64;
      
      public static const const_1054:Number = 32;
      ...
      private var var_1763:Vector3d;
      
      private var var_499:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1138:Vector3d;
      
      private var _scale:Number = 1.0;
      
      private var var_423:Number = 1.0;
      ...
      private var var_1760:Number = 1.0;
      ...
      private var var_2896:Number = -500.0;
      
      private var var_2895:Number = 500.0;
      
      private var var_249:Number;
      ...
      {
         this.var_1763.assign(this.var_171);
         return this.var_1763;
      }
      
      public function get location() : IVector3d
      {
         this.var_499.assign(this.var_92);
         this.var_499.x *= this.var_423;
         this.var_499.y *= this.var_422;
         this.var_499.z *= this.var_424;
         return this.var_499;
      }
      
      public function get direction() : IVector3d
      {
         this._direction.assign(this.var_364);
         return this._direction;
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_423 != param1 * this.var_1761)
         {
            this.var_423 = param1 * this.var_1761;
            ++this.var_157;
         }
      }
      ...
      {
         if(this.var_422 != param1 * this.var_1760)
         {
            this.var_422 = param1 * this.var_1760;
            ++this.var_157;
         }
      }
      ...
      {
         if(this.var_424 != param1 * this.var_1762)
         {
            this.var_424 = param1 * this.var_1762;
            ++this.var_157;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_92.x /= this.var_423;
         this.var_92.y /= this.var_422;
         this.var_92.z /= this.var_424;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_364.x;
         var _loc3_:Number = this.var_364.y;
         var _loc4_:Number = this.var_364.z;
         this.var_364.assign(param1);
         if(this.var_364.x != _loc2_ || this.var_364.y != _loc3_ || this.var_364.z != _loc4_)
         {
            ++this.var_157;
         }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_500 != null)
         {
            ...
            return this.var_500.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1138.assign(_loc22_);
         }
         else
         {
            this.var_1138.assign(_loc17_);
         }
         ++this.var_157;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_423;
         _loc2_.y *= this.var_422;
         _loc2_.z *= this.var_424;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1138);
         if(_loc3_ < this.var_2896 || _loc3_ > this.var_2895)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_422;
            _loc2_.z *= this.var_424;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1138);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_92.x * this.var_423,this.var_92.y * this.var_422,this.var_92.z * this.var_424);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_171;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_423,param2.y * this.var_422,param2.z * this.var_424);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_423,param3.y * this.var_422,param3.z * this.var_424);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_423,param4.y * this.var_422,param4.z * this.var_424);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1054;
         }
         else
         {
            this.scale = const_736;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_736;
      }
