package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_611:Point = new Point(0,0);
      
      private static const const_358:int = 50;
      
      private static const const_1403:int = 50;
      
      private static const const_1009:Number = 60;
      
      private static const const_1402:Number = 50;
      ...
      private var var_277:BitmapDataCache;
      
      private var var_671:RoomObjectCache;
      
      private var var_548:Array;
      
      private var var_673:Array;
      
      private var var_1541:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2786:Number = -1.0E7;
      
      private var var_2782:Number = -1.0E7;
      ...
      private var var_1995:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_276.addChild(this.var_100);
         ...
         this.var_277 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         ...
         this.var_671 = new RoomObjectCache(_loc6_);
         this.var_1015 = new ColorTransform();
         this.var_1016 = new Matrix();
      ...
      {
         this.var_547.x -= param1 - this.var_674;
         this.var_674 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_547.y -= param1 - this.var_672;
         this.var_672 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_894 = true;
            if(this.var_141 != null && !this.var_276.contains(this.var_141))
            {
               this.var_276.addChild(this.var_141);
               this.var_100.mask = this.var_141;
            }
         }
         else if(!param1 && this.var_894)
         {
            this.var_894 = false;
            if(this.var_141 != null && this.var_276.contains(this.var_141))
            {
               this.var_276.removeChild(this.var_141);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_673.length)
            {
               this.cleanSprite(this.var_673[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_673 = [];
         }
      ...
      {
         this.var_671.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_1994 = !this.var_1994;
         ...
         if(this.var_829 != this.var_2785 || this.var_830 != this.var_2784)
         {
            _loc8_ = true;
         }
         if(this.var_100.x != this.var_674 || this.var_100.y != this.var_672)
         {
            this.var_100.x = this.var_674;
            this.var_100.y = this.var_672;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2785 = this.var_829;
         this.var_2784 = this.var_830;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1540 > 0)
         {
            _loc2_ = param1 - this.var_1540;
            if(_loc2_ > const_1009 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2783 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_831;
               if(this.var_831 == const_358 + 1)
               {
                  this.var_526 = _loc2_;
                  this.var_1995 = this.var_2781;
               }
               else if(this.var_831 > const_358 + 1)
               {
                  _loc3_ = Number(this.var_831 - const_358);
                  this.var_526 = this.var_526 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1995 = this.var_1995 * (_loc3_ - 1) / _loc3_ + Number(this.var_2781) / _loc3_;
                  if(this.var_831 > const_358 + const_1403)
                  {
                     this.var_831 = const_358;
                     if(!this.var_1258 && this.var_526 > const_1009)
                     {
                        this.var_1258 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1258 && this.var_526 < const_1402)
                     {
                        this.var_1258 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_671.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_671.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1994 && this.var_1258);
         ...
         _loc13_ += int(this.var_829 / 2);
         _loc14_ += int(this.var_830 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_672;
                  if(_loc19_ < this.var_829 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this.var_830 && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     _loc17_.y = _loc20_ - this.var_672;
      ...
      {
         if(param1 < 0 || param1 >= this.var_1017)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_673.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_1017)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_277.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_277.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_277.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_1016.identity();
            this.var_1016.scale(-1,1);
            this.var_1016.translate(data.width,0);
            finalData.draw(data,this.var_1016);
            if(name.length > 0)
            {
               this.var_277.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_611);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_1015.redMultiplier = tR;
            this.var_1015.greenMultiplier = tG;
            this.var_1015.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_1015);
            if(name.length > 0)
            {
               this.var_277.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_674;
         param2 -= this.var_672;
         this.var_547.x = param1;
         this.var_547.y = param2;
         if(this.var_1257 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1993;
         }
         this.var_1993 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1257;
         return this.var_1993;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_829 / 2;
         var _loc12_:Number = param2 - this.var_830 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1996,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_670.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_670.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2786 || param2 != this.var_2782)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_670.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_670.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_390.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1541.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1257 == 0)
         {
            this.checkMouseHits(this.var_547.x,this.var_547.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1257 = 0;
         ++this.var_1996;
      }
