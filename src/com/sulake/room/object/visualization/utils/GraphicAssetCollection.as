package com.sulake.room.object.visualization.utils
{
   ...
   public class GraphicAssetCollection implements IGraphicAssetCollection
   {
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_253)
            {
               _loc3_ = this.var_253[_loc1_];
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function defineAssets(param1:XMLList) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(_loc5_.length > 0)
            {
               ...
               _loc12_ = this.var_362.getAssetByName(_loc6_);
               if(_loc12_ != null)
               {
      ...
      private function disposePaletteAssets(param1:Boolean = true) : void
      {
         ...
         if(this.var_615 != null)
         {
            if(param1 || this.var_615.length > const_1287)
            {
