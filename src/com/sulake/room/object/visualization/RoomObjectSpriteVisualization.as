package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      protected var var_465:int = -1;
      
      protected var var_175:int = -1;
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_197.length > 0)
            {
               _loc1_ = this.var_197[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_706.removeReference();
         }
         this.var_706 = param1;
         if(this.var_706 != null)
         {
            this.var_706.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_197.length > param1)
         {
            _loc2_ = this.var_197[this.var_197.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_197.length)
         {
      ...
      {
         this.var_465 = 4294967295;
         this.var_175 = 4294967295;
         this.var_89 = -1;
      }
